# INDEX — KB `claude-code`

Wissen ueber das Werkzeug, auf dem der Hub ruht. Angelegt 29.07.2026.

## Artikel

| Artikel | Inhalt | Status |
|---|---|---|
...
- `raw/IMG_5458.jpeg` bis `raw/IMG_5489.jpeg` — 32 Slides der Lecture vom 29.07.2026,
  fotografiert von Raphael Jans. Quelle des Destillats.
- Register: `raw/_INGESTED.md` (inkl. externer Quellen, die in OneDrive bleiben).

## Umsetzung im Hub

Was aus diesem Wissen konkret gebaut wurde:
`docs/konzepte/260729-Anthropic-Lecture-Prinzipien/` (Konzept + Massnahmen + Messwerte).
