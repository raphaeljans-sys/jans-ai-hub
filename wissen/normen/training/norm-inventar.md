...
|---|---|---|
| **SIA 416/1:2007** | ⚠ **zurückgezogen 31.03.2015** (Run 57); Datei `xalt/neu/SIA 416_1_2007.pdf` | **destilliert Run 52** → `sia-416-1-2007.md`. ⚠ **ZURÜCKGEZOGEN — belegt Run 57 (19.08.2026) an zwei Primärquellen.** SIA 416/1:2007 war gültig **01.07.2007 bis 31.03.2015** und ist seit **01.04.2015** ersetzt durch **SIA 380:2015 «Grundlagen für energetische Berechnungen von Gebäuden»** (SN 504380:2015). Belege: SIA-Shop-Produktdatenblatt («archivierter Titel», mit Enddatum) und das **Titelblatt der SIA 380:2015 selbst** («Ersatz für SIA 416/1:2007 sowie Teile von SIA 2031:2009, SIA 2032:2010 und SIA 2040:2011»). **SIA 380:2015 liegt NICHT im Haus** — Beschaffung ist Bring-Schuld (N57-2). Das Destillat bleibt als Bestandes-/Altfall-Referenz gültig, ist aber **keine geltende Fundstelle** mehr (Rule `normen-referenz`, Ausgaben-Disziplin). |
| **SIA 215:1978** | REGISTER: 1978✓ **geltend**; Datei `xalt/215_d.pdf` (40 S., Titelblatt «Ausgabe 1978», ersetzt Norm 115:1953, Zement/VSZKGF); kein Destillat | **destilliert 16.08.2026** → `sia-215-1978.md`, schliesst P3/QUESTIONS N52-4. **Neuer Befund:** die im Haus liegenden `xalt/215.002_2000_d.pdf` (SIA 215.002 = SN EN 197-1:2000 «Zement Teil 1», gültig ab 01.01.02, ersetzt bereits «SIA 215.002:1993 (ENV 197-1:1992)») und `xalt/215_003d.pdf` (SIA 215.003 = SN EN 197-2:2000 «Zement Teil 2», gültig ab 01.01.02) belegen, dass die Zement-Bestimmungen von SIA 215:1978 (Ziff. 2.1/3.2/6.2/6.28/6.29) seit spätestens 1993 durch eigenständige EN-Adoptionen unter derselben 215er-Familiennummer ersetzt sind. Für Kalk/Gips (Ziff. 2.3-2.5/3.3-3.5/6.3-6.5) ist im Haus keine entsprechende EN-Nachfolgenorm (z.B. SN EN 459-1 Baukalk, SN EN 13279-1 Gips) vorhanden — offen, ob eine solche existiert |
...
| **SIA 151:2001** | im REGISTER nicht gefuehrt → **GEKLAERT Run 53 (260816)**: `ersetzte_normen.pdf` fuehrt sie gueltig ab 01.01.2001, **ohne Enddatum und ohne Nachfolger**; Gesamtverzeichnis: Dokumentart **O = Ordnung** («Standesordnung»). Datei `xalt/151_dfi.pdf` dreisprachig mit deutschem Volltext | **geltend** — REGISTER Zeile ergaenzt Run 53. **Kein Destillier-Auftrag**: Standesordnung ist Berufsrecht, kein Planungs-/Vertragsstoff. `xalt` erneut irrefuehrend |
| **SIA 178:1996** | im REGISTER nicht gefuehrt → **GEKLAERT Run 53 (260816)**: **ersetzt per 31.12.2011 durch SIA 266/2:2012**; Gesamtverzeichnis fuehrt sie als «V178, E = Empfehlung» (Naturstein-Mauerwerk) | **erloschen** — REGISTER Zeile ergaenzt Run 53. Nicht destillieren. Hier liegt `xalt` sachlich **richtig** |
| **SIA 266/2:2012** | Nachfolgenorm der SIA 178; **Bestand gemessen Run 53: NICHT im Haus** (im PL-02-Baum nur die Vertragsnorm `alle/118_266-2_2017.pdf`) | **Beschaffungsposten (N53-1)**. Die KB fuehrt die ABB-Norm SIA 118/266-2 als `established`, die Bemessungsnorm dahinter fehlt |
...
|---|---|---|---|---|---|
| [x] 260816 | P3 | SIA 215 — Zement (Grundnorm, VSZKGF) | 215 | **1978** | ⚠ **Status nachgetragen Run 54 (17.08.2026):** Diese Zeile stand noch auf `[ ]`, obwohl Run 53 die Norm am 16.08.2026 vollständig destilliert hat (`sia-215-1978.md`, 40 S., Textlayer). **Refuter-Runde gefahren Run 54: 41 bestätigt, 3 widerlegt, 1 Fundstelle falsch, alle inline korrigiert** (Prüfalter-Überdehnung Baugips/Kalk, Fundstelle der drei chemischen Grenzwerte, «Ziff. 0-6», Seitenbereich Stichwortverzeichnis). Status `speculative`, weil die Zahlenwerte der Gütewert-Tabellen aus Urheberrechtsgründen bewusst nicht destilliert sind — das Destillat ist Wegweiser, nicht Wertequelle. **Neu aufgenommen Run 52 (15.08.2026).** REGISTER führt SIA 215 als **1978✓ geltend**; die Datei `SIA_Norm/SIA_Normen/alle/xalt/215_d.pdf` (40 S.) trägt auf dem Titelblatt «Ausgabe 1978», «Ersetzt Norm 115 (1953)», Herausgeber-Mitwirkung VSZKGF. Sie war nie destilliert, weil sie im Ordner `xalt` liegt — derselbe Mechanismus wie bei SIA 416/1:2007 (Run 52 destilliert) und SIA D 0165 (Run 29). **Anders als jene beiden für ein Architekturbüro randständig** (Zement-Produktgrundnorm, kein Planungs-/Vertragsstoff), deshalb P3 und nicht P1. Die zugehörigen Teilnormen 215.002 (EN 197-1:2000, Zement Zusammensetzung) und 215.003 (EN 197-2:2000, Konformitätsbewertung) liegen ebenfalls in `xalt`. |
| [x] 260815 | P1 | SIA 416/1 — Kennzahlen für die Gebäudetechnik | 416/1 | 2007 | `sia-416-1-2007.md`, Erstdestillat Run 52 (15.08.2026). Quelle `alle/xalt/neu/SIA 416_1_2007.pdf`, 40 S., reiner Scan ohne Textlayer, vollständig in 300 dpi gerendert; Tabellen 1-5 zellenweise abgelesen (Methodik-Pflicht 8), Folio = PDF-Blatt 1:1 verifiziert. Kern: Energiebezugsfläche A_E (Ziff. 3.2), Gebäudehüllfläche A_b/A_th/A_inf (Ziff. 3.3), Energiekennzahl E (Ziff. 4.1); ersetzt Empfehlung SIA 180/4:1982. Schliesst QUESTIONS 260813 (Link-Fehler in `sia-382-2-2011.md` umgehängt). ⚠ **Prüfstand nachgeführt Run 54 (17.08.2026)** — hier stand «Refuter-Runde ausstehend», sie war seit Run 53 gefahren: **Refuter-Richtung Run 53** (93 bestätigt, 2 widerlegt, 1 Fundstelle falsch), **Abdeckungsrichtung Run 53 (Kap. 3) und Run 54 (Kap. 0-2 sowie Kap. 4-5/Anhänge)** mit **37 Kern- und 20 Nebenlücken**, alle eingearbeitet, kein falscher Wert. ⚠ **Prüfstand erneut nachgeführt Run 55 (17.08.2026): N54-1 geschlossen.** Die Refuter-Runde auf dem Run-54-Zuwachs ist gefahren, vom Hauptprozess ohne Subagenten am eigenen 300-dpi-Rendering der S. 26-32, 34, 35 und 40: ~69 Aussagen geprüft, **2 widerlegt** (Ziff. 4.3.3 — EV umfasst nur die *Auswirkungen der luftseitigen Druckverluste*, nicht die Lufterwärmung selbst; das war eine Doppelzählung gegen Eh — und HNF3-Kategorietitel ohne «Experimente», was die Zuordnung der Labors trägt), 2 unpräzise, 7 weitere Abdeckungslücken beiläufig gefunden, alle inline korrigiert. Bleibt `speculative`, weil der Zuwachs auf **S. 4, 6, 9, 17, 21-22 und 39** noch keine **unabhängige** Refuter-Runde hat — dort prüfte in Run 54 der Autor seinen eigenen Text nach, S. 22 und S. 39 gar niemand. Offen als **N55-1**. ⚠ **Prüfstand nachgeführt Run 56 (18.08.2026): N55-1 GESCHLOSSEN.** Alle sieben Seiten unabhängig am eigenen 300-dpi-Rendering gegengelesen (Präfix `ref416-r56-`), S. 22 und S. 39 erstmals überhaupt. **3 Kernbefunde:** (a) S. 4 — das Vorwort nennt **vier** Änderungen gegenüber SIA 180/4, nicht drei; die fehlende ist die **vereinfachte, aus SIA 416 abgeleitete Definition der Energiebezugsfläche** und damit die Bezugsgrösse der ganzen Norm; (b) S. 6 — die KF-Definition stand ohne die Eingrenzung «**innerhalb der Geschossfläche GF liegenden**», also ohne das Kriterium, das KF zur Teilfläche der GF macht (Bauteil-Beispiele Aussen-/Innenwände, Stützen, Brüstungen fehlten ebenfalls); (c) S. 21 — bei **abgehängten Decken an auskragenden Bauteilen** fehlte die mitlaufende **10-cm-Schwelle** («Das gilt auch für…» trägt sie mit, Figur 13 zeigt die Spalte «Böden gegen Aussenklima» als Paar ≤ 10 cm / > 10 cm); ohne sie wird Ath zu klein gerechnet. Dazu 5 Nebenbefunde (Energiekennzahlen-Folge des Brennwert-Wechsels, «äusserste» Hauptebene, Herkunft «hinterlüftete Aussenwände» aus der Figurenlegende, Figur-10-Linientypen, Auflösung der fünf Organisationskürzel S. 39). Alle inline korrigiert. **S. 9, 17, 22 und 39 ohne Kernbefund** — S. 17 (der am stärksten umgebaute Block, Ziff. 2.2.1.1-2.2.1.5) hielt Satz für Satz. Bleibt `speculative`: drei Seiten tragen neuen, wieder unverifizierten Text (**N56-1**). ⚠ **Prüfstand nachgeführt Run 57 (19.08.2026): N56-1 GESCHLOSSEN, und der Gegenstand hat sich verschoben.** Die Runde auf den fünf zuletzt offenen Seiten (4, 6, 21, 27, 34) ist gefahren, Präfix `ref416-r57-`: **sämtliche Korrekturen der Runs 55 und 56 haben am Druck gehalten**, keine musste zurückgenommen werden. Neu **3 Kernbefunde**: (a) S. 6 — **Figur 1 und die GF-Gliederung fehlten dem Destillat vollständig** («Die Geschossfläche gliedert sich in NGF und KF»; damit war die Identität GF = NGF + KF und die Taxonomie NGF = NF+VF+FF, NF = HNF+NNF nirgends geführt; Gegenprüfung «Figur 1»/«gliedert»/«GF = NGF» je 0 Treffer); (b) S. 6 — «**Bauteile _wie_** versetzbare Trennwände und Schrankwände» war zur geschlossenen Aufzählung verengt, und verneint ist nicht die Bauteil-Eigenschaft schlechthin, sondern die als **umschliessendes oder innenliegendes** Konstruktionsbauteil; (c) S. 27 — die **Positivdefinitionen von EV und EC fehlten** (Run 55 trug drei nach, es waren fünf), mit ihnen die Zuteilung von **WRG-Antrieb → EV** und **Rückkühl-Ventilator → EC**. Dazu 4 Nebenbefunde (Vorwort-Zweck «gemeinsamer Datensatz»/«nicht vergleichbar»; Schlusssatz «weitere nützliche Kennzahlen»; Zählweise «vier» als Lesart statt Quellenangabe gekennzeichnet; NNF «Räume **in** Kraftwerken»). Alle inline korrigiert. **S. 4, 21 und 34 ohne Kernbefund.** ⚠⚠ **ENTSCHEIDEND: Run 57 hat erstmals den GÜLTIGKEITSSTAND geprüft.** ⚠ **ZURÜCKGEZOGEN — belegt Run 57 (19.08.2026) an zwei Primärquellen.** SIA 416/1:2007 war gültig **01.07.2007 bis 31.03.2015** und ist seit **01.04.2015** ersetzt durch **SIA 380:2015 «Grundlagen für energetische Berechnungen von Gebäuden»** (SN 504380:2015). Belege: SIA-Shop-Produktdatenblatt («archivierter Titel», mit Enddatum) und das **Titelblatt der SIA 380:2015 selbst** («Ersatz für SIA 416/1:2007 sowie Teile von SIA 2031:2009, SIA 2032:2010 und SIA 2040:2011»). **SIA 380:2015 liegt NICHT im Haus** — Beschaffung ist Bring-Schuld (N57-2). Das Destillat bleibt als Bestandes-/Altfall-Referenz gültig, ist aber **keine geltende Fundstelle** mehr (Rule `normen-referenz`, Ausgaben-Disziplin). Fünf Läufe (53-57) haben den Inhalt minutiös verifiziert, ohne je Methodik-Pflicht 3 (Fassungsstand VOR Werteabgleich) auf die Norm als Ganzes anzuwenden. |
...
| [ ] | P2 | SN 640 052 (VSS) — Kehrplatz/Kehrmöglichkeit bei Stichstrassen | 640 052 | 1977, **ausser Kraft 31.03.2019** | Bring-Schuld KB `baurecht` (`baurecht/wiki/baureife-und-erschliessung.md:76`, Cross-KB-Vorbehalt dort bereits gesetzt, Commit `fd4ef28d`/`b1533e82`). **Gültigkeitsstand bereits am 23.08.2026 (QUESTIONS-Abarbeitung) geklärt, am 24.08.2026 (SIA-Sweep, 35. Fortsetzung) ins REGISTER konsolidiert und gegengeprüft** (`mobilityplatform.ch/de/vss-shop/product/640052`, «Wendeanlagen», 01.01.1977–31.03.2019, CHF 45.20). Nachfolgenorm weiterhin unbekannt; heutiger Versuch über ASTRA-Strukturanpassungsdokument (`astra 8A002`) scheiterte an HTTP 502. Details `wiki/REGISTER.md` Abschnitt B. |
| [ ] | P2 | SN 641 400 (VSS) — Grundlage der ZH-Parkplatzberechnung | 641 400 | — | Bring-Schuld KB `baurecht` (`baurecht/wiki/fahrzeugabstellplaetze-und-parkierung.md:43`). Bezug zum bestehenden Parkierungs-Block (VSS 40 291 / 640 281). **Fünfter erfolgloser Web-Beschaffungsversuch 24.08.2026 (SIA-Sweep, 35. Fortsetzung)** bestätigt nur den seit 23.08.2026 in `wiki/QUESTIONS.md` vierfach dokumentierten Negativbefund (Shop-404, ZH-Wegleitung nur Klammerverweis ohne Ausgabe). Einzig offener Weg: VSS-Kundendienst (`info@vss.ch`, Kontakt bereits recherchiert im QUESTIONS-Lauf 03:17 Uhr) — kein weiterer Web-Anlauf sinnvoll. Details `wiki/REGISTER.md` Abschnitt B. |
| [ ] | P2 | SN 640 273a (VSS) — Sichtverhältnisse bei Knoten | 640 273a | seit 01.08.2010 | **Neu 24.08.2026 (QUESTIONS-Abarbeitung, N41-1), Cross-KB-Fund Wissens-Chef Run 41.** Bring-Schuld KB `baurecht` (`baurecht/wiki/strassenabstand-zufahrten-vorteilsabgabe-sz.md:38-42`, dort materiell zitierte Sichtweiten-Kennwerte ohne verifizierte Fundstelle). Im Haus nur eine Literaturangabe der Vorgängernorm SN 640 273 (`destillate/vss-640050-1993.md`). REGISTER-Zeile angelegt (Abschnitt B). |
...
| [x] 260713 | P1 | `02_Brandschutzrichtlinien 2015/2001-15_VKF-AEAI_BrandschutzMerkblatt_Solaranlange_d.pdf` | 2001 | 2001 |  Reconcile 260713: vkf-brm-2001-15-solaranlagen.md (Duplikat vkf-merkblatt-2001-15-solaranlagen.md, Merge offen). **260805:** Das Hausbestand-PDF ist die Ausgabe 06.03.2015 und seit **01.01.2017** überholt (RF3(cr)-Pflicht für Unterdachbahnen); geltend ist die Ausgabe 01.01.2022, über das VKG-Portal beschafft und gelesen, Re-Destillat offen (QUESTIONS 260805). Beide Destillate als historische Bestandsfassung markiert und mit Delta-Block versehen  |
...
| [x] 260806 | P2 | `06_Richtlinien/GVZ/M30-17-3_RWA-Parkhaus.pdf` | Run 40 → `destillate/gvz-rwa-parkhaus-einstellraum.md` (Merkblatt Nr. 30.17.3, 28.02.2011). Refuter **BEANSTANDET**, 6 Kernbefunde: die diagonal zweigeteilten Matrixzellen (blau = mit Sprinkler) waren bei 601-1200 m2 falsch aufgeloest. Matrizes 6.1/6.2 vom Hauptprozess am Original neu gefasst; Status bleibt `speculative` bis zur zweiten Runde **Run 45 (260806): zweite unabhaengige Refuter-Runde — Matrizen 6.1/6.2 BESTANDEN, zellengenau nachgemessen und damit zweifach unabhaengig bestaetigt; 2 Kernbefunde ausserhalb der Matrizen (Anhang-Legende S. 10, zu weite Farbwarnung) inline eingearbeitet.** **Run 46 (260807): VIERTE Refuter-Runde, Verdikt BEANSTANDET — 5 Kernbefunde, 8 Nebenbefunde, alle inline eingearbeitet. Die geplante Hebung auf `established` ist damit gescheitert. Die Matrizen halten zum dritten Mal zellengenau; saemtliche Befunde liegen im FLIESSTEXT der S. 2-9, den eine fruehere Runde als «Wort fuer Wort geprueft» fuehrte — namentlich die Anforderungen an die Entrauchungsoeffnungen (Ziff. 4.2.2.4 und Anhang S. 9): Funktionserhalt 400/200 Grad C auch fuer das Brandlueftungskonzept, einzeln und wieder schliessbar, betriebsbereit bei Stromausfall, dauernd offene Oeffnungen im Brandfall schliessbar, und die fehlende Qualifikation «geometrisch freie Flaeche» beim 1-%-Kriterium. Kernbefunde am eigenen 300-dpi-Rendering nachgelesen.** |
...
| Status | Prio | Datei | Bemerkung |
|---|---|---|---|
| [x] 260806 | P2 | `06_Richtlinien/SWKI/SWKI VA 103-1 Lüftungsanlagen für Parkhäuser.pdf` | Run 40 → `destillate/swki-va103-01-2017.md` (SWKI VA103-01:2017, Erstausgabe April 2017, 110 S.). Erfuellt Auftrag **N-R21-1**. Refuter **BEANSTANDET**, 5 Kernbefunde; drei am Original korrigiert (Anwendungsbereich NUR Mittel-/Grossgaragen ab 100 m2, Garagentypen nach Flaeche, 25-Prozent-Definition aus BSR 15-15). Nur ~45 von 110 Seiten gelesen → Status `speculative` **Run 45 (260806): Refuter-Runde BEANSTANDET, 3 Kernbefunde — im Frontmatter dokumentierte Seitenkorrekturen waren nie im Fliesstext angekommen, und mechanische Bemessungsregeln standen weiterhin unter der Ueberschrift «Natuerliche Lueftung». Beides inline korrigiert, 8 Abdeckungsluecken ehrlich benannt.** **Run 46 (260807): fuenf der acht Abdeckungsluecken geschlossen, darunter die als EINZIGE BEMESSUNGSRELEVANTE gefuehrte — Kap. 2.3 «Quellen» (S. 20-26) mit Kernformel, Tab. 2-5, der Regel exponiert/geschuetzt und der Aufschluesselung des 50-%-Zuschlags; dazu Kap. 2.1, 2.6.7, 3.2 (inkl. Tab. 11) und 3.3. Zahlenkette Tab. 4 → Tab. 5 rechnerisch geschlossen, S. 26 und S. 54 vom Hauptprozess selbst nachgelesen. Offen bleiben nur die drei Begriffs-/Abkuerzungskapitel.** |
...
| Status | Prio | Datei | Bemerkung |
|---|---|---|---|
| [x] 260806 | P2 | `09_Sanitaereinrichtung/Arbeitshilfen Sanitärapparate.pdf` | Run 42 → `destillate/geberit-sgvsb-sanitas-troesch-arbeitshilfen-sanitaerapparate.md`. **Kein Einzeldokument**, sondern Sammelscan aus mind. 3 Quellen (GEBERIT mit zwei Nummernkreisen, «SGVSB»-Blattwerk, Sanitas Troesch) ohne gemeinsamen Titel/Ausgabestand; S. 8 = S. 9 Duplikat. Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 4 Kernbefunde (SGVSB-Datierung dreifach falsch, Tab. 33 SP/GWA vertauscht, Mass 90x55 der Eckdusche statt dem Waschbecken zugeordnet, «Clasomat» statt «Closomat») plus 3 Abdeckungsluecken, alle inline eingearbeitet. Herkunfts-Zuschreibung und Duplikat S. 8 = S. 9 per Pixel-Diff bestaetigt.** |
...
| [x] 260806 | P2 | `09_Sanitaereinrichtung/Plan7_Badezimmer Alterswohnung.pdf` | Run 42 → `destillate/plan7-badezimmer-alterswohnung.md`. Auszug S. 40-47 aus einem grösseren Werk, **kein Impressum/Herausgeber**, Hybrid Planungsblatt mit Herstellerbezug; zitiert SIA 500 nur als Disclaimer. Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 3 Kernbefunde und 1 Abdeckungsbefund eingearbeitet. Wichtigstes Ergebnis: der nie gefahrene SIA-500-Abgleich ist nachgeholt — die Masse sind weitgehend deckungsgleich mit SIA 500 Anhang E, einzige Abweichung der Wandhaken (1000 statt 1100 mm), und die Waschtisch-Unterkante fuellt eine Normluecke mit einer Hersteller-Setzung.** |
...
| Status | Prio | Datei | Bemerkung |
|---|---|---|---|
| [x] 260806 | P3 | `04_Merkblätter/120206_Leitfaden_Boulevardgastronomie.pdf` | Run 42 → `destillate/stadt-zuerich-leitfaden-boulevardgastronomie-2008.md`. Tiefbauamt Stadt ZH, **4. Auflage März 2008** + zwei Einlageblätter. **Die Dateinamen-Ziffer 120206 ist NICHT das Ausgabedatum**, sondern das PDF-Erstellungsdatum 06.02.2012. Bewilligungsvoraussetzung (VBöGS AS 551.210). Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 3 Kernbefunde und 5 Abdeckungsbefunde eingearbeitet. Wichtigster Punkt: die Kontaktadresse war aus Strassen- und Postfachadresse falsch verschmolzen (richtig Foerrlibuckstrasse 61, 8005 Zuerich bzw. Postfach 1612, 8021 Zuerich). Die Datierungs-These des Erstdestillats ist vollstaendig bestaetigt.** |
| [x] 260806 | P3 | `04_Merkblätter/AFS_Leitfaden Dachlandschaften.pdf` | Run 42 → `destillate/afs-leitfaden-dachlandschaften-2010-praesentation.md`. Vortragsfolien AfS Stadt ZH zur Veranstaltung vom 09.03.2010, **Kurzfassung der Vollfassung**; das Kapitel «Gesetzliche Grundlagen» fehlt dort ganz → **nicht zitierfähig**. Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 3 Befunde eingearbeitet — es fehlen nicht ein, sondern DREI Kapitel vollstaendig (2 Gesetzliche Grundlagen, 8 Dachbegruenung, 10 Mobilfunkantenne/Satellitenanlage). Einstufung «nicht zitierfaehig» bestaetigt.** |
| [x] 260806 | P3 | `04_Merkblätter/AFS_Leitfaden_Dachlandschaften.pdf` | Run 42 → `destillate/afs-leitfaden-dachlandschaften-2009-vollfassung.md`. Amt für Städtebau Stadt ZH, **Dezember 2009**, 60 S., die Vollfassung. Auslegungshilfe zu § 238/292/302 PBG, Art. 18b/24d/39/43/11 BZO, Art. 18a RPG, § 1/2 BVV. Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 4 Kernbefunde und 4 Nebenbefunde eingearbeitet. Die 17 Solar-Grundsaetze der Kategorien A bis E und die vier Grundsaetze Liftanlage fehlten ganz und sind nachgetragen; saemtliche Grundsatz-Seitenzitate waren systematisch um eine Seite zu tief (gedruckte Seite = PDF-Blatt minus 1, vom Hauptprozess am eigenen Rendering bestaetigt).** |
| [x] 260806 | P3 | `04_Merkblätter/AFS_Leitfaden_klein kunst.pdf` | Run 42 → `destillate/afs-leitfaden-kunst-im-oeffentlichen-raum-2009.md`. **Kein Dachlandschaften- und kein Kleinkunst-Bezug**: Leitfaden «Kunst im öffentlichen Raum», AG KiöR Stadt ZH, 2. Auflage November 2009. «AFS» im Dateinamen ist blosses Ablage-Präfix, nicht die Herausgeberin. Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 2 Kernbefunde eingearbeitet (AfS erscheint sieben- statt zweimal; die zitierte «S. 13» ist im Dokument nirgends gedruckt — es traegt nur auf der ersten Seite jedes Abschnitts eine Foliozahl). Umklassierungs-These vollstaendig bestaetigt.** |
| [x] 260804 | P3 | `04_Merkblätter/AUVA Planungshilfe Anschlagsvorrichtung V101025-klein.pdf` | Run 42 → `destillate/auva-planungsgrundlagen-anschlageinrichtungen-daecher-2010.md`. ⚠ **ÖSTERREICHISCHES Dokument** (AUVA Wien, 10/2010, ÖNORM B 3418) — Werte nicht unbesehen auf CH-Projekte übertragbar; Schweizer Primärquelle ist Suva 44066 (in dieser KB) plus BauAV/EKAS 6512. Verifikation offen. **Run 43 (260804): Refuter BEANSTANDET, 6 Kernbefunde — OENORM EN ist die nationale Veroeffentlichung einer EN und in der CH inhaltsgleich; wirklich national sind OENORM B 3418, Klassenmatrix und die 5-m-Leiterregel (CH: ab 3.0 m Massnahmenpflicht).** |
...
| [x] 260804 | P3 | `04_Merkblätter/Bemessung Kalksandstein.pdf` | Run 42 → `destillate/kalksandstein-bemessung-sia266-ksv-2012.md`. Verband Schweizer Kalksandstein-Produzenten, September 2012, Norm-Anwendungshilfe zu SIA 266. Verifikation offen. **Run 43 (260804): Refuter BEANSTANDET, 10 Kernbefunde — l1 ist NICHT die Deckenspannweite (0.6 l bei Zwischenwaenden, dritte Potenz, Fehlerfaktor 4.6), Gebrauchstauglichkeit mit q_ser,lang und E_c 12e6, Rissweiten-Diagramme ohne Nxo unanwendbar. NICHT als Bemessungsgrundlage verwenden, bis nachgetragen.** |
...
| [x] 260804 | P3 | `04_Merkblätter/Merkblatt-TK004_Fluchtwege_DE.pdf` | Run 42 → `destillate/smu-merkblatt-004-tueren-in-fluchtwegen.md`. SMU/VST, **Verbandsauslegung der Türenindustrie**, keine VKF-Vorschrift. ⚠ stützt sich auf die **VKF-Generation 2003** und ist damit **überholt** (geltend VKF 2015 / BRL 16-15, Stand 2022). Verifikation offen. **Run 43 (260804): Refuter BEANSTANDET, 8 Kernbefunde. DUBLETTE — beschreibt dieselbe Publikation wie `vst-merkblatt-012-tueren-fluchtwegen` (SMU-Ko-Ausgabe des VST-Merkblatts); Zusammenfuehrung destruktiv, Raphaels Entscheid. Echter VKF-Widerspruch belegt (30 m2/6 Pers. gegen BRL 16-15 mit 20 Pers.).** |
| [x] 260804 | P3 | `04_Merkblätter/Merkblatt_16d-06.pdf` | Run 42 → `destillate/crb-merkblatt-16d-06-spachtelungen-weissputze.md`. **CRB** mit SMGV und FRMPP, «Merkblätter zum Devisieren Nr. 16 D/06», 01/2006; Q1-Q4-Oberflächengüte, NPK 643/651/671/675/676, BKP 271.1/271.10. Verifikation offen. **Run 43 (260804): Refuter BEANSTANDET, 6 Kernbefunde — kein falscher Zahlenwert, aber die Streiflicht-Vorbehalte bei Q4 und Q3-geglaettet fehlten. Zusatzbefund mit Hub-Reichweite: BKP 271.10 existiert nicht, richtig 271.0.** |
...
| [x] 260806 | P3 | `04_Merkblätter/Tiefbauamt_Leitfaden.pdf` | Run 42 → `destillate/stadt-zuerich-leitfaden-mobilitaet-2000-watt-2007.md`. **Der Dateiname sagt nichts über den Inhalt**: «Leitfaden Mobilität in der 2000-Watt-Gesellschaft», Tiefbauamt Stadt ZH, Juni 2007 — es geht um die durch ein Bauprojekt induzierte Mobilität, nicht um Werkleitungen oder Strassenabstände. Kein Bewilligungsinstrument. Verifikation offen **Run 45 (260806): Refuter-Runde BEANSTANDET, 3 Kernbefunde, 3 Nebenbefunde und 1 Abdeckungsbefund eingearbeitet (Umsetzbarkeit «mittel» statt «schwierig», behoerdliche Mitwirkung untertrieben, Anhang-Seitenzahlen waren PDF- statt Druckseiten). Die Fallstudien KraftWerk1 und XL Insurance mit ihren MJ/m2-Kennwerten fehlten ganz und sind nachgetragen. Umklassierungs-These vollstaendig bestaetigt.** |
...
| [x] 260804 | P3 | `04_Merkblätter/Wegleitung für Verlegung Gartenplatten.pdf` | Run 42 → `destillate/svdw-wegleitung-gartenplatten-verbundsteine-balkone-terrassen.md`. SVDW/ASTF Technische Kommission Flachdach, **kein Ausgabedatum am Dokument**. Normbezug SIA 271/318/244/118, EN 1339. Zusatzfund: die letzte Scanseite ist **kein Teil der Wegleitung**, sondern ein mitgescannter Fremd-Auszug aus SIA 244:2006. Verifikation offen. **Run 43 (260804): Refuter BEANSTANDET, 8 Kernbefunde — SIA 244 Tab. 4 fuehrt Mindest-PLATTENBREITEN je Dicke, keine Bettungsmasse; Fundstellen systematisch um eine Seite verschoben.** |

<!-- Summe: 69 -->
<!-- Stand 04.08.2026 (Run 43, selbst ausgezaehlt): PL-02-Kern-Nachtrag 69 von 69 Positionen mit Status
     versehen, KEINE offene [ ]-Position mehr in diesem Abschnitt. Von den Erstdestillaten des Run 42
     sind in Run 43 fuenf unabhaengig refuter-geprueft und auf [x] 260804 gehoben (CRB 16 D/06,
     Kalksandstein, SVDW Gartenplatten, SMU-Merkblatt 004, AUVA Anschlageinrichtungen) — ALLE FUENF
     mit Verdikt BEANSTANDET. Es verbleiben 11 Positionen mit Marker [~] (destilliert, Verifikation
     offen). Die fuenf noch offenen [ ]-Zeilen des Gesamtinventars (Zeilen 405-409) sind ausnahmslos
     externe Bring-Schulden (kostenpflichtiger Bezug ueber SIA-Shop bzw. SNV) und in einem
     unbeaufsichtigten Lauf nicht loesbar. -->
...
| [x] 260824 | P2 | `www.suva.ch/44078.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Suva 44078.d «Fassadengerüste — Sicherheit bei der Montage und Demontage», Erstausgabe Dez. 2006, überarbeitete Ausgabe Januar 2022. Vollständig gelesen (pymupdf-Extraktion), Destillat `destillate/suva-44078-2022-fassadengeruest-montage-demontage.md`, status established. War in `wiki/REGISTER.md` Abschnitt D als Bring-Schuld-Kandidat geführt (SIA-Sweep 30. Fortsetzung); jetzt erschlossen. **Werkzeug-Falle:** der Kurzlink `www.suva.ch/waswo/44078.D` lieferte per direktem curl-Abruf die FRANZÖSISCHE Fassung — deutsche Version über gezielte Produktseiten-Abfrage nachbeschafft (SIA-Sweep 31. Fortsetzung, 24.08.2026) |
| [x] 260824 | P2 | `www.suva.ch/44046.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Suva 44046.d «Sicheres Arbeiten im Bereich von Liftschächten», Erstausgabe Juli 1993, überarbeitete Ausgabe Januar 2022. Vollständig gelesen (pymupdf-Extraktion), Destillat `destillate/suva-44046-2022-liftschachtgeruest.md`, status established. Gleiche Sprachfalle wie 44078.d (siehe dort), deutsche Fassung nachbeschafft. SIA-Sweep 31. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/84018.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Suva 84018.d «Acht zentrale Fragen rund um das Rollgerüst», Erstausgabe Juni 1999, überarbeitete Ausgabe November 2003. Vollständig gelesen (pymupdf-Extraktion, Faltprospekt), Destillat `destillate/suva-84018-2003-rollgeruest-acht-fragen.md`, status established. Gleiche Sprachfalle wie 44078.d, deutsche Fassung nachbeschafft. ⚠ Älteste Ausgabe des Laufs, Aktualitäts-Check auf neuere Fassung nicht durchgeführt (offener Punkt im Destillat). SIA-Sweep 31. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/67038.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Suva-Checkliste «Fassadengerüste» (67038.d), Ausgabe Februar 2022. Vollständig gelesen (pymupdf-Extraktion), Destillat `destillate/suva-67038-2022-checkliste-fassadengeruest.md`, status established. Direkter deutscher Download ohne Sprachfalle. SIA-Sweep 31. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/67150.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Suva-Checkliste «Rollgerüste» (67150.d), Ausgabe Juli 2026 — jüngste Suva-Publikation dieser KB. Vollständig gelesen (pymupdf-Extraktion), Destillat `destillate/suva-67150-2026-checkliste-rollgeruest.md`, status established. Direkter deutscher Download ohne Sprachfalle. SIA-Sweep 31. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/33001.d` bis `www.suva.ch/33029.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Neun Suva-Factsheets der Fassadengerüst-Reihe: 33001.d (Auffangnetze), 33017.d (Seitenschutz Bauteile), 33020.d (Gerüstbeläge Fassadengerüst), 33021.d (Gerüstbeläge Spenglergang), 33022.d (Dachdeckerschutzwand), 33023.d (Dachfangwände), 33024.d (Seitenschutz Fassadengerüst), 33025.d (Gerüstzugänge Treppen), 33029.d (PSAgA Fassadengerüstbau). Vollständig gelesen (pymupdf-Extraktion), 9 neue Destillate `destillate/suva-330*.md`, alle status established. **Neue Werkzeug-Falle (abweichend von der 44078-Sprachfalle der 31. Fortsetzung):** `www.suva.ch/waswo/<Nr>.D` lieferte bei ALLEN neun Factsheets per direktem curl-Abruf NICHT das PDF, sondern die HTML-Produktseite mit Sprachauswahl-Dropdown (Content-Type text/html, von pymupdf faelschlich als 6-seitiges "PDF" mit Navigations-/Footer-Text gerendert statt als Fehler erkannt) — am PDF-Metadatentitel bemerkt (fehlte, nur Webseiten-Titel), dann über die HTML-Struktur (`<li class="dropdown-link">` mit Text "PDF Deutsch") den echten `sitecorecontenthub.cloud`-Downloadlink extrahiert. Alle neun Downloads danach mit `file`/PDF-Metadatentitel als deutsch verifiziert (kein Titel mit Sprachsuffix .f/.i). SIA-Sweep 32. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/33026.d`, `www.suva.ch/33028.d`, `www.suva.ch/44002.d`, `www.suva.ch/67018.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Vier Bring-Schuld-Kandidaten aus dem Verweisnetz der 32. Fortsetzung: 33026.d (Arbeitsplattformnetze), 33028.d (Seitenschutz mit Auffangnetzen), 44002.d (Sicherheit durch Anseilen, 36 S. Broschüre statt Factsheet), 67018.d (Checkliste Kleinarbeiten auf Dächern). Vollständig gelesen (pymupdf-Extraktion), 4 neue Destillate `destillate/suva-33026-…md`, `suva-33028-…md`, `suva-44002-…md`, `suva-67018-…md`, alle status established. Gleiche HTML-statt-PDF-Werkzeug-Falle wie die neun Factsheets der 32. Fortsetzung, bei allen vier Publikationen erneut aufgetreten und identisch gelöst (Downloadlink aus "PDF Deutsch"-Dropdown extrahiert). 44002.d nennt in seinem Publikationsverzeichnis ein grosses Netz weiterer, noch unerschlossener Suva-Titel (siehe Destillat-Abschnitt „Offene Punkte"). SIA-Sweep 33. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/33016.d`, `www.suva.ch/33006.d`, `www.suva.ch/33032.d`, `www.suva.ch/33070.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Erste vier Titel des grossen, mit der 33. Fortsetzung entdeckten Bring-Schuld-Blocks (Verweisnetz von 44002.d Kap. 8), thematisch als Seil-/Kletter-Reihe ausgewählt: 33016.d (Arbeiten am hängenden Seil / SZP, Stand März 2026, zweitjüngste Publikation dieser KB), 33006.d (Rigging Veranstaltungstechnik, Stand Mai 2023), 33032.d (Seilwurfsystem Industrieschleuder, Stand Juni 2022), 33070.d (Seilsicherung im steilen Gelände, Stand Januar 2024). Vollständig gelesen (pymupdf-Extraktion), 4 neue Destillate `destillate/suva-33016-…md`, `suva-33006-…md`, `suva-33032-…md`, `suva-33070-…md`, alle status established. Gleiche HTML-statt-PDF-Werkzeug-Falle wie 32./33. Fortsetzung, bei allen vier Publikationen erneut aufgetreten und identisch gelöst. Verbleibender Bring-Schuld-Rest nach diesem Lauf: 12 Suva-Titel (33071.d, 33072.d, 33102.d-33104.d, 44062.d, 44095.d, 44096.d, 88816.d/84044.d, 67055.d, 67064/1.d+67064/2.d) + 2 EKAS-Richtlinien (2134, 6512). SIA-Sweep 34. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/33102.d`, `www.suva.ch/33103.d`, `www.suva.ch/33104.d`, `www.suva.ch/67055.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Vierteilige «Ortsfeste Leitern»-Reihe aus dem Bring-Schuld-Rest der 34. Fortsetzung: 33102.d (Schachtleitern, SN EN 14396, Ausgabe März 2026), 33103.d (Gebäude, DIN 18799, Stand September 2023), 33104.d (maschinelle Anlagen, ISO 14122-4, Stand September 2024), 67055.d (konsolidierte 21-Fragen-Checkliste aller drei Typen, Ausgabe Juli 2024). Vollständig gelesen (pymupdf-Extraktion), 4 neue Destillate `destillate/suva-33102-…md`, `suva-33103-…md`, `suva-33104-…md`, `suva-67055-…md`, alle status established. Direkte PDF-Downloads über den «PDF Deutsch»-Dropdown-Link (keine Sprachfalle wie 44078.d, keine HTML-statt-PDF-Falle wie 32./33. Fortsetzung — bei diesen vier lieferte der Dropdown sofort das korrekte PDF). Kernbefund: drei unterschiedliche Bemessungsnormen je Einbauort mit abweichenden Schwellenwerten (Absturzsicherung 3 m bei Maschinen, sonst 5 m). Neue Cross-Referenzen aus den Texten selbst: 44062.d (aus 33102.d) und 88816.d (aus 67055.d) — beide bereits im Bring-Schuld-Rest geführt, keine neue Zeile nötig. Verbleibender Bring-Schuld-Rest nach diesem Lauf: 8 Suva-Titel (33071.d, 33072.d, 44062.d, 44095.d, 44096.d, 88816.d/84044.d, 67064/1.d+67064/2.d) + 2 EKAS-Richtlinien (2134, 6512). SIA-Sweep 36. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `www.suva.ch/33071.d`, `www.suva.ch/33072.d`, `www.suva.ch/44062.d`, `www.suva.ch/44095.d`, `www.suva.ch/44096.d`, `www.suva.ch/88816.d`, `www.suva.ch/84044.d`, `www.suva.ch/67064-1.d`, `www.suva.ch/67064-2.d` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Restlicher 8-Titel-Block aus der 36. Fortsetzung vollständig erschlossen: 33071.d (Sicher arbeiten auf Bäumen, Stand August 2013), 33072.d (Arbeiten auf der Leiter an Bäumen, Stand November 2022), 44062.d (Sicher arbeiten in Schächten/Gruben/Kanälen, 23 S. Grundlagenpublikation, überarbeitete Ausgabe Juni 2026 — jüngste Suva-Publikation dieser KB nach 67150.d), 44095.d (Sicher zu Energie vom Dach/Solaranlagen, 24 S. inkl. 2 Anhänge, überarbeitete Ausgabe Juli 2024), 44096.d (Anschlageinrichtungen auf Dächern wollen geplant sein, 26 S. inkl. 3 Anhänge, überarbeitete Ausgabe Januar 2022), 88816.d/84044.d (Acht lebenswichtige Regeln Anseilschutz, Instruktionshilfe 31 S. + Faltprospekt 12 S., beide überarbeitete Ausgabe Januar 2022), 67064-1.d/67064-2.d (Checkliste Hubarbeitsbühnen, Teil 1 Planung Dezember 2018 + Teil 2 Kontrolle März 2024). Vollständig gelesen (pymupdf-Extraktion), 8 neue Destillate `destillate/suva-33071-…md`, `suva-33072-…md`, `suva-44062-…md`, `suva-44095-…md`, `suva-44096-…md`, `suva-88816-…md`, `suva-84044-…md`, `suva-67064-1-…md`, `suva-67064-2-…md`, alle status established. Gleiche HTML-Produktseiten-Route mit «PDF Deutsch»-Dropdown, keine Sprach- oder HTML-statt-PDF-Falle bei diesen neun. **Zusätzlich beide EKAS-Richtlinien geprüft:** 2134 (Forstarbeiten, 76 S.) und 6512 (Arbeitsmittel, 32 S.) sind entgegen der bisherigen Vermutung **kostenlos** direkt als PDF verfügbar (`ekas.admin.ch/fileadmin/Dokumente/Richtlinien/gueltig/`), aber als umfangreiche Rechtsgrundlagen-Dokumente noch **nicht** destilliert — eigener Aufwand für den nächsten Lauf. Damit sind alle acht namentlich benannten Suva-Titel des ursprünglichen Bring-Schuld-Blocks (Verweisnetz 44002.d Kap. 8) erschlossen; aus den neun Destillaten selbst ist ein deutlich breiterer neuer Cross-Referenzen-Rest entstanden (Baumpflege 67156.d, Solar/Asbest 33027.d/33031.d/33068.d, Elektrizität/Dächer 84041.d/88815.d/84042.d/88814.d, Hubarbeitsbühnen/Krane 88180.d/66138.d, Ausbildung 66109.d/66110.d/66112.d, u. a. — vollständige Liste in `wiki/REGISTER.md` Abschnitt D). SIA-Sweep 37. Fortsetzung, 24.08.2026 |
| [x] 260824 | P2 | `ekas.admin.ch/fileadmin/Dokumente/Richtlinien/gueltig/06512_d_2017_01_01.pdf`, `.../02134_d.pdf` (Web, kostenlos, kein SharePoint-Bestand zu erwarten) | Beide von der 37. Fortsetzung als «noch nicht destilliert» zurückgelassenen EKAS-Richtlinien erschlossen: **6512** «Arbeitsmittel» (vom 19.10.2001, Stand 01.01.2017, 32 S.) vollständig gelesen, Destillat `destillate/ekas-6512-arbeitsmittel.md`, established — Ziff. 5.3 (Art. 32a Abs. 3 VUV) verlangt dokumentierte Überprüfung von Baugerüsten/Rollgerüsten/Baustellenaufzügen nach jeder Montage, direkt bauleitungsrelevant. **2134** «Forstarbeiten» (vom 06.12.2017, Stand 27.06.2025, 76 S.) Hauptteil (Ziff. 1-7) + Anhang 7 (Ausbildungsstufen F1-F7) + Anhang 12-14 (Rechtsgrundlagen/Fachunterlagen/Normen) vollständig gelesen, Anhänge 2-6/8-11 nur über Inhaltsverzeichnis erschlossen, Destillat `destillate/ekas-2134-forstarbeiten.md`, established — zentrale Kennzahl Fall- und Gefahrenbereich = doppelte Baumlänge (Ziff. 6.1.5), deckt sich mit den bereits destillierten Suva-33071.d/33072.d und ist deren Rechtsgrundlage. Beschaffung per `curl -sL`, Extraktion `pdftotext -layout`; Direktlinks über die eingebettete JSON-Struktur der generischen EKAS-Übersichtsseite ermittelt (die Kurzlinks `ekas.admin.ch/<nr>.d` funktionieren anders als bei Suva nicht). QUESTIONS-Abarbeitung, 24.08.2026 |
| [x] 260824 | P2 | Kollisionsauflösung (kein neuer Beschaffungsweg) + `www.suva.ch/waswo/33042.d`-`33047.d` (Web, kostenlos) | **Kollision mit parallelem Lauf («QUESTIONS-Abarbeitung», ~03:55 Uhr) aufgelöst:** derselbe offene Punkt der 37. Fortsetzung (EKAS 6512/2134 destillieren) wurde von diesem Lauf UND einem gleichzeitig laufenden Prozess unabhängig bearbeitet, beide legten eigene Destillate an (`ekas-6512-arbeitsmittel.md`/`ekas-2134-forstarbeiten.md` vs. `ekas-6512-2017-richtlinie-arbeitsmittel.md`/`ekas-2134-2025-richtlinie-forstarbeiten.md`). Beim routinemässigen INDEX-Abgleich entdeckt; die Fassungen des parallelen Laufs waren an sicherheitsrelevanten Kennzahlen (Fall-/Gefahrenbereich doppelte Baumlänge, Leiter-Schwellenwerte 2 m/5 m) nachweislich tiefer gelesen und bereits korrekt in `wiki/REGISTER.md`/`destillate/INDEX.md` verzeichnet — die eigenen zwei Duplikate darum gelöscht (eine bereits vom 15-Min-`nas-selfcommit`-Cron miterfasst, `git rm --cached`+`rm`; die andere noch untracked, `rm`), keine inhaltliche Substanz verloren. Vollständig dokumentiert in `wiki/QUESTIONS.md` (Abschnitt «EKAS 2134/6512 zweimal parallel destilliert»). **Zusätzlich dritte offene Frage der 37. Fortsetzung geklärt:** 33045.d (in `suva-44096.d`/`suva-88816.d` als «ungeklärte Nummer, ggf. Vorgänger der Ortsfeste-Leitern-Reihe» geführt) existiert nicht — `www.suva.ch/waswo/33045.d` liefert HTTP 404, ebenso 33046.d; Nachbarnummern 33042.d-33044.d/33047.d sind Asbest-Fensterkitt-/Faserzement-Factsheets, thematisch fremd. Vermutung widerlegt, in beiden Destillaten sowie `wiki/REGISTER.md` Abschnitt D nachgeführt. Der 16-Titel-Cross-Referenzen-Rest (Baumpflege, Solar/Asbest, Hubarbeitsbühnen/Krane, Ausbildung) bleibt bewusst unbearbeitet — wartet laut `wiki/QUESTIONS.md` auf Raphaels Entscheid, ob der Sweep über den ursprünglichen SIA-Teilauftrag hinaus fortgesetzt werden soll. SIA-Sweep 38. Fortsetzung, 24.08.2026 |
| — 260830 | — | Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]`) | **Normen-Nacht Run 66, Vertiefungsstufe (c): Q&A-Runde auf dem Figurenanhang von `destillate/sia-416-2003.md` (S. 44-57)** — die von Run 65 als N65-3 ausgewiesene Lücke: die einzige der drei etablierten Prüfrichtungen, die auf dem praktisch folgenreichsten Teil nie gelaufen war. Vier blinde Agenten (kein Destillat, nur Prüfungsfragen, je eigenes Render-Präfix), danach jede Abweichung vom Hauptprozess am Original entschieden. **Ergebnis: 1 Kernbefund, 3 nie geführte Darstellungsregeln, 2 Präzisierungen, 1 geschlossener offener Punkt, 1 widerlegte Agentenbehauptung — kein falscher Zahlenwert (der Anhang enthält keine Zahlen, was beim Bewerten der Ausbeute mitzudenken ist).** **Der Kernbefund ist rechnerisch, nicht visuell gewonnen:** die Darstellungskonvention der Figur 12 war graphisch falsch beschrieben («Vollton = Schnitt, Schraffur = Ansicht»). Gemessen sind **beide** AKV-Signaturen schraffiert und trennen sich am Grund (gefüllt 0 % Weiss gegen weiss 79 %); ein «Vollton braun» ist in der Gesamtlegende die Signatur von **KV (5.2), einer Innen-Kategorie** — die alte Formulierung verwies auf die falsche Kategorie. Zudem führt die Gesamtlegende S. 45 AKV **nur** geschnitten; die Ansichts-Signatur existiert allein in Figur 12 und ist dort nirgends erklärt. Neu geführt: **Tür-/Fensternischen** sind in Figur 3 in der Wandfarbe mit gestricheltem Umriss gezeichnet und zählen zur KF (in Figur 4 weiss, also nicht NGF) — beim Aufmass werden Türöffnungen nicht abgezogen; das **⊠-Schachtsymbol** ist über den Vergleich Fig. 3/Fig. 4 entschlüsselt (unkoloriert = nicht KF, blau = FF) und macht die Ausnahme «sofern nicht der NGF zugeordnet» sichtbar; die **freistehende Stütze** als isoliertes KFT-Feld. Präzisiert: die Zuordnung tragend/nichttragend wechselt **innerhalb** eines Wandzugs (feiner als das bisherige «wandscheibenscharf»), und in Figur 6 wechselt die durchgehend eingefärbte Platte die Kategorie **an der Fassadenflucht** — damit ist die massgebende Aufmasskante für Balkon-/Terrassenflächen benannt. **Figur 7 ist jetzt Beispiel für Beispiel ausgedeutet** (offener Punkt geschlossen): Zeile 4 ist ein bewusstes **Vergleichspaar** derselben Gebäudeform mit und ohne Terrainanschluss, und die **gestrichelte Diagonale** verbindet in beiden Vorkommen zwei UF-Segmente auf verschiedenen Niveaus — gedachter Geländeverlauf, **keine** Projektionsregel. Alle übrigen Einzelbeispiele **bestätigen** die schon geführten drei Kriterien (Methodik-Pflicht 7: als Bestätigung, nicht als Befund protokolliert). **Widerlegt:** ein Agent meldete mit Pixelmessung, der Massstrang der Figur 8 reiche tiefer als die Farbfläche. Gegenmessung des Hauptprozesses am eigenen 600-dpi-Rendering: unterster Tick y=3594, tiefste Farbe y=3647, Ende der blossen Achslinie y=3711 — die Farbe reicht **2.24 mm auf dem Blatt tiefer** als die letzte Segmentgrenze; der Agent hatte das Ende der Achslinie für das Ende des Massstrangs gehalten. Run-65-Befund unabhängig reproduziert. **Zusätzlich erstmals die Fundstellen-Richtung gefahren (N63-2, Pilot auf einem Destillat): 109 Fundstellen geprüft, 104 korrekt, 1 falsch (S. 1-17 statt S. 1-16), 4 nicht prüfbar, null falsche Ziffern.** Alle Befunde stehen **einzeln mit Fundstelle** in der Anlage `training/n66-qa-anhang-anlage.md` (löst den Run-65-Vorschlag N65-1 ein). Seiten-Inventur des Anhangs erstellt, Seitenversatz an 14 von 14 Seiten null. Status bleibt `speculative`. Report `outputs/2026-08-30_normen-nacht-run66.md` |
| — 260829 | — | Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]`) | **Normen-Nacht Run 65, Vertiefungsstufe (b): Refuter-Runde auf `destillate/sia-416-2003.md`** — die von Run 64 offen gelassene zweite Prüfrichtung (N64-2). Sechs parallele Refuter-Agenten über Vorwort/Ziff. 0, Ziff. 1-3, Ziff. 4 inkl. Matrix, Ziff. 5-6, Figuren 1-7 und Figuren 8-12; alle Kernbefunde vom Hauptprozess am Original nachgeprüft (eigene Renderings, Präfix `hauptprozess-r65-`). **Ergebnis: 51 Behauptungen geprüft, 1 widerlegt, 4 eingeschränkt, kein einziger falscher Zahlenwert.** Die Widerlegung: Ziff. 0.2 wurde als unbedingte Pflicht geführt («Teilflächen immer mit übergeordneten darstellen»), die Norm formuliert **bedingt und als Soll-Vorschrift** — der Fehlertyp weggelassene Bedingung, den nur die Refuter-Richtung findet. **Zwei neue Kernbefunde zum GV-Umfang**, beide am eigenen 500-dpi-Ausschnitt abgelesen und mit Ziff. 6 gegengeprüft: der **Dachüberstand** und **auskragende Balkonplatten** sind in Figur 8 unkoloriert, zählen also **nicht zum GV**, sondern zum AKV nach Ziff. 6. Dazu die Berichtigung des Run-64-Befundes: **der eingefärbte Umriss, nicht der Höhen-Massstrang, definiert den Umfang** — beide sind am Fusspunkt nachweislich nicht deckungsgleich (unterstes H-Segment endet an der UK Bodenplatte, das gespreizte Fundament darunter ist eingefärbt). Weiter präzisiert: der Legendencode Vollfarbe/Schraffur ist **nicht durchgehend** — aussen fehlt ein «ANNF» (HNF und NNF fallen beide auf ANF), und volumenseitig ist nur KV↔AKV gepaart. **N64-5 beantwortet** über den f/i-Kontrolltext: alle drei Sprachfassungen der Ziff. 5 sind wortgleich knapp, «Dicke Dach» und «H DG» fehlen in Begriffsliste und Anhang-Legende — die Höhenbeschriftung ist **illustrativ**, normativ trägt der Umriss. Status bleibt `speculative` (Q&A auf dem Figurenanhang nie gelaufen). **N64-1 als nicht abarbeitbar berichtigt:** die 18 Nebenbefunde stehen im Run-64-Report nur als Zahl, nicht einzeln, und eine `training/`-Anlage existiert nicht. Report `outputs/2026-08-29_normen-nacht-run65.md` |
| — 260828 | — | Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]`) | **Normen-Nacht Run 64, Vertiefungsstufe (b): Abdeckungsrunde auf `destillate/sia-416-2003.md`** — Rang 1 der N62-3-Kandidatenliste (12 entscheidungstragende Konsumenten, davon 4 rechnende Agenten). Ergebnis: **12 Kern- und 18 Nebenlücken, kein einziger falscher Wert.** Folgenreichster Fund: die **Messregel für die Gebäudehöhe** steht nicht in Ziff. 5, sondern allein in Figur 8 (S. 53) — geschossweise Segmente plus ein eigenes Segment «Dicke Dach» bis zum First; das GV reicht damit bis zur Dachaussenhaut. Weiter: Ziff. 4.3 entzieht auch die **Aussen-Konstruktionsfläche AKF** der Sonder-/Gemeinschaftszuordnung (Destillat führte nur GGF und KF, Matrix am Rendering abgelesen, Methodik-Pflicht 8); die Vier-Faktoren-Regel Quantität/Form/Qualität/Komplexität aus Ziff. 0.2 und dem Vorwort fehlte ganz; Laubengang ist AVF, nicht ANF (Figur 6). **Der Anhang S. 49-57 war nie eingesehen** — das Frontmatter wies nur S. 44-48 aus, tatsächlich reicht er bis S. 57 (Figuren 1-12). Status auf `speculative` herabgestuft, Prüfstand-Tabelle gesetzt. Seitenversatz null, an S. 5 und S. 17 abgelesen; Präfix `sia416-r64-`. **Zusätzlich die in Run 63 offene Stichproben-Kalibrierung gefahren** (blinder Lauf auf `sia-118-1991` in der Fassung vor Run 62, Kapitel 1/5/6 per Seed gezogen): 17 Kern-/9 Nebenfunde, die vier folgenreichsten Vollrunden-Befunde blind reproduziert, keine Falsch-Positive — aber die Stichprobe schlug in allen drei Kapiteln an und spart bei einem betroffenen Destillat nichts. Anlage `training/n64-stichproben-kalibrierung.md`. Report `outputs/2026-08-28_normen-nacht-run64.md` |
| — 260827 | — | Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]`; jüngste Bestandsdatei 07.08.2026) | **Normen-Nacht Run 63, Vertiefungsstufe (b): Abdeckungsrunde auf `destillate/sia-102-2020.md`.** Erstmals lief auf diesem Destillat die Abdeckungsrichtung (Methodik-Pflicht 13); es trug seit 14.07.2026 `established` allein auf Grundlage von Refuter- und Q&A-Runden. Ergebnis: **34 Kern- und 52 Nebenlücken, ein Fundstellenfehler, kein einziger falscher Wert.** Kernbefunde inline eingearbeitet, Status auf `speculative` herabgestuft, Prüfstand-Tabelle ins Destillat. Quelle ist ein **Scan ohne Textlayer** — vollständig visuell an 200-dpi-Renderings gearbeitet (Präfix `sia102-r63-`), Seitenversatz an S. 5 und S. 30 abgelesen und null. Strukturbefund: die Norm baut jede Teilphase als Tabelle mit fünf Leistungsbereichen plus AG-Block, das Destillat hatte durchgehend nur die Spalte *Auftragsgegenstand*. **Zusätzlich N62-3 beantwortet:** von 310 `established`-Destillaten tragen 2 einen Prüfstand, beide DIN (Mac-Mini-Scope), im SIA/VKF-Bestand keines — Kandidatenliste `training/n62-3-pruefstand-kandidaten.md`, nächster Kandidat `sia-416-2003.md`. Ausbreitungs-Check ergab einen Treffer: `wiki/synthese-sia-vkf-fachskills.md` trug die verschmolzene Ziff.-3.3.2/3.3.5-Aussage weiter, korrigiert. Report `outputs/2026-08-27_normen-nacht-run63.md` |
| — 260902 | — | Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]` im SIA/VKF-Scope) | **Normen-Nacht Run 77, Vertiefungsstufe (b): messende Abdeckungsrunde des Hauptprozesses auf Figur 11 von `destillate/sia-416-2003.md`** — der von Run 66 als **N66-1** ausgewiesene Rückstand, die einzige Stelle des Destillats, die nur über Agentenaugen gesehen war. **N66-1 geschlossen.** Der gemeldete blaue Streifen ist **bestätigt** (waagrechte Installationszone im FV, unterhalb des Deckenkörpers gemessen; Ziff. 2.1.3 nennt «Installationsgeschosse sowie Ver- und Entsorgungskanäle» ausdrücklich). Der orange Keil ist als **Beobachtung bestätigt**, seine Begründung «zu geringe Raumhöhe» als Norm-Kriterium dagegen **nicht**: SIA 416 kennt keinen Raumhöhen-Schwellenwert, unabhängig am ganzen deutschen Normteil S. 3-16 gegengeprüft. **Fünf Befunde aus einer einzigen Figur, zwei mit Hub-Reichweite:** (1) **Volumenanteile sind nicht aus Flächenanteilen ableitbar** — über derselben Grundfläche liegen HNV und FV übereinander, und der Luftraum, der in Figur 1 unkoloriert bleibt, zählt im Volumen voll mit; (2) **die NGV-Kategorien sind nicht geschossweise geschnitten** (zweigeschossiger Raum über EG/1. OG mit nur teilweise gezeichneter Decke, Schachtfuss 45 % ins 2.-UG-Band). Dazu die HNV/NNV-Grenze ohne Konstruktion (`S12` ohne weissen Kern gegen `S6 W18–28 S6` bei jeder echten Wand) und die innenliegende Treppe in HNV-Farbe (Bestätigung einer schon geführten Regel, Methodik-Pflicht 7). **Eine Selbstkorrektur im Lauf:** die eigene Aufnahme «einziger eingefärbter Bereich im 2. UG» war falsch — ein Refuter widersprach, die Nachmessung des Hauptprozesses gab ihm recht, und die Zahl stand die ganze Zeit in der eigenen Regionenliste. **Status bewusst NICHT auf `established` gehoben**, obwohl alle vier Prüfrichtungen auf allen Teilen gelaufen sind und vier Runden keinen falschen Wert fanden: die messende Abdeckung lief auf **1 von 12 Figuren** und hat dort fünf Befunde gehoben — nach der Methoden-Lehre misst eine ertragreiche Runde die Quelle, nicht die Methode. **Zweiter Beleg für N66-2** (Signaturen messen statt betrachten) erbracht und damit Raphael vorgelegt; die **ID-Kollision N66-1/N66-2** zwischen den zwei Run-Nummernkreisen als N77-3 protokolliert, nicht selbständig umnummeriert. Vier zitierende Bausteine (`agents/flaechen-nachweis`, `skills/kostenkontrolle` 2×, `skills/wettbewerb`, `baurecht/wiki/nutzungsziffern`) mit dem `speculative`-Vermerk versehen (Rule `normen-referenz` 1b). Anlage `training/n77-figur11-anlage.md`, Report `outputs/2026-09-02_normen-nacht-run77.md` |
| — 260903 | — | Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]` im SIA/VKF-Scope) | **Normen-Nacht Run 78, Vertiefungsstufe (b): messende Abdeckungsrunde des Hauptprozesses auf den Figuren 1-10 und 12 von `destillate/sia-416-2003.md`** — der von Run 77 als erster von zwei Hebungs-Blockern benannte Rückstand (die messende Abdeckung lief auf 1 von 12 Figuren). **Geschlossen.** Methode: alle Anhangseiten selbst gerendert (Präfix `sia416-r78-`), Legenden-Swatches je Figur an der Figur gemessen, die drei Figurenserien gegeneinander registriert und **kreuztabelliert** — der Test prüft nicht, ob eine Aussage stimmt, sondern ob die Figuren untereinander aufgehen. Drei unabhängige Refuter-Agenten. **17 Behauptungen: 11 bestätigt, 5 eingeschränkt, 1 Zahlenwert widerlegt** (eine Behauptung des Laufs selbst, vom Hauptprozess unabhängig schon berichtigt); **kein falscher Zahlenwert des Bestands in fünf Prüfrunden.** **Zwei Kernbefunde mit Hub-Reichweite:** (1) **die Fläche/Volumen-Paarung bricht bei den Aussenkategorien ab** — HNF↔HNV, NNF↔NNV, VF↔VV, FF↔FV sind gepaart, **ANF und AVF haben kein Volumen-Pendant**; über Balkon- und Laubengangplatte ist der Raum in allen fünf Volumenfiguren leer. Praxisfolge: CHF/m³ GV ist gegenüber Aussenflächen blind, CHF/m² nicht (`grobkosten-onepager`, `machbarkeit-studio`, `grobkosten-rechner`). (2) **KV ist aus KF nicht hochrechenbar** — Geschossdecken sind KV (Deckenzone: GV 0.737, NGV 0.000, KV 0.684) und haben im Grundriss kein Pendant; 39.2 % des KV liegen in den waagrechten Platten. **Damit N77-1 vollständig geschlossen.** Weiter: **Figur 4 klassiert zwei Treppen desselben Grundrisses verschieden** (gemeinschaftlich VF, wohnungsintern HNF; Treppen sind nie KF, der Luftraum ist netto zu messen); **die Flächen der Figuren 5/6 sind Bänder ohne Massbedeutung** (alle 14 Bänder 52-54 px hoch bei Bandabständen von 100 bis 253 px; dasselbe Feld in Fig. 5 bei y720-772, in Fig. 6 bei y749-800 — 29 px versetzt bei deckungsgleichen Referenzlinien); **die raumweise Zuordnung der Figur 6** und der **vollständige Bestand des AKV in Figur 12** (sechs Elementgruppen, darunter ein über beide Balkongeschosse durchlaufendes Bauteil in Ansicht) erstmals aufgenommen; **die Gesamtlegende S. 44/45 vollständig ausgezählt** (9+7 Flächen, 7+1 Volumen; alle 24 Signaturen Weissanteil 0.000; braun trägt drei Bedeutungen). **Additivität beider Serien pixelgenau, dreifach unabhängig belegt** (Hauptprozess null Abweichungsregion > 1200 px in acht Richtungen · Refuter A grösste nicht-linienartige Komponente 213 px · Refuter C IoU 0.986/0.990). **Der Hauptprozess hat zwei Refuter-Quantifizierungen seinerseits widerlegt bzw. nicht übernommen** (Massstabsdifferenz Fig. 5 gegen Fig. 8 — die Referenz war der Textrand, nicht das Gebäude; Höhen-Deutung der NNF-Insel — Run 77 hat sie bereits am Normtext widerlegt). Status bleibt `speculative`; **einziger verbleibender Blocker ist der f/i-Sprachdiff**, und ob der überhaupt Voraussetzung sein soll, ist als **N78-1** Raphael vorgelegt (betrifft alle dfi-Normen der KB). Anlage `training/n78-figuren-1-10-12-anlage.md`, Report `outputs/2026-09-03_normen-nacht-run78.md` |

**Run 79 (04.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — Abdeckungsrichtung erstmals gefahren auf `vkf-brl-13-15-baustoffe-bauteile` (9 Kern-, 6 Nebenlücken, 0 falsche Werte, Status bleibt `established`) und `vkf-brl-15-15-brandschutzabstaende-tragwerke` (27 Kern-, 6 Nebenlücken + 1 falsche Angabe, **Status auf `speculative` herabgestuft**). Zusätzlich: Spezifität der Stichprobenstufe erstmals gemessen (`training/n79-spezifitaet-kalibrierung-260904.md`, 3/3 Sensitivität · 0 Kern-Falschbefunde Spezifität) und vier falsche Bestandsaussagen in SIA-118-Destillaten berichtigt. Keine DIN-/VSS-/RAL-Position berührt.

**Run 80 (07.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — die zwei von Run 79 selbst als offen ausgewiesenen Teile von `vkf-brl-15-15-brandschutzabstaende-tragwerke` nachgemessen. (1) **Ersatzmassnahmen-Matrix S. 23 aufgenommen** (Methodik-Pflicht 8: die Seite trägt keinen Textlayer; 18 Zellen rechnerisch über Farb-Blobs gemessen, von einem unabhängigen Refuter mit eigenem Rendering und eigener Rasterbestimmung in allen 18 Zellen repliziert) — Kernaussage: unter 2 m Gebäudeabstand tragen nur noch Variante D (beidseitig) und die öffnungslose Variante F (einseitig). (2) **Tabellen 2 und 3 erstmals vom Hauptprozess zellenweise abgelesen** — 6 weitere Kernlücken, **0 falsche Werte**: die Löschanlagen-Zeile der Gruppe 1 in Tab. 1 fehlte ganz (Tragwerk «k. A.», Geschossdecke **EI 30 statt REI 30** — die einzige Stelle der Richtlinie ohne R-Anteil), Fussnote [9] nie geführt, und vier Sonderheiten, die allein Hochhäuser betreffen ([a]/[b] wertidentisch, Kategorie [c] und «Landwirtschaft» fehlen, Parking und EI 90 ohne Fussnote). (3) **Fassungsvergleich 2015/2017 auf S. 22-23 erstmals als Bildvergleich** (Methodik-Pflicht 4) statt als Volltextvergleich: alle 18 Matrixzellen und alle sechs Variantenzeichnungen sind unverändert — gemessen, nicht behauptet —, geändert ist der Wortlaut an vier Stellen; die Destillat-Aussage «Änderung beschränkt sich auf Beschluss-Vermerk und Layout» ist entsprechend berichtigt. (4) Ein scheinbar offener Punkt hat sich als **bereits in der KB vorhanden** erwiesen (Methodik-Pflicht 7/10): die Definition der Beherbergungskategorien [a]/[b]/[c] samt der **20-Personen-Schwelle** steht in `vkf-brl-10-15-begriffe-definitionen` — verlinkt und mit Fassungsvorbehalt übernommen, nicht als Lücke verbucht. Status des Destillats unverändert `speculative` (Refuter-Richtung auf keinem Nachtrag gelaufen). Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]` im SIA/VKF-Scope). Report `outputs/2026-09-07_normen-nacht-run80.md`, Anlage `training/n80-matrix-ersatzmassnahmen-260907.md`

**Run 81 (08.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — den von Run 80 als naheliegendsten benannten Auftrag **N80-1 geschlossen**: der Fassungsvergleich 2015/2017 von `vkf-brl-15-15-brandschutzabstaende-tragwerke` war erst auf S. 22-23 messend gefahren. Run 81 hat ihn über **alle 35 Seitenpaare** gefahren (150-dpi-Sweep + Volltext-Delta über das ganze Dokument + 300-dpi-Bildvergleich auf den drei offenen Anhangseiten). **Ein Kernbefund: S. 34 (Ziff. 3.7.13) trägt eine inhaltliche Änderung**, die der Bestand seit Run 7 als «inhaltlich unverändert» führte — die Befreiung bei Löschanlagenvollschutz ist 2017 örtlich (nur noch der Anschluss an die Aussenwand statt der ganzen Fassadenaussenseite) und sachlich (nur noch *bauliche* Massnahmen) enger gefasst; der Kernziffern-Teil gab die Fassung 2017 bereits richtig wieder, falsch war allein die Delta-Aussage. **S. 27 und S. 33 bestätigt, beide mit berichtigter Begründung** (S. 27: nur «Bedachungen» → «Dachkonstruktionen» in der Überschrift, gemessener Zeilenversatz 53 px, Restdifferenz −97.4 %; S. 33: Zeichnung unverändert bei dy = 0, der Beschriftungsblock ist um die Zeile «mit Löschanlage → beliebig» gewachsen). **Zwei methodische Belege:** (a) die S.-33-Änderung ist im **Textlayer unsichtbar** — die Seite ist in beiden Fassungen wortgleich (261 Zeichen), «beliebig» kommt darin nicht vor; (b) der Textlayer **verfälscht Vergleichszeichen** («≤ 1'200 m²» wird als «<» extrahiert), erstmals an einer VKF-Richtlinie belegt — das Destillat ist korrekt, weil Run 79/80 am Rendering gelesen haben. **Zwei Scheinbefunde durch Gegenprobe abgefangen:** «m» → «m2» ist ein Encoding-Artefakt (beide Fassungen drucken «m²»), und die acht seitenweise als abweichend gemeldeten, nicht angekündigten Seiten sind **Reflow**, nicht Inhalt. Die Änderungsliste auf S. 2 ist damit für alle anforderungsrelevanten Änderungen **vollständig**; nicht genannt sind nur vier orthografische Korrekturen. Status unverändert `speculative` (N80-2, Refuter-Richtung weiterhin nicht gelaufen). Kein neues Grunddestillat (PL-02/PL-03 weiterhin 0 offene `[ ]` im SIA/VKF-Scope); keine DIN-/VSS-/RAL-Position berührt. Report `outputs/2026-09-08_normen-nacht-run81.md`, Anlage `training/n81-fassungsvergleich-260908.md`

**Run 82 (09.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — den von Run 81 offen gelassenen Auftrag **N81-2 messend geschlossen**, mit entwarnendem Ergebnis. Gebaut wurde dafür eine kontrastierende Unterstrich-Messung (`training/n82-vergleichszeichen-sweep-260909.md`), die an **acht** unabhängig sichtgeprüften Fundstellen kalibriert ist und damit auch die Spezifitäts-Lücke schliesst, die Run 50, 79, 80 und 81 je ausgewiesen hatten; die **erste** Fassung der Messung mass Tabellenrahmen statt Unterstriche und ist als Fehlversuch dokumentiert. Prüfmenge **190 distinkte Fundstellen** über beide Ablagen (Methodik-Pflicht 1) plus 146 aus 14 vorgefilterten SIA-Dateien. Befund: der Defekt «≤ gedruckt / < extrahiert» betrifft genau **zwei Richtlinien** — die bekannte BRL 15-15 und die **BRL 24-15 «Wärmetechnische Anlagen»** (S. 19 «A = K × P ≥ 150 cm²», S. 37 «Sicherheitsabstand x1/x2 ≤ 50 mm»); beide Werte standen im Destillat **bereits richtig** und sind jetzt inline mit Rendering-Beleg verifiziert. **Kein verschobener Grenzwert im ganzen VKF-Bestand, kein echter Fall im SIA-Bestand.** Gegenbefund: die 76 isolierten «>» der BRL 21-15 sind gedruckt so gewollt — die Abwesenheit von «≥» ist **kein** Defektindiz. Schwererer Nebenbefund: die zwei destillierten SIA-Originale mit **OCR-Producer** («Paper Capture Plug-in», SIA 180:2014 und SIA 500:2009) halluzinieren in Grafikbereichen Zeichen; beide Destillate hatten das erkannt, bevor jemand nachmass. Daraus die Producer-Typologie A-D als Vorschlag **N82-1** (Entscheid Raphael). Mitgeschlossen: alle 11 destillierten Originale mit Scanner-Producer haben **0** extrahierbare Zeichen und sind strukturell gefeit. Kein neues Grunddestillat, `[ ]`-Positionen unverändert; die einzige P1-Position SIA 181:**2020** bleibt Bring-Schuld (im Haus nur 181:2006 und 181:1988, am Bestand geprüft). Keine Statushebung (N82-5). Neu offen: N82-1 bis N82-5.

**Run 83 (10.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — den von Run 82 als «grösste offene Kante» ausgewiesenen Auftrag **N82-2 geschlossen**: über den ganzen Scope (379 Destillate ausser DIN/VSS/RAL) lösen **302 über den notierten `quelle:`-Pfad exakt auf**, 69 sind legitime externe Quellen, 7 führen `sources:` statt `quelle:`, 1 zeigt auf ein Verzeichnis, **0** hängen an einem nur zufällig rettbaren Pfad. **Vier echte tote Pfade gefunden und repariert** (VKF 100-15 ×2, 101-15, 102-15 — notiert unter `02_Brandschutzrichtlinien 2015/`, real unter `04_Erlaeuterungen Brandschutz 2015/`), je einzeln nachgemessen (4/4 OK, vorher 0/4). Der Weg dorthin kostete **vier eigene Werkzeugfehler**, darunter eine Bestandswurzel eine Ebene zu tief (587 von 1327 PDF fehlten im Index). **Anschlussfund: eine zweite Verfälschungs-Mechanik** — in `162.051_A1_2004_d.pdf` ist «≤» als «d» und «≥» als «t» kodiert, am 300-dpi-Rendering verifiziert; sie hinterlässt kein isoliertes «<» und ist für die Run-82-Anlage strukturell unsichtbar (N82-3 teilweise beantwortet). Reichweite über 284 distinkte PDF gemessen: **ein einziger Fall**, und das Destillat führt ihn korrekt. Methodik-Pflicht 7 dreimal bestätigt (VKF-Gattung, Symbol-Substitution, Brandschutznorm-Grenzwerte — je richtig beobachtet, je kein Befund). Kein neues Grunddestillat, keine Statushebung (Refuter-Richtung nicht gelaufen, Methodik-Pflicht 13). Neu vorgelegt: **N83-1** (17 Dateinamen der VKF-100er-Reihe tragen die falsche Gattung «brl» statt «bse» — inhaltlich überall richtig, Umbenennung destruktiv) und **N83-2** (Risikokarte, 52 Destillate). Karte: `training/n83-quellenaufloesung-260910.md`; Report: `outputs/2026-09-10_normen-nacht-run83.md`.

**Run 84 (11.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — Risikokarte **N83-2** in der Klasse «Textlayer ohne ≤/≥» vollständig abgearbeitet (26 Destillate in Run 84, 2 in Run 83): 90 Grenzwerte am Rendering, **kein falscher Wert**, 8 von 8 untergeschobene Kontrollwerte erkannt. **Sieben neue Textlayer-Mechaniken** (N82-3), die gefährlichste die Pi-Schrift SchwabePi der SIA-Normen 2006 (≤ → «9», ≥ → «0», Scheinzahlen). Sechs Bestandsfehler inline korrigiert, keiner ein verschobener Grenzwert (SIA 181:2006 Tab. 3 L_r-Schwellen, SIA 108 fünf Kriterien, BRL 24-15 elf Temperaturklassen, Suva 44006, GVZ MFH, BSPUB-57). **WC57-N2 geschlossen:** SIA 181:2006 Anhang G/H/J destilliert und refutiert (KISPI PL57-1). Kein neues Grunddestillat; `[ ]`-Positionen unverändert (nur Bring-Schulden: SIA 181:2020 P1, SIA 491, SN EN 12193 sowie VSS im Mac-Mini-Scope). Neu offen: N84-1 bis N84-3. Anlage `training/n84-textlayer-mechaniken-260911.md`, Report `outputs/2026-09-11_normen-nacht-run84.md`.

**Run 85 (15.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) — Risikokarte **N83-2** in der letzten Klasse «Quelle ohne Textlayer» (Typ A, **N84-2**) abgearbeitet: 22 Destillate, 136 Aussagen in sechs blinden Paketen, jede Relation am selbst gerenderten Scan; **14 von 14 untergeschobenen Kontrollwerten erkannt**. Kein vertauschtes ≤/≥ und kein falscher Zahlenwert im Bestand, aber **34 übernommene Befunde**, alle inline korrigiert: 5 Relations- und Grenzfehler (zweimal < statt ≤, einmal ≥ statt >, «unter» statt «nie höher als», eine falsche Baujahrs-Klassengrenze), 9 fehlende Bedingungen oder Geltungsbereiche, 8 Zuordnungs- und Kontextfehler, 12 Fundstellen, Formalien und normeigene Vermerke; der folgenreichste: der SIA-312-Praxis-Transfer nannte die Abflussbeiwerte «direkt verwendbar» für den GEP, die Norm sagt, sie liegen höher als die GEP-Werte. **Statusabstieg** `lignum-4-2` → `speculative` (vierte Runde hatte null Befunde gemeldet). Dazu: die drei reinen ASCII-Destillate aus Run 84 am Original geprüft (zwei kleine Befunde), zwei Prüfvermerke in `sia-251-2008` geschlossen, **WC57-N1 beantwortet** (VKF-Verzeichnis 40-15de 11.06.2025, Registerzeile SN EN IEC 62368-1). Kein neues Grunddestillat; `[ ]`-Positionen unverändert (nur Bring-Schulden). Anlage `training/n85-typ-a-refuter-260915.md`, Report `outputs/2026-09-15_normen-nacht-run85.md`.

**Run 88 (19.09.2026, MacBook Pro, SIA/VKF-Scope):** Vertiefungsstufe (b) auf `lignum-4-2-anschluesse-feuerwiderstand.md`. **N87-1 geschlossen:** die 33 Piktogramme der 22 Anhang-2-Matrixzeilen aufgenommen (Stossform, Brandseite, Weiterleitungsweg, Flächenton aller 81 Arme gemessen), zwei blinde Agenten ohne Widerspruch; Matrixtabellen im Destillat mit Spalte «Piktogramm». **Refuter-Runde auf die ~30 Run-86-Nachträge:** 2/2 Kontrollwerte erkannt, 2 Kernbefunde (Kap. 5.2.1, 5.2.2) inline korrigiert, 0 falsche Zahlenwerte. Fassungsstand 2018 beim Herausgeber belegt. **Statushebung `lignum-4-2` → `established`.** Kein neues Grunddestillat; `[ ]`-Positionen unverändert (nur Bring-Schulden). Anlage `training/l42-anhang2-piktogramme-260919.md`, Report `outputs/2026-09-19_normen-nacht-run88.md`.
