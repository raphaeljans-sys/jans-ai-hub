...
| SIA 416/1 | 2007 | 2007✓ | destilliert Run 52 (15.08.2026) → `sia-416-1-2007.md`, `speculative`. Ersetzt Empfehlung SIA 180/4:1982. **Nicht mit SIA 416:2003 verwechseln** (Flächen/Volumen); 416/1 liefert Energiebezugsfläche, Gebäudehüllfläche und Energiekennzahl. Bestand lag unter `alle/xalt/neu/`. **Stand Run 56 (18.08.2026):** Refuter-Richtung auf S. 4-40 (Run 53), Abdeckungsrichtung auf S. 4-40 (Run 53/54), Refuter-Runde auf dem Zuwachs vollständig (Run 55: S. 26-32/34/35/40 · Run 56: S. 4/6/9/17/21-22/39). Status weiterhin `speculative`, offen N56-1 |
