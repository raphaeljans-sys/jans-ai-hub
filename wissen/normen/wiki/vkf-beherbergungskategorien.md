...
# VKF-Beherbergungsbetriebe [a]/[b]/[c] — Definition, Zuordnung, Anforderungsunterschiede
...
## Die drei Kategorien (Originalwortlaut)

Quelle: VKF Brandschutznorm 1-15de, Art. 13 Abs. 2 lit. a (identisch in der
Begriffs-Richtlinie 10-15de, Stichwort «Beherbergungsbetriebe»):

> **[a]** insbesondere Krankenhäuser, Alters- und Pflegeheime, in denen dauernd oder
> vorübergehend 20 oder mehr Personen aufgenommen werden, die auf fremde Hilfe
> angewiesen sind;
>
> **[b]** insbesondere Hotels, Pensionen und Ferienheime, in denen dauernd oder
> vorübergehend 20 oder mehr Personen aufgenommen werden, die nicht auf fremde
...
diese Nutzungs-Definition) und (2) bei [a] vs. [b] die **Selbstrettungsfähigkeit
...
Nur was das Original tatsächlich nennt (keine Ergänzung):

| Nutzung | Kategorie | Beleg |
|---|---|---|
| Krankenhaus / Spital | **[a]** | Art. 13 Abs. 2 lit. a, wörtlich genannt |
| Alters- und Pflegeheim | **[a]** | Art. 13 Abs. 2 lit. a, wörtlich genannt |
| Hotel | **[b]** | Art. 13 Abs. 2 lit. a, wörtlich genannt |
| Pension | **[b]** | Art. 13 Abs. 2 lit. a, wörtlich genannt |
...
- In Bettengeschossen, in denen dauernd oder vorübergehend kranke,
  ...
  **müssen** die horizontalen Fluchtwege so unterteilt werden, dass zusammen mit
  den Patientenzimmern mindestens **zwei voneinander unabhängige Brandabschnitte**
  entstehen, damit eine horizontale Evakuierung möglich ist (Aufenthaltskonzept).
- Empfangsbüros, die von angrenzenden Räumen mit Feuerwiderstand **EI 60**
  abgetrennt sind: gegen vertikale Fluchtwege genügt ein Abschluss EI 30, gegen
  horizontale Fluchtwege mindestens ein Abschluss aus Baustoffen RF1; Türen mit
  Selbstschliessern.
- Zu einer Wohneinheit zusammengefasste Zimmer sind möglich, sofern die
...
- Empfangstheken/Reception, die von angrenzenden Räumen (z.B. Büro) mit
  Feuerwiderstand EI 30 abgetrennt sind, dürfen in horizontalen Rettungswegen
  stehen.
- Hotelzimmertüren müssen mindestens 0.8 m breit sein, müssen aber nicht in
  Fluchtrichtung öffnen; an Türen innerhalb von Hotelsuiten werden keine
  Anforderungen gestellt.
- Bei **[c]**: Hauseingangstüren müssen nicht in Fluchtrichtung öffnen; gewendelte
...
- Ob weitere VKF-Richtlinien (Sprinkler 19-15, Brandmeldeanlage 20-15,
  Kennzeichnung Fluchtwege 17-15) eigene Sonderregeln für [a]/[b]/[c] enthalten,
  wurde für diesen Artikel nicht geprüft — nur Begriffs-Richtlinie 10-15de,
  Brandschutznorm 1-15de und Flucht-/Rettungswege-Richtlinie 16-15de wurden
  durchsucht (gemäss Auftrag).
- Einordnung «Betreutes Wohnen» offen (siehe oben) — bei Bedarf in
  `wissen/normen/wiki/QUESTIONS.md` durch die Wissens-Bibliothekar-Routine
  nachtragen lassen.
