---
quelle: "PL - 02_Recht_Norm/02_Normen/DIN_Norm/Sonstiges/Abkuerzungsverzeichnis.pdf"
...
# Abkürzungsverzeichnis (D, Planen und Bauen, 2010)
...
Nachschlagewerk, nicht als inhaltliches Regelwerk mit Kernziffern.

## Geltungsbereich

Alphabetisches Glossar A-Z, keine normativen Aussagen — reine Begriffsauflösung für
deutsche Bau- und Rechtsdokumente.

## Kernziffern mit Fundstellen

Kein Ziffern-/Kennwerte-Inhalt (Glossar). Ausgewählte, für JANS-Projekte relevante
Einträge:
...
Reines Nachschlagewerk ohne direkte CH-Anwendung, aber nützlich als **schnelle
Übersetzungshilfe**, wenn in einem deutschen Referenzdokument, einer
Fachplaner-Offerte oder einem Ankaufsprüfungs-Fall (Skill `ankaufspruefung`) ein
unbekanntes deutsches Bau-Kürzel auftaucht — Kürzel hier nachschlagen statt zu raten.
Besonders die Flächen-/Volumen-Kürzel (BGF/NGF/HNF/BRI/NRI) und die
Honorar-/Vergabe-Pendants (HOAI↔SIA102, VOB↔SIA118) sind als Cross-Referenz-Tabelle
für grenzüberschreitende Projekte brauchbar.

## Offene Punkte

Keine — reines Glossar, keine inhaltliche Vertiefung nötig. Bei Bedarf im Original-
PDF nachschlagen (Volltext liegt in `Sonstiges/Abkuerzungsverzeichnis.pdf`).
