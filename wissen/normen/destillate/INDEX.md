...
| `sia-266-1-2003.md` | SIA 266/1 Mauerwerk – Ergänzende Festlegungen (Prüf-/Deklarationsnorm) | 2003 | speculative — Run 22 (260725) neu destilliert, adversarial **BEANSTANDET**: 13 Befunde korrigiert + 9 Lücken nachgetragen. Run 23 (260725) ZWEITE Runde: alle Korrekturen bestätigt, EIN neuer Fehler (Figur-1 h/l vertauscht) gefunden + korrigiert. Run 24 (260725) DRITTE Runde: 0 Befunde ausserhalb Figur-1, aber wieder EIN neuer Fehler exakt in der zuvor editierten Figur-1-Zeile (Fy-Hauptkraft mit optionalem Querdruck-System verwechselt) gefunden + korrigiert; weiterhin BEANSTANDET, vierte Runde vor Statushebung noetig. Bestandsfalle: Datei liegt deutsch im italienischen Sprachordner (`alle/i/266_1_d.pdf`), war als «Sprachvariante» abgehakt |
...
| `sia-271-wegleitung.md` | Wegleitung zur Norm SIA 271 — Abdichtungen von Hochbauten | unbekannt (kein Ausgabevermerk im PDF) | speculative (Run 16 260719, beanstandet, 12 Aussagen, 3 Befund(e)) |
...
| `sia-112-leistungsmodell.md` | Phasen des SIA-Leistungsmodells (Merkblatt KUNDERT PLANER AG zur SIA Ordnun… | unbekannt (kein Ausgabevermerk, kein Datum… | speculative (Run 16 260719, beanstandet, 12 Aussagen, 2 Befund(e)) |
| `sia-112-tabelle-infrastruktur.md` | kein Titel im Dokument — Deckblatt fehlt; Arbeitstitel aus Dateiname «tabel… | unbekannt (kein Ausgabevermerk im PDF) | speculative (Run 16 260719, bestanden, 12 Aussagen, 0 Befund(e)) |
