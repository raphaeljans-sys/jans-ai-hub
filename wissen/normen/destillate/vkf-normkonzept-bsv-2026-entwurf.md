...
# VKF Normkonzept BSV 2026 — Totalrevision der Brandschutzvorschriften
...
- Das Dokument beschreibt vier Teile: Geschichte der Brandschutzvorschriften (Kap. 2), IST-Situation BSV 2015 (Kap. 3), SOLL-Zustand nach IOTH-Auftrag (Kap. 4) und die Eckpunkte der Totalrevision (Kap. 5) — Ziff. 1.2, S. 6.
...
- **Ziff. 3.1.2** — Baupolizeirecht und damit der Brandschutz ist grundsätzlich Sache der Kantone; seit 1966 sind sämtliche Harmonisierungsvorstösse auf Bundesebene gescheitert (S. 29 f.).
- **Ziff. 3.1.3** — Grundlage ist die Interkantonale Vereinbarung zum Abbau technischer Handelshemmnisse (IVTH) von 1998; sie schafft suprakantonales Recht, das entgegenstehendem kantonalem Recht vorgeht (Art. 48 Abs. 5 BV; BGer 1C_328/2018 vom 12.04.2019). Beschlüsse des IOTH brauchen eine Mehrheit von 18 Stimmen (Art. 5 IVTH); eine kantonale Ratifizierung ist nicht erforderlich (S. 31 f.).
- **Ziff. 3.1.2** — Seit dem 1. Januar 2005 gelten die VKF-Brandschutzvorschriften grundsätzlich schweizweit; erhebliche Unterschiede bestehen aber weiterhin beim Vollzug (S. 31).

**IST-Zustand BSV 2015**

- **Ziff. 3.3.2** — Die geltenden BSV 2015 bestehen aus der Brandschutznorm VKF-BSN 1-15 und den Brandschutzrichtlinien VKF-BSR 10-15 bis 28-15; sie sind am 1. Januar 2015 in Kraft getreten (S. 46; Ziff. 1.1, S. 5).
- **Tabelle 7** — Gesamtumfang: 277 Seiten verbindlicher Textteil plus 167 Seiten Anhänge, total 454 Seiten (S. 47).
- **Ziff. 3.3.2** — Seit 1993 sind die Vorschriften nicht mehr nach Nutzungen, sondern nach Massnahmen gegliedert; für Gebäude geringer Abmessungen, Wohnbauten und Schulhausbauten bestehen drei Arbeitshilfen, die dem Bedürfnis der Architekten nach rascher Übersicht entsprechen (S. 47).
- **Ziff. 3.3.3** — Die Vollzugshilfen umfassen unter anderem 10 Erläuterungen, 3 Arbeitshilfen, 8 Merkblätter, 2 Musterweisungen, 2 Reglemente, 12 Formulare, 52 FAQ und eine Liste von 27 Stand-der-Technik-Papieren (STP); das Verzeichnis VKF-BSVER 40-15 führt über 200 Dokumente (S. 48). Auf S. 80 wird der aktuelle STP-Bestand mit 28 Dokumenten angegeben.
- **Ziff. 3.3.5** — Das geltende Recht wurde nicht systematisch risikobasiert erarbeitet. Im Vordergrund stehen präskriptive, deterministische Standardkonzepte (VKF-BSN 1-15 Art. 10); Abweichungen sind über Art. 11 (gleichwertige Einzellösungen) und Art. 12 (Nachweisverfahren) möglich, letztere werden mangels konkretisierter Schutzziele kaum angewendet (S. 49 f.).
- **Ziff. 3.4.1** — Die BSV machen zum Vollzug nur wenige Vorgaben; Zuständigkeiten und Verfahren regeln die Kantone. Drei Hauptgründe für die unterschiedliche Auslegung: Interpretationsspielraum, kantonale Vollzugsregelungen, Verhältnismässigkeitsprinzip (S. 50).
...
- **Eckpunkt 1 / 2** — Der risikoorientierte Ansatz bildet das Rückgrat der Totalrevision; das Interesse an vereinfachten, risikoorientierten Vorschriften überwiegt das Kontinuitätsvertrauen (S. 92 f.).
- **Eckpunkt 4** — Die Umschulung auf die neuen BSV hat vor der Inkraftsetzung zu beginnen (S. 93).
- **Eckpunkt 18** — Verzicht auf zwei Erlassstufen: künftig nur noch eine Stufe (BSV) statt Norm und Richtlinien (Ziff. 5.2.3 a), S. 101, 103).
- **Eckpunkt 19** — Künftige Bezeichnung: «Schweizerische Brandschutzvorschriften (BSV)» als ausführlicher Titel, «Brandschutzvorschriften» als Kurztitel, «BSV» als Abkürzung (S. 106).
- **Eckpunkt 20 / 21** — Gliederung nach der im Bundesrecht gebräuchlichen Systematik (Titel, Kapitel, Abschnitt, Artikel, Absatz, Buchstabe, Ziffer); der Umfang soll **200 Seiten nicht überschreiten**, auf nicht normative Anhänge wird verzichtet (S. 106 f.).
- **Eckpunkt 22 / 25** — Die Vollzugshilfen werden zur «BSV-Erläuterung» zusammengefasst; das Projektteam hat zwei Dokumente auszuarbeiten: BSV 2026 und BSV-Erläuterung (S. 108, 111).
- **Eckpunkt 24** — Bei der Redaktion gelten die Regeln des Gesetzgebungshandwerks, unter anderem die «Eugen-Huber-Regel»: pro Artikel höchstens drei Absätze, pro Absatz ein Satz, pro Satz eine Aussage (S. 108, 110).
- **Eckpunkt 29** — Die für die Klassifizierung der Bauprodukte (Baustoffe, Bauteile) relevanten Eigenschaften sollen in einem Grundlagendokument für möglichst alle Bauprodukte beschrieben werden; heute in VKF-BSR 13-15 geregelt (Ziff. 5.2.4, S. 112).
- **Eckpunkt 30** — Vollzugsvereinheitlichung ist ein Hauptziel; sie geht dem Deregulierungsziel vor (Ziff. 5.2.5, S. 112 f.).
...
- **Eckpunkt 38** — Es ist eine operationale «rote Linie» festzulegen, unterhalb derer unabhängig von einem Umbauvorhaben nachgerüstet werden muss, sowie Kriterien zur Verhältnismässigkeit von Nachrüstmassnahmen. Beispiel im Text: zwingende Nachrüstung, wenn in einem mehrgeschossigen Gebäude kein vertikaler Fluchtweg vorhanden ist (S. 127 f.).

## JANS-Praxis-Transfer

- **Skill `brandschutz`**: Die BSV 2015 (VKF-BSN 1-15, VKF-BSR 10-15 bis 28-15) bleiben bis zur Inkraftsetzung der Nachfolgeregelung die massgebende Fundstellenbasis. Zitate aus diesem Normkonzept dürfen NIE als geltendes Recht ausgegeben werden — es ist ein Projektpapier ohne Vorschriftencharakter (Deckblatt, S. 1). Für Fundstellen weiterhin die BSV 2015 selbst zitieren.
- **Skill `brandschutz` / `ankaufspruefung`**: Für Bestandesfragen liefert Ziff. 5.3.4 (S. 125-128) die belegte Argumentationslinie — es gibt im Brandschutz keine unbeschränkte Bestandesgarantie; bei wesentlichen baulichen oder betrieblichen Veränderungen (inkl. blosser Nutzungsänderung) ist die Baute anzupassen (Verwaltungsgericht SO, Urteil vom 27.05.2005). Das ist für die CapEx-/Risiko-Beurteilung einer Ankaufsprüfung direkt verwertbar.
- **Skill `machbarkeit` / `nutzungsstrategie`**: Die Abgrenzung «neubauähnlicher Umbau» (§ 357 Abs. 1 PBG ZH, S. 126 f.) bestätigt das bereits im Skill `nutzungsstrategie` geführte Bestandesschutz-Kriterium — je geringer die baulichen Eingriffe im Verhältnis zum verbleibenden Bestand, desto eher greift die erweiterte Besitzstandsgarantie.
- **Skill `kostenschaetzung` / `grobkosten-onepager`**: Der Anteil des vorbeugenden Brandschutzes an den Bauinvestitionen wird mit 2.5 bis 4 % beziffert (S. 73). Das ist ein belegter Plausibilitäts-Richtwert, aber KEIN JANS-Kennwert und keine BKP-Position; er stammt aus einer internationalen Schätzung (The Geneva Association 2011) und ist nicht als Kalkulationsgrundlage einzusetzen.
- **Skill `auflagebereinigung` / `behoerden-vorabklaerung`**: Das Dokument belegt amtlich, dass der Vollzug heute kantonal stark divergiert (Ziff. 3.4.1, S. 50; Ziff. 4.2.4, S. 83 f.) — insbesondere bei periodischen Kontrollen sowie bei Inhalt und Umfang der Prüfungen. Das stützt die Praxis, brandschutzrelevante Auflagen immer mit der konkret zuständigen kantonalen Fachstelle abzuklären statt aus der Norm abzuleiten.
- **Planungsvorlauf allgemein**: Bei Projekten mit langer Planungsphase über den Inkraftsetzungszeitpunkt hinaus ist das Übergangsrecht relevant (Wahlrecht integral BSV 2015 oder BSV 2026, sechs Monate für Stammbaugesuche, zwei Jahre für Mieterausbauten — S. 125, 165). Diese Fristen sind Vorschläge im Konzeptstand 2022 und vor einer Anwendung am dann geltenden Erlass zu verifizieren.
