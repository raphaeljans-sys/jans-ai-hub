...
Zwei HTA-Luzern-Skripte aus derselben Lehrveranstaltungsreihe (Feuchteschutz datiert März 2007, Autor Peter Boog dipl. Ing. FH; Unterkonstruktionen ohne Datum, thematisch/gestalterisch dieselbe Reihe). Beide beziehen sich auf **SIA 180 in der Ausgabe 1999** — nach Rule `normen-referenz` ist jede Norm-Aussage vor Verwendung gegen die heute geltende Ausgabe zu prüfen, da SIA 180 seither revidiert wurde (aktuelle Fassung SIA 180:2014, korrekter Titel «Wärmeschutz, Feuchteschutz und Raumklima in Gebäuden» — ⚠ **berichtigt 29.08.2026, Wissens-Chef Run 47:** ein Destillat liegt sehr wohl vor, `wissen/normen/destillate/sia-180-2014.md` (`status: destilliert VOLLSTAENDIG`, last_updated 24.08.2026, also sechs Wochen vor diesem Artikel angelegt). Die Werte dieses Skripts sind dort nicht gegengelesen; die Fundstellen stehen unter «Offene Punkte».)
...
Bei jedem Fassadendetail mit Wärmebrücken-Verdacht (Oblichter, auskragende Betonteile, durchlaufende Metallprofile) zuerst den fRsi-Grenzwert 0,75 als Faustregel prüfen, bevor ein rechnerischer Nachweis beauftragt wird (⚠ 0,75 ist der Stand SIA 180:1999; nach SIA 180:2014 Ziff. 6.2.2.1 gilt der Standortwert nach Anhang F, ungünstigster CH-Wert 0,80/0,83 — die Faustregel liegt also zu tief, siehe «Offene Punkte»). Für die Unterkonstruktion gilt: nie starr verspannen, immer Gleitlager oder elastische Verbindung mit gesicherter Schraube vorsehen — die Dehnungsformel mit ΔT ≈ 40 K liefert eine schnelle Grössenordnung für die nötige Fugenbreite.

## Offene Punkte

- **Beide Skripte beziehen sich auf SIA 180 in der Ausgabe 1999** (Ziffern 6.2.1.2 und 3.1.3.5 explizit zitiert). Nach Rule `normen-referenz` ist jede Norm-Aussage vor Verwendung gegen die aktuell geltende SIA-180-Fassung zu prüfen; gegenzulesen ist `wissen/normen/destillate/sia-180-2014.md` (⚠ berichtigt 29.08.2026, Wissens-Chef Run 47 — die frühere Aussage «kein Destillat vorhanden» war falsch). Zuordnung der beiden zitierten Ziffern in der Ausgabe 2014: Kondensat/Schimmel jetzt Ziff. 6.2.1.1–6.2.1.3, maximal zulässige Raumluftfeuchte Ziff. 6.2.1.4 — der Regelungsgegenstand ist von Kapitel 3 nach 6.2 **umnummeriert**, weshalb er ohne diesen Zeiger nicht auffindbar ist. **Operativ wichtigster Punkt:** nach Ziff. 6.2.2.1 gilt für konstruktive Wärmebrücken der standortabhängige Grenzwert nach Anhang F, nicht der pauschale fRsi 0,75 der Ausgabe 1999; der ungünstigste Schweizer Wert liegt gemäss Destillat bei 0,80 bzw. 0,83. Die Faustregel dieses Skripts ist unter der geltenden Ausgabe damit **nicht** auf der sicheren Seite. Vorbehalt: das Destillat führt eine Korrigenda C2:2020, deren Inhalt im Hub nicht verifiziert ist — keine 2014er-Zahl ohne eigene Prüfung am Original übernehmen.
