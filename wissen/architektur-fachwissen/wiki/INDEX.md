...
| 08 | `02_Architekturgeschichte` | archiv | 11 / 3'826 — **P1 vollständig, sechzehnter P2-Lauf 30.08.2026, dritter Lauf Architektenportraits (20/39)** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster, Architekturtheorie-Genealogie Vitruv/Alberti, Luzerner Skript Sauter/Marion (alle 13 Kapitel destilliert), Architektenportraits-Ordner: 20 Kurzbiografien destilliert (Michelozzo, Laurana, Rossellino, Bernini, Borromini, Perrault, Hildebrandt, Soufflot, Giulio Romano, Erdmannsdorff, Gilly, Labrouste, Paxton, Baltard, Eiffel, Jenney, Burnham, Fischer von Erlach, Neumann, Klenze). Neumanns gesicherte Lebensdaten 1687-1753 bestätigen den bereits bekannten Datierungsfehler im Semper-Portrait (dort fälschlich dieselbe Zahl). Offen: 16 weitere Einzelportraits (zehn davon laut Duplikatscheck bereits andernorts in dieser KB behandelt: Schinkel, Semper, Garnier, Ruskin, Morris, Webb, Wright, Sullivan, Vignola, Palladio) plus drei Nicht-Portrait-Positionen desselben Ordners, `Fragen.doc`, Rest der Renaissance-Zusammenfassung (Einzelbau-Dokumentation), `Moderne.pdf` (Duplikatsprüfung gegen bestehende Semper-Artikel nötig vor Bearbeitung). | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
