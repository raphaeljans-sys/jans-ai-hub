...
| 08 | `02_Architekturgeschichte` | archiv | 16 / 3'826 — **P1 vollständig, `Renaissance-Zusammenfassung.pdf` S. 5-33 destilliert (89. Lauf) 30.08.2026** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster, Architekturtheorie-Genealogie Vitruv/Alberti, Luzerner Skript Sauter/Marion (alle 13 Kapitel destilliert), Architektenportraits-Ordner: 25 Kurzbiografien destilliert, `Fragen.doc` destilliert, `Moderne.pdf` vollständig ausgewertet, `Renaissance-Zusammenfassung.pdf` S. 5-33 destilliert (Domkuppel-Konstruktion Florenz, Michelozzo/Palazzo Medici, Alberti-Fassadenvertiefung Palazzo Rucellai + Rossellino/Pienza + Laurana/Urbino, St.-Peter-Baugeschichte, Palazzo del Tè/Giulio Romano, Uffizien/Vasari, Il-Gesù-Vertiefung/Vignola, fünf Palladio-Bauten Basilica/Chiericati/Rotonda/Redentore/Foscari). Neumanns gesicherte Lebensdaten 1687-1753 bestätigen den bereits bekannten Datierungsfehler im Semper-Portrait (dort fälschlich dieselbe Zahl). Offen: drei Nicht-Portrait-Positionen des Portrait-Ordners, `Renaissance-Zusammenfassung.pdf` S. 34-51 (Barock/Aufklärung, tatsächlich kein Renaissance-Stoff — Duplikatrisiko gegen Sauter-Kapitel). | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
