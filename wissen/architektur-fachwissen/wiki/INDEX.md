...
| 08 | `02_Architekturgeschichte` | archiv | 11 / 3'826 — **P1 vollständig, `Moderne.pdf` S. 10-16 destilliert (86. Lauf) 30.08.2026** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster, Architekturtheorie-Genealogie Vitruv/Alberti, Luzerner Skript Sauter/Marion (alle 13 Kapitel destilliert), Architektenportraits-Ordner: 25 Kurzbiografien destilliert, `Fragen.doc` destilliert, `Moderne.pdf` S. 10-16 destilliert (Richardson Trinity-Church/Marshall-Fields/Glessner-House, Chicagoer Skelettbau-Reihe Jenney/Burnham, Sullivan Auditorium/Wainwright/Charnley-House, Wright Prairie-House bis Falling Water). Neumanns gesicherte Lebensdaten 1687-1753 bestätigen den bereits bekannten Datierungsfehler im Semper-Portrait (dort fälschlich dieselbe Zahl). Offen: drei Nicht-Portrait-Positionen des Portrait-Ordners, Rest der Renaissance-Zusammenfassung (S. 4-51 Einzelbau-Dokumentation), `Moderne.pdf` S. 1-9 (Empire-Paris/Schinkel/Klenze/Gärtner/Semper/Garnier/Morris-Webb — Duplikatscheck ergab Überschneidung mit bestehenden Kanon-Zeilen, Vertiefung wäre eigener Folgeauftrag) und die S.-16-Stichwortzeilen zu Corbusiers Domino-Häusern/Villa Stein. | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
