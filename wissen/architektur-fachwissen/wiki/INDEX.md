...
| 08 | `02_Architekturgeschichte` | archiv | 12 / 3'826 — **P1 vollständig, `Moderne.pdf` vollständig ausgewertet (87. Lauf) 30.08.2026** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster, Architekturtheorie-Genealogie Vitruv/Alberti, Luzerner Skript Sauter/Marion (alle 13 Kapitel destilliert), Architektenportraits-Ordner: 25 Kurzbiografien destilliert, `Fragen.doc` destilliert, `Moderne.pdf` vollständig ausgewertet: S. 10-16 destilliert (Richardson Trinity-Church/Marshall-Fields/Glessner-House, Chicagoer Skelettbau-Reihe Jenney/Burnham, Sullivan Auditorium/Wainwright/Charnley-House, Wright Prairie-House bis Falling Water), S. 4+6-7 destilliert (Sempers Polytechnikum Zürich/ETH-Hauptgebäude — Struktur-gegen-Oberfläche-Theorie am eigenen Bau, Gründungskontext ETH 1854, Gärtners Bayerische Staatsbibliothek München im Rundbogenstil-Vergleich), Rest S. 1-3+5+7-9 als Duplikat bestehender Kanon-Zeilen bzw. unter Destillationsschwelle begründet ausgelassen. Neumanns gesicherte Lebensdaten 1687-1753 bestätigen den bereits bekannten Datierungsfehler im Semper-Portrait (dort fälschlich dieselbe Zahl). Offen: drei Nicht-Portrait-Positionen des Portrait-Ordners, Rest der Renaissance-Zusammenfassung (S. 4-51 Einzelbau-Dokumentation). | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
