...
| 04 | `02_Architekturtheorie` | archiv | 21 / 1'603 — **P1 vollständig, P2-Gruppen «31 Syllabi» + 2 versteckte Fragen-Kataloge destilliert 30.08.2026** | Vorlesungsreihe Architekturtheorie ETH (Moravánszky/Hildebrand) mit rund 20 eigenen, durchformulierten Frage-Antwort-Katalogen zu Stil, Tektonik, Typus und Ornament, dazu eine Literaturlandkarte über 16 Begriffe aus den Semestersyllabi, Rossis Theorie der Permanenz und ein Fallbeispiel-Register (Loos/Wright/Kahn/Rossi). P2 offen: rund 180 Vorlesungsmitschriften (nur 2/23 Ordner auf weitere versteckte Fragen-Kataloge geprüft, `QUESTIONS.md` #68), Vorlesungsfolien-Sammel-PDF. | `raw/inventar/archiv-fachwissen__02_Architekturtheorie.md` |
