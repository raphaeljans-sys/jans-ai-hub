...
| 08 | `02_Architekturgeschichte` | archiv | 11 / 3'826 — **P1 vollständig, achter P2-Lauf 30.08.2026** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster, Architekturtheorie-Genealogie Vitruv/Alberti, Luzerner Skript Sauter/Marion (8 von 13 Kapiteln: Bautenverzeichnis/Glossar, Renaissance/Manierismus, Barock/Rokoko Sakralbauten, Revolutionsarchitektur, Klassizismus/Historismus/Eklektizismus, Heimatstil/Gartenstadtbewegung, Jugendstil/Secession). Offen: 5 weitere Sauter-Kapitel (Expressionismus/Kubismus bis Postmoderne), 41 Architektenportraits, `Fragen.doc`, Rest der Renaissance-Zusammenfassung (Einzelbau-Dokumentation), `Moderne.pdf` (Duplikatsprüfung gegen bestehende Semper-Artikel nötig vor Bearbeitung). | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
