...
| 08 | `02_Architekturgeschichte` | archiv | 11 / 3'826 — **P1 vollständig, erster P2-Lauf 30.08.2026** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster und Architekturtheorie-Genealogie Vitruv/Alberti. Offen: Luzerner Skript Sauter/Marion (13 Teile), 41 Architektenportraits, `Fragen.doc`, Rest der Renaissance-Zusammenfassung (Einzelbau-Dokumentation), `Moderne.pdf` (Duplikatsprüfung gegen bestehende Semper-Artikel nötig vor Bearbeitung). | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
