...
| 08 | `02_Architekturgeschichte` | archiv | 11 / 3'826 — **P1 vollständig, vierzehnter P2-Lauf 30.08.2026, erster Lauf Architektenportraits (9/39)** | Kunst-/Architekturgeschichte-Studienarchiv ETH/HTA mit Analyseraster für Gebäudeanalysen, Fachglossar historischer Bauteile und einer geprüften Referenz-Objektliste. P2: machtgeschichtliche Herleitung von Bauaufgaben (Tönnesmann-Skript, Florenz/Urbino), Mittelalter-Epochenraster (Romanik/Gotik-Datierungshilfe), Renaissance-Stilmerkmal-Raster, Architekturtheorie-Genealogie Vitruv/Alberti, Luzerner Skript Sauter/Marion (alle 13 Kapitel destilliert), Architektenportraits-Ordner: neun Kurzbiografien destilliert (Michelozzo, Laurana, Rossellino, Bernini, Borromini, Perrault, Hildebrandt, Soufflot, Giulio Romano). Offen: 30 weitere Architektenportraits (Qualitätsvorbehalt: belegter Datierungsfehler bei Semper-Portrait bekannt), `Fragen.doc`, Rest der Renaissance-Zusammenfassung (Einzelbau-Dokumentation), `Moderne.pdf` (Duplikatsprüfung gegen bestehende Semper-Artikel nötig vor Bearbeitung). | `raw/inventar/archiv-fachwissen__02_Architekturgeschichte.md` |
