---
title: "Inventar archiv-fachwissen / 02_Architekturgeschichte"
korpus: archiv-fachwissen
sektion: /Volumes/daten/02_Architektur_Archiv/02_Architekturgeschichte
last_updated: 2026-08-23
status: established
---

# Inventar: 02_Architekturgeschichte

## Kurzbefund

Die Sektion ist das vollständig erhaltene **Studienarchiv Kunst- und Architekturgeschichte**
aus dem Architekturstudium (Bachelor ETH Zürich, dazu Material der hta Luzern), Jahrgang der
Dateien im Wesentlichen **2008 bis 2014**, mit einzelnen älteren Skripten (Luzerner Skript
2005/06) und einem Themenordner Protomoderne.

Umfang: **3826 Dateien, 29.1 GB**, verteilt auf 19 chronologisch benannte Epochenordner
(`0000_0300_Antike` bis `2015_2030_Protomoderne`) und einen sehr grossen Querschnittsordner
`00_Allgemein`. Formatverteilung: 1156 PDF (5.7 GB), 1736 Bilddateien (JPG/PNG/TIFF/PSD),
74 DOCX und 30 DOC, 523 HTML- und Webarchiv-Ressourcen, 17 M4A-Tonmitschnitte plus 52
AIF-Rohspuren aus GarageBand-Projekten. **Allein die GarageBand-Rohspuren machen 20.9 GB aus,
also rund 72 Prozent des Speichervolumens bei rund 3 Prozent der Dateien.**

Der Bestand ist inhaltlich **architekturhistorisch, nicht bauprojektbezogen**. Es gibt hier
keine Ausschreibungen, keine Kostendaten, keine Behördenakten. Der Wert für JANS liegt
deshalb nicht im Fachwissen des Tagesgeschäfts, sondern in drei anderen Dingen: einem
belegten **Analyse- und Beschreibungsraster für Bestandes- und Kontextanalysen**, einem
**Fachglossar historischer Bauteile** (relevant bei Umbauten an historischer Substanz) und
einem **Referenz- und Argumentationsfundus** für Wettbewerbs- und Erläuterungstexte,
besonders zur Schweizer Architektur seit 1970.

Gesichtet wurde die Sektion vollständig über die rekursive Dateiliste. **Wirklich gelesen
wurden 22 Dateien** (PDF via pdftotext, DOC und DOCX via textutil), ausgewählt nach dem
Kriterium: eigene Verfasserschaft, Übersichts- oder Methodencharakter, oder grösster
Textanteil je Epochenordner. Bildlastige Vorlesungsfolien wurden stichprobenweise geprüft
und nicht einzeln gelesen.

**Datenschutz:** Nichts Heikles gefunden. Keine Verträge, Bewerbungen, Personaldossiers,
Adress- oder Kontaktsammlungen, keine Lohn- oder Honorardaten, keine Privatunterlagen. Der
Bestand enthält Namen von Dozierenden auf Vorlesungsunterlagen und Namen von Mitstudierenden
auf einzelnen Zusammenfassungen; **Letztere werden hier bewusst nicht genannt**, sie sind für
den Inhaltswert ohne Belang.

**Urheberrecht:** Ein grosser Teil des Bestandes sind fremde Vorlesungsskripte, Buchscans und
Zeitschriftenscans, darunter eine mehrhundertseitige Scanserie einer Architekturzeitschrift.
Dieses Material darf **methodisch beschrieben und ausgewertet, aber nie wörtlich
reproduziert** werden. Für eine Destillation in die Wissensbasis heisst das: Begriffe,
Systematik und Argumentationsfiguren übernehmen, Textpassagen nicht.

## Struktur (Dateien je Ordner der ersten Ebene)

| Ordner | Dateien | Volumen |
|---|---|---|
| ` 00_Allgemein` | 1396 | 7496 MB |
| `1575_1770_Barock` | 821 | 361 MB |
| `1970_1990_Postmoderne` | 270 | 378 MB |
| `1920_1970_Moderne` | 259 | 2800 MB |
| `1200_1420_Gotik` | 250 | 2533 MB |
| `1750_1800_Aufklaerung` | 203 | 7808 MB |
| `1840_1890_Historismus` | 200 | 115 MB |
| `1420_1520_Renaissance` | 125 | 2672 MB |
| `0000_0300_Antike` | 103 | 1937 MB |
| `1890_1920_Jugendstil` | 87 | 197 MB |
| `1000_1250_Romanik` | 37 | 1957 MB |
| `0300_1000_Mittelalter` | 32 | 1267 MB |
| `1770_1840_Klassizismus` | 16 | 18 MB |
| ` 2000` | 12 | 4 MB |
| `2015_2030_Protomoderne` | 6 | 1 MB |
| `1520_1590_Manirismus` | 3 | 12 MB |
| Einzeldateien auf oberster Ebene | 6 | 245 MB |

Drei Epochenordner sind angelegt, aber **leer**: `0000_500_Roemisch_Antike`,
`1050_1100_Protorenaissance`, `1725_1780_Rokoko`.

## Triage

| Datei / Gruppe | Stufe | Begründung |
|---|---|---|
| ` 00_Allgemein/05_Gebaeudeanalyse/` (7 PDF: Gebäudeanalyse, Beispielanalysen Semper, Asplund, Perret, Terragni, van 't Hoff, Kolloquium) | **P1** | Ausformulierter, wiederholbarer **Analyseraster** für ein einzelnes Gebäude. Gelesen: die Analyse Haus Steiger, Zürich (1957-60) folgt strikt der Kette Grundstück und Topografie, Erschliessung, Grundform und Volumen, Grundriss mit Haupt- und Nebenachsen, Raumfolge und Sichtachsen, Fassade und Material, geschichtliche Einordnung. Genau diese Kette ist der Rumpf einer Kontext- und Bestandesanalyse im Wettbewerb und in der Machbarkeitsstudie. |
| ` 00_Allgemein/00_Begriffe/` (2 PDF) | **P1** | Fachglossar historischer Bauteile mit sauberen Definitionen (Krypta, Apsis, Portikus, Joch, Strebewerk, Chor, ausgeschiedene Vierung, Kapitell, Basis, Pilaster, Architrav, Obergaden, Triforium, Dienste). Direkt verwertbar, sobald an historischer Substanz gebaut wird, in Behörden- und Denkmalkorrespondenz und bei der Beschreibung von Bestandesbauteilen. Achtung: `architekturgeschichte_begriffe_notizen.pdf` hat **keinen Textlayer**, es ist ein Scan. |
| `ArchitekturVVI_Texte.pdf` (8 Seiten, Volltext) | **P1** | Der einzige Text des Bestandes mit direktem Bezug zur **heutigen Schweizer Architekturdebatte**: Tendenza und Tessiner Schule, Botta, Snozzi, Galfetti, Reichlin und Reinhart, Diener und Diener, Herzog und de Meuron, Zumthor, dazu die Frage nach Architektur als autonomer Disziplin und deren ökonomischer Vereinnahmung. Argumentationsfundus für Erläuterungsberichte und Konzepttexte. |
| ` 00_Allgemein/07_Objektliste/` (Prüfungs-Objektliste als PDF) | **P1** | Kanonische **Referenz-Objektliste** einer ETH-Bachelorprüfung: Architekt mit Lebensdaten, Bauwerk, Ort, Datierung, geordnet von Brunelleschi bis Palladio und weiter. Verifizierte Datierungen sind genau das, was die KB `entwurfs-referenzen` für belegte Referenzangaben braucht. |
| ` 00_Allgemein/04_Kunsthistoriker/Sauter_Marion/` (13 PDF, Skript hta Luzern 2005/06) | P2 | Geschlossener Vorlesungszyklus in 13 Teilen von Renaissance bis Postmoderne, mit eigenem Glossar, Bautenverzeichnis, Kurzbiografien und Literaturverzeichnis. Sauberste, weil systematischste Sekundärquelle des ganzen Bestandes. Fremdurheberschaft, also nur destillieren, nicht zitieren. |
| Epochen-Zusammenfassungen auf oberster Ebene (`MITTELALTER-ZSMFSG.pdf`, `Moderne.pdf`, `Renaissance-Zusammenfassung.pdf`, Tönnesmann-Skript HS 2012 mit 43 Seiten Volltext) | P2 | Durchgehend textbasiert und gut gegliedert. Das Tönnesmann-Skript liefert zudem die wirtschafts- und machtgeschichtliche Herleitung von Bauaufgaben (Zünfte, Bankwesen, Stiftungswesen, Konkurrenz der Bauherren), also die Frage, warum ein Bautyp entsteht. |
| Eigene Epochen-Übersichten (`..._Uebersicht_..._Jans.docx` für Renaissance, Barock, Klassizismus, Moderne, Postmoderne, Manierismus) | P2 | Selbst verfasst, deshalb ohne Urheberrechtsproblem und stilistisch verwertbar. Alle sechs folgen demselben selbst gesetzten Dreisatz, siehe unten. |
| ` 00_Allgemein/01_Architektenportrait/` (41 Dateien, davon 39 Einzelportraits von Brunelleschi bis Sullivan plus Kartenset) | P2 | Kurzbiografien im einheitlichen Format Leben, Werk, Bedeutung. Qualitätsvorbehalt, **fehlerhafte Datierung belegt**: `32_semper.pdf` führt Gottfried Semper im Titel mit den Lebensdaten 1687-1753, während derselbe Text im Fliesstext korrekt von Studienbeginn 1823 und Dresdner Professur 1834 spricht. Vor jeder Übernahme einer Jahreszahl gegen die Objektliste oder eine externe Quelle prüfen. |
| ` 00_Allgemein/03_Fragen/Fragen.doc` | P2 | Frage-Antwort-Katalog zur Architekturtheorie (Alberti, Vitruv, Vignola, Serlio, Palladio; Traktate, Säulenordnungen, Fassade als eigenständiges Element). Brauchbar als Musterform für Prüffragen-Kataloge und als kompakter Theorieabriss. |
| ` 00_Allgemein/04_Kunsthistoriker/` übrige Autorenordner (Posener, Ruskin, Rasmussen, Omachen, Pehnt, Wölfflin, Riegl, Gombrich, Banham, Frampton, Giedion, Pevsner, Oechslin und weitere, total 889 Dateien, davon 332 PDF) | P2/P3 | Theorie-Handbibliothek. **P2** sind die wenigen ausformulierten Skripte, etwa die Vorlesung zu Nachkriegsmoderne, Postmoderne, Dekonstruktivismus und High-Tech. **P3** sind die reinen Scanserien, insbesondere die über 200 Einzelseiten-Scans einer Architekturzeitschrift ohne Textlayer. Einzelne Merkblätter sind zudem sehr dünn: die Notiz zu Wölfflin besteht aus drei Stichworten. |
| Vorlesungsfolien-Serien (365 Dateien nach dem Muster `FS2011-Gotik01.pdf`, `ETH-Romanik-1.pdf`, `HS2013-Renaissance-02.pdf`, `FS2013-Aufklaerung-06.pdf` und Ableger) | P3 | Bild-PDF ohne oder mit sehr dünnem Textlayer, oft zusätzlich als Einzelseiten dupliziert. Archivwert als Bildreferenz, kein Destillationswert. |
| Bildbestände der Epochenordner, Objektliste-Kartenset (87 Dateien inkl. 17 XLS-Kartentabellen), Hauptstadtarchitektur (19 Dateien), Karte Mesopotamien | P3 | Reines Bild- und Kartenmaterial mit Sachbezug, teils ordentlich benannt. Aufheben, nicht destillieren. |
| Tonmitschnitte der Vorlesungen (17 M4A, 4 MP3, 1 M4V, zusammen 1.2 GB) | P3 | Inhaltlich potenziell wertvoll (Originalvorlesungen), aber ohne Transkription nicht nutzbar. Erst wieder anfassen, wenn eine Transkriptionsstrecke steht. |
| GarageBand-Projekte `*.band/` (129 Dateien, davon 52 AIF-Rohspuren, 20.9 GB) | **X** | Rohschnitt-Reste derselben Tonmitschnitte, die als M4A bereits fertig vorliegen. Reine Speicherlast, kein zusätzlicher Inhalt. Grösster Aufräumposten der Sektion. |
| HTML- und Webarchiv-Ablagen (523 Dateien: `.htm`, `_files/`-Ressourcen, `.webarchive`) | **X** | Gespeicherte Webseiten samt Hilfsdateien, überwiegend Layout- und Bildschnipsel. |
| 50 Wikipedia-Ausdrucke als PDF | **X** | Veraltete Momentaufnahmen einer laufend geänderten Quelle, teils schon 2011/12 gedruckt. Nie als Beleg verwenden. |
| 126 Finder-Alias-Dateien (`*_Alias` in den Architektenordnern) | **X** | Verweise ohne Inhalt, die Ziele liegen ausserhalb der Sektion. |
| 24 Dateien `Sicherungskopie von ...` | **X** | Word-Dubletten der jeweils danebenliegenden Datei. |
| ` 00_Allgemein/02_Epochenuebersicht/02_Bilder_Gebaeude/` (232 JPG mit Zufallsnamen wie `asdfölkjasdf.jpg`) | **X** | Bildmaterial ohne jeden Namens- oder Ordnungsbezug. Ohne Bilderkennung nicht zuordenbar, der Aufwand steht in keinem Verhältnis. |
| Leere Ordner `0000_500_Roemisch_Antike`, `1050_1100_Protorenaissance`, `1725_1780_Rokoko` | **X** | Leer. |

Mengengerüst der Triage: **P1 11 Dateien, P2 rund 160, P3 rund 1100, verworfen rund 2555.**

## Was hier für JANS drinsteckt

**1. Ein fertiger Analyseraster für Bestandes- und Kontextanalysen.** Die Gebäudeanalyse
Haus Steiger arbeitet eine Kette ab, die sich eins zu eins auf ein Wettbewerbsgrundstück oder
ein Ankaufsobjekt übertragen lässt: Lage und Topografie mit Hangneigung und Ausrichtung,
fussläufige Erschliessung von oben und unten, Grundform und Abweichungen davon, Achsen im
Grundriss samt Teilungsverhältnis, Raumanordnung und die daraus folgenden Sichtbeziehungen,
Fassadenöffnung je Himmelsrichtung, Material und Ornamentverzicht, zum Schluss die
geschichtliche Einordnung mit dem Verfasser des Baus. Vier weitere Beispielanalysen im selben
Ordner (Semper, Asplund, Perret, Terragni, van 't Hoff) zeigen den Raster an anderen Bauten.
Das ist ein Kandidat für einen Wiki-Artikel «Gebäudeanalyse-Raster» und für den Agenten
`bericht-autor` im Skill `wettbewerb`.

**2. Ein Dreisatz, mit dem eine Epoche oder Referenz auf Nutzen geprüft wird.** Die sechs
selbst verfassten Epochenübersichten stellen alle dieselben drei Fragen: Was macht diese
Epoche bedeutsam, was davon hat universelle Gültigkeit, und wo liegen die intellektuellen
Anknüpfungspunkte für unsere Zeit heute. Das ist kein Studienformalismus, sondern ein
brauchbarer Filter für jede Referenz, die in einen Erläuterungsbericht soll: sie muss die
dritte Frage beantworten können, sonst ist sie Dekoration. Die Übersichten liefern dazu je
eine Handvoll geordneter Schlagworte, für die Renaissance etwa Humanismus, Perspektive,
Zentralraum, menschliche Proportionen, Harmonie, Symmetrie, Zentralkomposition, dazu die
Beobachtung, dass sich der Architekt vom Handwerk löst und zum Künstler wird.

**3. Fachterminologie für den Umgang mit historischer Substanz.** Das Begriffsglossar und das
Glossar im Luzerner Skript decken die Bauteile ab, die bei Umbau, Ertüchtigung oder
Denkmalkorrespondenz benannt werden müssen. Beispiele aus dem gelesenen Text: das Joch ist der
Abstand zweier Stützen, gemessen von Säulenmittelpunkt zu Säulenmittelpunkt; das Strebewerk
aus Strebepfeilern und Strebebogen leitet den Gewölbeschub ab; der Pilaster ist ein in den
Mauerverbund eingebetteter Teilpfeiler, der tragend sein kann, aber nicht muss. Solche
Präzision ist der Unterschied zwischen einer Beschreibung, welche die Denkmalpflege ernst
nimmt, und einer, die es nicht tut.

**4. Argumentationslinien für die Schweizer Gegenwart.** Aus `ArchitekturVVI_Texte.pdf`
belegt: die Tessiner Architekten der 1970er Jahre reagieren auf die unkontrollierte
Urbanisierung, indem sie das Bauen als autonome Disziplin verstehen, deren Form nicht durch
soziale, ökonomische oder funktionale Bedingungen bestimmt sein soll, und indem sie dem
zersiedelten Umfeld starke Solitäre entgegenstellen, statt sich dem Kontext unterzuordnen.
Der Text stellt dem die Gegenposition gegenüber, wonach dieselbe Autonomie das Objekt als
vermarktbares Kunstwerk angreifbar macht. Beide Positionen sind in einem Erläuterungsbericht
zur Einordnung eines Neubaus in einen unklaren Kontext direkt einsetzbar, als Begründung wie
als Gegenargument.

**5. Die wirtschafts- und machtgeschichtliche Herleitung von Bauaufgaben.** Das
Tönnesmann-Skript zeigt an Florenz um 1500, wie Bautypen aus Machtverhältnissen entstehen: das
Bankwesen geht aus dem Wollhandel hervor, die neue wirtschaftliche Schicht verschiebt die
Macht zu den Zünften, der Dom wirkt neben der sakralen Funktion verbindend, das Rathaus trennt
Privatgeschäft und Politik, und der Ort einer Stiftung spiegelt den Grad der Macht. Dieselbe
Frage, wer baut warum und an welcher Stelle, trägt heute jede Nutzungsstrategie und jede
Positionierung eines Projekts im städtischen Gefüge.

**6. Ein Referenzkanon mit geprüften Datierungen.** Die Objektliste liefert zu jedem
Architekten die Bauten mit Ort und Jahr in geordneten Reihen, inklusive der Bauleitungsfolge
von Sankt Peter in Rom über acht Namen hinweg. Für die KB `entwurfs-referenzen` ist das eine
belastbare Grundlage. Die Gegenprobe bleibt Pflicht, siehe den belegten Datierungsfehler im
Semper-Portrait.

## Empfehlung für die Destillation

Zuerst die elf P1-Dateien destillieren, das ist eine überschaubare Charge mit dem höchsten
Ertrag. Danach das Luzerner Skript und die vier Zusammenfassungen der obersten Ebene, weil sie
den Epochenrahmen geschlossen liefern und damit die Einordnung aller weiteren Funde erlauben.
Die Tonmitschnitte erst dann, wenn eine Transkriptionsstrecke existiert. Alles unter X wird
