...
| D6 | **Dichte-Kennwerte je Gemeinde/Zone** — 8 von 11 Gemeinden mit voller Tabelle, D6 substanziell geschlossen | D/T | niedrig | **Run 25 (2026-07-13):** 7 weitere Gemeinden direkt aus amtlicher BZO/Baureglement extrahiert und belegt in [[az-gfz-kennwerte]] — Maur/Regensdorf/Wangen SZ/Muri AG (AZ), Zollikon/Wald ZH (Baumassenziffer), Einsiedeln (Ueberbauungsziffer); Luzern als System-Beschrieb (UEZ + Gesamthoehe-Klassen A-F je Ordnungsnummer, Per-Zonenwerte offen); Langnau am Albis BZO 2005 **ausser Kraft** (Revision 2026/27, Rechtsstand bei Gemeinde). **Kernbefund:** die Gemeinden nutzen drei nicht ineinander umrechenbare Bezugsgroessen (AZ vs. Baumassenziffer m3/m2 vs. Ueberbauungsziffer) — Vergleiche nur bei gleicher Kennziffer. Zusammen mit Thalwil+Waedenswil (Run 24). Offen/Wiedervorlage: Langnau (nach Revision), Luzern-Per-Ordnungsnummer, Muri-Aktualisierung 2019, Zollikon-Nachfolger BZO 1996 |
