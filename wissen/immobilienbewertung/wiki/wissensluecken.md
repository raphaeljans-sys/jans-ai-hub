...
| D2 | **Bodenpreise nur Screenshots** — ⚠ **teilweise geschlossen 23.08.2026 (Vertiefungslauf 2):** fuer die **Stadt Zuerich** liegt jetzt eine maschinenlesbare, amtliche Bodenpreis-Naeherung vor — Open-Data-CSV der LIMA-Handaenderungsstatistik (`bau_hae_lima_preise_anzahl_hae_art_bebauung_jahr_od5144`, CC0, Stand 05.02.2026, Daten 2008-2025, 47 Gebiete quartierscharf, Reihe «Preis pro m2 Grundstuecksflaeche abzgl. Versicherungswert»), ausgewertet und mit Vorbehalten in [[lageklasse-landwertanteil]] eingearbeitet | D | hoch | **Rest offen und unveraendert hoch:** die JANS-Kerngemeinden liegen **ausserhalb** der Stadt Zuerich (Seeufer, Bezirk Horgen, SZ). Dafuer weiterhin noetig: Zugang Handaenderungs-/Bodenpreisstatistik Kanton ZH bzw. SZ, oder Wuest-/IAZI-Bodenpreis-Abo. Die `IMMO-05`-Screenshots bleiben nicht maschinenlesbar |
