...
| D6 | **Ausnuetzungsziffer-Kennwerte** — 2 von 11 Gemeinden erfasst | D/T | mittel | `IMMO-06 WOHNEN Ausnuetzungsziffer` war leer — **Run 24 (2026-07-13):** Thalwil + Waedenswil (ZH) direkt aus amtlicher BZO (Art. 3 Grundmasse) extrahiert und belegt in [[az-gfz-kennwerte]]. Methode erwiesen tractabel (BZO-PDF der Gemeinde → `pdftotext -layout` → Grundmasse-Tabelle), Fruehere Einschaetzung "Grossrecherche noetig" war zu pessimistisch. Offen: Langnau am Albis, Zollikon, Maur, Regensdorf, Wald (ZH), Wangen, Einsiedeln (SZ), Muri (AG), Luzern — gleiche Methode je Gemeinde in Folgelaeufen anwendbar |
