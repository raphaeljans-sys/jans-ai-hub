# Lern-Report Immobilienbewertung — Training-Run 41 (2026-07-23)

**Ergebnis in einem Satz:** Delta-Null-Bestaetigungslauf (siebter in Folge) — kein neuer
Ingest, keine Artikelaenderung; die KB ist unveraendert saturiert und hat keine vom Loop
selbststaendig schliessbare Aufgabe mehr.

## Ablauf dieses Laufs

1. **Stand gelesen:** `training/PROGRAMM.md`, `training/curriculum.md` (Stand Run 40),
   `wiki/wissensluecken.md`, letzter Report `outputs/2026-07-22_training-run40.md`. Befund
   unveraendert: Wuest-Kurs (W0–W10) + alle Ergaenzungsquellen (E1–E10) + alle
   auto-schliessbaren T-Aufgaben eingearbeitet; der letzte selbst schliessbare Restposten
   (D6 Luzern) ist seit Run 36 zu. Alle verbleibenden Luecken sind extern gebunden
   (Bring-Schulden Raphael D1/D2/D5/D7/D9/D10 bzw. zeitlich blockiert: Langnau/Zollikon/
   Luzern-BZO fruehestens 2027, naechster amtlicher Referenzzins 01.09.2026).
...
2. **10 Themen NICHT erfunden.** Bei einer saturierten KB 10 Themen zu konstruieren waere ein
   ...
   - **Neuer JANS-Bewertungsfall?** Bewertungsordner
     `IMMO - 01 Projekte/01 BEWERTUNG PROJEKTE/` direkt gelistet — **unveraendert**. 11
     Fall-/Studienordner + `_Archiv`, juengster Bewertungsfall weiterhin **Wangen 8855
     Bahnhofstrasse 27 LB** (Ordner-mtime 09.06.). Kein neuer Fall seit Run 6. Kein Trigger.
...
3. **Kein Eskalations-Delta.** Beide offenen Pendenzen stehen bereits sichtbar in
   `logbuch/fristen.md` (im Lauf gegengeprueft: Zeilen 36 und 38) und werden **nicht** erneut
   geflaggt (der Trainings-Report ist als Meldekanal an Raphael nachweislich untauglich):
...
- Bestaetigt: die KB ist seit Run 16 (auto-schliessbare Rueckstaende) bzw. Run 36 (letzter
  Restposten) saturiert; Runs 34/35/37/38/39/40 waren bereits Delta-Null-Laeufe. Run 41 reiht
  sich ein — der siebte folgenlose Bestaetigungslauf in Folge.

## Was als naechstes

- **Entscheid Raphael zur Ruecktaktung ausstehend** (im Fristen-Register seit 19.07.). Bis
  dahin bleibt der Nachttakt; jeder Lauf ohne neuen Fall / neues Rohmaterial / neuen amtlichen
