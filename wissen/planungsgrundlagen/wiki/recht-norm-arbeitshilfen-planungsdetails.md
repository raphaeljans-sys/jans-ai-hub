...
## 7. Dach-Anschlageinrichtungen für Absturzsicherung — AUVA-Planungsgrundlage (Run 68, 2026-07-25)
...
die sich mit **persönlicher Schutzausrüstung (PSA) gegen Absturz** (Rückhalte-/Auffangsysteme,
Karabinerhaken, Falldämpfer) an baulich verankerten Anschlagpunkten sichern — eine frühzeitige
Dach-Planungsfrage, KEIN Doppel zu §3.

**Kernsystematik:**

- **Gefahrenbereich = gesamte Dachfläche**, «besonderer Gefahrenbereich» = 2 m Abstand zur
  Absturzkante — dort verstärkte Massnahmen.
...
- **Geometrische Planungsregeln:** Anschlagpunkt-Abstand zur Absturzkante **2,5 m** (ermöglicht
  ...
  klein zu halten — höheres Risiko); Steildach-Sicherheitsdachhaken im **Rastermass horizontal
  3,5 m / vertikal 5,0 m** (EN 517).
- **Zugang zur Anschlageinrichtung** selbst muss gesichert sein (Dachaufstieg/-ausstieg mit
  eigenem Anschlagpunkt in Reichweite, Rückenschutz bei Leitern).
...
Aufwand für Anschlagpunkte/Geländer) ergibt sich schon aus der geplanten Nutzung, nicht erst aus
der Ausführungsplanung. Ergänzt [[energie-pv-eignung-typenwahl]] (PV-Wartungszugang) und
