...
Quelle: **«Richtlinie für die Flächenerfassung und Erstellung von Bewirtschaftungsplänen (RFB)»**,
Version 7.0 (Stand 13.07.2007), Immobilien-Bewirtschaftung der Stadt Zürich, 85 Seiten. Regelt die
CAD-/CAFM-taugliche Flächenerfassung für **Bewirtschaftungspläne** — der städtische Vollzug von
**SIA 416 (2003) «Flächen und Volumen von Gebäuden»** und **SIA d 0165 (2000) «Kennzahlen im
Immobilienmanagement»** (DIN 277). Grundlagen-Normen laut Richtlinie: SIA 400 (Planbearbeitung),
SIA 405 (Planwerk unterirdische Leitungen), SIA 410/1+2 (Kennzeichnung Installationen),
**SIA 416 (2003)**, **SIA 416/1 (2005, Entwurf) «Kennzahlen für die Gebäudetechnik»**,
SIA-Merkblatt 2014 (CAD-Layerorganisation), SIA-Merkblatt 2007 (Qualitätssicherung),
**SIA d 0165 (2000)**.

Das erschliesst die im JANS-Kontext bisher nur begrifflich (nicht formelhaft) belegte SIA-416-
Flächensystematik — ergänzt [[recht-norm-raumprogramm-referenzwerke]] um die **rechnerische Ebene**
(Formeln + Abgrenzungsfälle), nicht nur die Kategorien-Übersicht.

### 1.1 Flächen-Hierarchie und Formeln (verifiziert gegen SIA 416/2003 S. 9–11 + SIA d 0165/2000)

- **Geschossfläche GF** = allseitig umschlossene, überdeckte Grundrissfläche des zugänglichen
  Geschosses inkl. Konstruktionsflächen. Aussenmasse der Bauteile inkl. Bekleidung (z.B. Aussenputz)
  in Fussbodenhöhe; konstruktive/gestalterische Vor-/Rücksprünge unberücksichtigt.
  **GF = NGF + KF**
- **Nettogeschossfläche NGF** = Teil der GF zwischen den umschliessenden/innenliegenden
  Konstruktionsbauteilen. **NGF = NF + VF + FF**
  - **Nutzfläche NF** = dient der Zweckbestimmung/Nutzung im weiteren Sinn. Gliedert sich in
    **Hauptnutzfläche HNF** (Zweckbestimmung im engeren Sinn) und **Nebennutzfläche NNF**
    (ergänzt HNF, z.B. Sanitärräume/Garderoben/Abstellräume).
    **HNF nach DIN 277 in 6 Kategorien** (Zuordnung Mischgebäude nach grösstem Flächenanteil):
    HNF 1 Wohnen und Aufenthalt · HNF 2 Büroarbeit · HNF 3 Produktion/Hand-/Maschinenarbeit/
    Experimente · HNF 4 Lagern/Verteilen/Verkaufen · HNF 5 Bildung/Unterricht/Kultur ·
    **HNF 6 Heilen und Pflegen** (direkt JANS-Healthcare-relevant: Kinderspital/Pflegezentrum-
    Raumprogramme fallen in HNF 6).
  - **Funktionsfläche FF** = für haustechnische Anlagen (Gas/Wasser/Elektro/Telefon/TV/Heizung,
    Aufzugs-/Fördermaschinenräume, Ver-/Entsorgungsschächte, Tankräume, lichte Querschnitte von
    Schächten/Kaminen/Installationskanälen >0.25 m²).
  - **Verkehrsfläche VF** = ausschliesslich Erschliessung/Zugang/Verkehr im Bauwerk/Verlassen im
    Notfall (Fluchtwege, Liftschachtflächen je Geschoss, Treppenaugen <5 m², offene Flächen unter
    Treppenläufen). Fahrzeug-Verkehrsflächen = **VF 9.4** (Durchfahrt/Manövrieren).
- **Konstruktionsfläche KF** = GF minus NGF, rechnerisch (kein eigenes Polygon).
  **KF = GF − NGF**. Gliedert sich in **KFT tragend** (Wanddicke d ≥ 15 cm, ausser
  Leichtbau-/Ständerkonstruktionen wie Gipsständerwände — diese gelten immer als nichttragend
  unabhängig von der Dicke) und **KFN nichttragend** (d < 15 cm). Bei nichttragenden Wänden
  verläuft das Raumpolygon **mittig durch die Wand**, nicht an der Wandkante.
- **Aussengeschossfläche AGF** = genutzte Grundrissfläche ausserhalb der allseitig umschlossenen
  GF (Balkone/Terrassen, offene Parkgaragen, Dachterrassen/-gärten, Aussentreppen,
  Eingangsbereiche, offene Lichthöfe, nutzbare Flachdächer). **AGF = ANGF + AKF** (analoge
  Untergliederung Aussen-Nutzfläche ANF / Aussen-Verkehrsfläche AVF / Aussen-Funktionsfläche AFF).
...
### 1.3 Mietflächen-Kaskade (VMF/VWAGF/ZF/LF/EMF/DMF/VTF)

**VMF (vermietbare Fläche) = GF + AGF − KFT − NNF_allg − FF_allg − VF_allg − AGF_allg** —
äquivalent **VMF = VWAGF + ZF**. Allgemeine (nicht individuell zuordenbare) Nebennutz-, Funktions-,
Verkehrs- und Aussengeschossflächen (Treppenhäuser, Schächte, allgemeine Sanitärräume,
Fluchtwege) sind für den Gebäudebetrieb unabdingbar und vom Eigentümer **nicht vermietbar**.
**VWAGF** (Wohn-/Arbeits-/Gewerbefläche, exklusiv einer Miteinheit zugeordnet) + **ZF**
(Zuschlagsfläche, gemeinschaftlich genutzt, anteilig verrechnet) = VMF. Weiter: **LF**
Leerstandsfläche (kein Mietvertrag) · **EF** Eigenmietfläche (Eigennutzung) · **DMF** Drittmiet-
fläche (an Dritte weitervermietet) · **VTF** effektiv vermietete Fläche.

**Spezialfall Brüstungen:** Flächen werden bis zur begrenzenden Konstruktionsfläche gemessen —
bei Verkaufsflächen bis zur **Innenkante Schaufenster**, nicht nur bis Innenkante Wand. Befindet
sich ein Heizkörper in einer Nische, zählt die Nischenfläche zur vermietbaren Fläche (Abweichung
zu SIA d 0165).

### 1.4 Problemfälle (Zusammenfassung §3.7 RFB-Richtlinie)

Direkt anwendbare Abgrenzungsregeln für die Flächenberechnung, teils über SIA 416 hinausgehend
(städtische Präzisierung): konstruktive/gestalterische Vor-/Rücksprünge an Aussenflächen zählen
**nicht** zur GF/KF, solange sie die NGF nicht beeinflussen · Installationsgeschosse/Kriechgänge
mit lichter Höhe <1.5 m gehören **nicht** zur GF (auch wenn zugänglich) · Räume unter Treppen/
Steildächern werden **bis zur begrenzenden Konstruktionsfläche gemessen**, auch bei Raumhöhe
<1.5 m (offen → VF, mit Raumabschluss → NF; die untersten zwei Treppenstufen zählen zu KF, nicht
VF) · nicht eindeutig polygonisierbare Räume sind mit der IMMO abzuklären.

## 2. CAFM-Bezeichnungssystem Stadt Zürich

Quelle: **«Merkblatt für Bezeichnungen IMMO»**, CAFM-Richtlinie V14.2, Immobilien-Bewirtschaftung
Stadt Zürich, 13.12.2006. Fasst die für Bewirtschaftungspläne verbindliche Nomenklatur zusammen —
relevant, wenn JANS für die Stadt Bewirtschaftungspläne/Bauwerksdokumentation liefert (Abgabe im
CAFM-System **Aperture**):

- **Standort**: 5-stellig, Präfix «S» + 4 Ziffern (z.B. `S0006` Amtshäuser I+III) — fasst
  zusammengehörige Gebäude IMMO örtlich zusammen.
- **Gebäude IMMO**: 6-stellig, Präfix «G» + 5 Ziffern (z.B. `G00387` Amtshaus III) — eine Baute in
  der Bewirtschaftung der IMMO, unabhängig von Eigentumsverhältnissen.
- **Geschoss**: 4-stellig, z.B. `OG02`/`OG01`/`EG00`/`UG01`/`UG02`; Sortierziffern absteigend vom
  Dachgeschoss zum Untergeschoss. Erdgeschoss bestimmt sich durch den Haupteingang.
- **Raum**: Geschossbezeichnung (4-stellig) + 3-stellige Raumnummer (z.B. `OG01001`), im
  Uhrzeigersinn nummeriert, in vier Nummernkreisen: 1. Nutzflächen HNF+NNF ab 001 · 2. Funktions-
  flächen FF ab 701 · 3. Verkehrsflächen VF ab 801 · 4. Aussengeschossflächen ANF/AFF/AVF ab 901.
- **Tür**: 2-stellig pro Raum, im Uhrzeigersinn ab Haupteingang des Raumes.
- **Parkplatz innen**: Gebäude-IMMO-Nr. + Präfix «P» + 4-stellig (z.B. `G12345P0001`). **Parkplatz
  aussen**: Parzellen-Nr. + Präfix «P» + 3-stellig (z.B. `AU123P001`).
- **Datei-/Plan-Namenskonvention Bewirtschaftungsplan**: `G00000-gggg-mmm-X00.dwg`
  (Gebäude-Nr. – Geschoss – Massstab 050/100/200 – Projektphase V/B/A/R – Index) — z.B.
  `G00387-OG01-100-R01.dwg`. Erfassungs-/Lieferzeitpunkte an SIA-102-Phasen gekoppelt: Vorprojekt
  (nach Ermessen), **Baueingabe/Ausführung/revidierte Ausführung = zwingend für CAFM-Import**.

## 3. Sicherheitsnachweis Elektroinstallationen (SiNa)

Quelle: **«Merkblatt Sicherheitsnachweis (SiNa) Elektroinstallationen»**, AHB Fachstelle Energie
und Gebäudetechnik, Version 1.1 (13.05.2005/23.11.2007). Regelt den Ablauf der Elektro-
Installationskontrollen nach **Niederspannungs-Installationsverordnung (NIV, SR 734.27)**, in Kraft
seit 1.1.2002, für Bauvorhaben UND laufende Gebäudebewirtschaftung der Stadt Zürich.

**Kontrollperioden nach NIV** (Grundlage für die Terminplanung bei jedem Stadt-ZH-Projekt):

| Periode | Anlagentyp |
|---|---|
| Jährlich | Baustellen |
| **5 Jahre** | Laboratorien/Prüffelder Schulen, Gewerbebetriebe, Industrie; **Gebäude mit grosser Personenbelegung** — Schulhäuser, **Spitäler**, Theater, Gaststätten, **Heime** |
| 10 Jahre | Nasse gewerblich genutzte Räume; Bürogebäude, gewerbliche Werkstätten |
| 20 Jahre | Wohnbauten, alle übrigen Installationen |

Installationen mit 10-/20-jähriger Periode müssen zusätzlich bei jeder Handänderung nach Ablauf
von 5 Jahren seit letzter Kontrolle überprüft werden. **JANS-Relevanz:** Healthcare-Bauten
(Spitäler/Heime/Pflegezentren) unterliegen der **strengsten periodischen Kontrolle (5 Jahre)** —
bei Bauleitungsmandaten für Kliniken/Pflegeheime ist der SiNa-Zyklus in die Betriebsübergabe-
Dokumentation aufzunehmen.

**Ablauf Neuinstallation:** Unternehmer installiert → betriebsinterne Schlusskontrolle →
unterzeichneter SiNa an Auftraggeberin (AHB) → bei Kontrollperiode **<20 Jahre**: Auftraggeberin
(Planer, ev. delegiert an Elektroplaner) beauftragt **unabhängige Kontrolle** innerhalb 6 Monaten,
Ergebnis geht an Netzbetreiberin (ewz) + Eigentümerin (IMMO/Liegenschaftenverwaltung LVZ); bei
Periode **=20 Jahre** genügt die direkte Einreichung ohne unabhängige Zusatzkontrolle. Berechtigt
zur unabhängigen Kontrolle: konzessionierte Elektroinstallationsfirmen/Kontrollunternehmen (z.B.
ewzert AG), akkreditierte Inspektionsstellen (z.B. electrosuisse, Pflicht bei
Gefährdungspotential), Netzbetreiberinnen (nur mit unabhängiger Organisationseinheit), das
Inspektorat. Wer an Planung/Erstellung/Änderung beteiligt war, darf die Kontrolle **nicht selbst**
durchführen (Unvereinbarkeit).

## 4. Standard Gebäudeautomation Pflegezentren Stadt Zürich (GA-Standard PZZ)

Quelle: **«Pflegezentren der Stadt Zürich — Standard Gebäudeautomation»**, Version 1.1 (Juli 2008),
AHB Fachstelle Energie und Gebäudetechnik, in Zusammenarbeit mit den Pflegezentren (PZZ, Teil des
Gesundheits- und Umweltdepartements GUD) und der Immobilien-Bewirtschaftung. **Direkt
Healthcare-relevant** — PZZ ist mit rund 1'800 Mitarbeitenden und über 1'500 Betten die grösste
Institution dieser Art in der Schweiz (10 städtische Pflegezentren + Schule für Berufe im
Gesundheitswesen SGZ). Verbindlich für Neubauten/Gesamterneuerungen sowie weitgehenden/
vollständigen Ersatz der Gebäudeautomation; bei Teilerneuerungen gilt das Verhältnismässigkeits-
prinzip. Umsetzung erfordert projektspezifische Planung durch einen ausgewiesenen
Fachingenieur Gebäudeautomation.

### 4.1 Raumautomations-Anforderungen nach Raumtyp (Kernstück, §3.2)

| Raumtyp | Raumtemperatur | Beleuchtung | Lüftung | Storen |
|---|---|---|---|---|
| **Patientenzimmer** | Thermostatventile | Manuell (grosse Tasten mit Beschriftung) | Dauerbetrieb | Manuell, je nach Produkt mit Sicherheitsfunktion bei Wind/Regen/Frost |
| Gemeinschaftsräume (Saal, Restaurant) | Thermostatventile | Manuell, ev. Szenen | Zeitabhängig; grosse Räume mit Luftqualitätsregelung | (s. Patientenzimmer) |
| Verkehrszonen (Hallen, Korridore, Treppenhäuser) | Thermostatventile | Zeit-/tageslichtabhängig, reduzierte Stärke nachts | Zeitabhängig | — |
| Funktionsräume (Therapie, Küche, Wäscherei) | Thermostatventile | Manuell | Zeitabhängig, manuelle Übersteuerung mit Timer möglich | — |
| Nebenräume (Lager, Technik) | — | Präsenz-/tageslichtabhängig (Bewegungsmelder) | Zeitabhängig | — |

Die Tasten-Bedienung in Patientenzimmern ist explizit **gross und beschriftet** vorzuschreiben —
ein direkt übertragbares Detailkriterium für Healthcare-Raumprogramme.

### 4.2 Alarm-Priorisierung (§3.4) — Muster für Healthcare-Betriebskonzepte

- **Priorität 1**: Personen-/Anlagengefährdung oder Ausfall betriebskritischer Anlage (z.B.
  Warmwasserversorgung) → sofortige Reaktion.
- **Priorität 2**: Anlage/Anlageteil ausgefallen → Intervention nächster Arbeitstag.
- **Priorität 3**: Wartungsmeldungen → reguläre Unterhaltsarbeiten.

Während TD-Bürozeiten gehen Prioritäten 1+2 ans DECT-Handy des TD-Leiters; ausserhalb der
Bürozeiten Priorität 1 an die Nachtwache (Pflegepersonal) + SMS an den Pikettdienst. Die
betriebstechnischen Systeme (Patientenruf, Weglaufschutz) werden **nicht** ins GA-System
integriert, da sie ohnehin 24h durch das Pflegepersonal überwacht werden — die Alarmierung läuft
über einen vom GA-System unabhängigen, gleichberechtigten **Alarmserver** (Grundsatz: GA-System,
Brandmeldeanlage und Patientenrufanlage sind gleichrangige, getrennte Meldewege). Querverweis
Brandmeldeanlage-Systematik → [[brandschutz-pl03-wegweiser]] §5v/§5x.

### 4.3 Gebäudetechnische Anlagen unter GA-Steuerung vs. nur Überwachung (§3.1)

**Gesteuert/geregelt/überwacht**: Wärmeerzeugung (Kessel/Wärmepumpe/BHKW), Wärmeverteilung,
Brauchwarmwasser, Lüftung (ausser dezentrale Abluft ohne WRG), Klimakälte. **Nur überwacht**
(Störmeldung): Abwasserpumpen, Aufzugsanlagen, Blindstrom-Kompensation, Brandmeldeanlage,
Gaswarnanlagen, gewerbliche Kälteanlagen (Kühlzellen), Leckwarnanlagen, Notlichtzentrale,
USV (nur zentrale Anlagen), Wasseraufbereitung. Konventionelle Steuergeräte (insbesondere
...
**Neuer Fund:** Ein bisher nie erschlossener zweiter eco-bau-Ordner (Nummerierungsschema
1.xx-6.xx statt 18.x wie in §6 oben) liefert zwei genuine Ergänzungen. Cloud-only-Dateien
(analog Run 63/64), per `cp` materialisiert.

**«Verein eco-bau»** (Impressum 3.12.R, Stand Februar 2006) ist **kein Stadt-ZH-internes
Konstrukt**, sondern ein nationaler Trägerverein mit KBOB (Bund) als Koordinationsstelle sowie
den Hochbauämtern der Kantone AG/ZH/AI/GE/VD/AR/BL/BE/GR/SG/SH/SO/TG/LU/FR/JU/NE/SZ und den
Städten Zürich/Thun/Biel/Köniz/Luzern/St. Gallen/Baden/Bern/Winterthur/Zug/Genève/Neuchâtel/
Lausanne/Onex — die Stadt-ZH-Dokumente in §6 sind also lokale Anwendung eines gesamtschweizerischen
Systems, nicht ein Zürich-Spezifikum.

**«Ökologisch Bauen — Merkblätter nach BKP»** (3.12.R, eco-bau, Ausgabe 09/2006) liefert das
vollständige **BKP-Register der eco-bau-Merkblätter**: 112 Abbrüche/Rückbau/Entsorgung, 130
Baustelleneinrichtung, 201 Baugrubenaushub, 211 Baumeisterarbeiten, 213 Stahlbau, 214
Zimmerarbeiten, 215 Leichtkonstruktionen, 221 Fenster/Aussentüren, 222 Spenglerarbeiten, 224
Bedachung, 225 Dichtungen/Dämmungen, 226 Fassadenputze, 227 äussere Oberflächenbehandlungen, 230
Elektroanlagen, 240 Heizungsanlagen, 244-245 Lüftungs-/Klimaanlagen, 250 Sanitäranlagen, 271
Gipserarbeiten, 273 Schreinerarbeiten, 281 Bodenbeläge, 282 Wandbeläge, 283 Deckenverkleidungen,
285 innere Oberflächenbehandlungen — direkt nutzbar als Prüfliste beim LV-Aufbau nach
BKP 2017 (Rule `bkp-2017-referenz`), um pro Gewerk die passende eco-bau-Ökologie-Anforderung
zuzuordnen.

**«Allgemeine bauökologische Submissionsbedingungen»** (3.11.R, AHB Stadt Zürich, September 2006)
ist die **integrierender Vertragsbestandteil**-Fassung mit konkreten, LV-tauglichen Materialverboten/
-pflichten — präzisiert §6.1 Werkleistungen um harte Zahlen: RC-Beton **≥ 60 % rezyklierte
Gesteinskörner** als Hauptposition (nicht Variante/PER); Mörtel/Putze ohne Biozide
(Algizide/Fungizide), keine Kunststoffbindemittel; Holzwerkstoffe **Formaldehydklasse E1 /
Lignum CH 6.5**, bei grossflächigem Einsatz (≥ 0.2 m² Plattenoberfläche/m³ Rauminhalt) zusätzlich
Qualität V100 oder RAL UZ-76 bzw. formaldehydfreie Bindemittel; Tropenholz nur FSC-zertifiziert;
Klebstoffe wasserbasiert/lösemittelfrei; Fugendichtungsmassen **0 % Lösemittel**; Wärmedämmstoffe
ohne halogenierte Treibmittel (HFKW/FKW); textile Bodenbeläge auf Reaktionsharz-Basis **verboten**,
Verlegewerkstoffe EMICODE EC1; Leitungsmaterialien Elektro/Sanitär halogenfrei; **Montageschäume
verboten**; Baumaschinen/Fahrzeuge ohne Strassenzulassung ≥ 18 kW mit Partikelfilter (BUWAL/Suva-
Filterliste); Benzingeräte mit Alkylatbenzin (SN 181 163); Bauabfälle nach SIA 430; Abschluss-
messung Raumluftqualität nach 1 Monat Auslüftung: **Formaldehyd < 60 µg/m³, TVOC < 1000 µg/m³**
(VDI 4300) — bestätigt exakt die bereits in §17.3/[[energie-baustoffe-schadstoffe-rueckbau]] §6
dokumentierten Zahlen, jetzt mit der vollständigen Materialverbotsliste ergänzt.

**Delta-Check «1.11.R Massstäbe für Umwelt- und Energiegerechtes Bauen» (Mai 2006):** bestätigter
**Vorläufer** des bereits in §6.3 dokumentierten 7-Meilenschritte-Flyers (dort Stadtratsbeschluss
Nr. 1094 vom 17.9.2008) — inhaltlich identische sieben Meilenschritte, zwei Jahre früher als
internes AHB/IMMO-Programmpapier veröffentlicht, kein neuer Sachverhalt.
...
> ### ⚠ Fassungsvermerk SIA 382/1 — die AHB-Standards zitieren die Ausgabe 2007 (gesetzt 23.08.2026)
>
> Die Abschnitte §12.1, §13.2 und §13.3 zitieren dreimal **SIA 382/1:2007** (Ziff. 2.1.3/2.1.4
> thermisch aktive Speichermasse und Sonnenschutz, Ziff. 4.4.4 Bedarfsnachweis Raumkühlung,
> Lüftungskonzept-Pflicht). **Die Zitate sind quellentreu und bleiben unverändert** — die
> AHB-Projektstandards nennen diese Ausgabe.
>
> **Neu zu wissen:** die **geltende Ausgabe ist SIA 382/1:2025**, und sie ist seit dem
> **01.04.2026 rechtlich aufgeladen**. Die revidierte Lärmschutz-Verordnung macht sie zum
> Massstab für den «Stand der Technik» kontrollierter Wohnraumlüftungen in lärmbelasteten
> Gebieten: Art. 31 Abs. 1bis LSV verlangt Raumluftqualität **IDA 2 nach SIA 382/1:2025,
> Tabelle 18** (alternativ SIA 382/5:2021, Ziff. 5.2.4), dazu **SIA 180:2014 Figur 4** und
> **SIA 380/2:2022 Ziff. 3.2.4** für die Temperatur sowie **SIA 181:2020 Tabelle 2** für den
> Lärm. Herleitung: [[recht-norm-quellenlandkarte]], Abschnitt «LSV-Novelle 01.04.2026 — Details
> geschlossen an der Primärquelle».
>
> **Praxisfolge für ein AHB-Projekt an lärmexponierter Lage:** die Ziffernverweise der
> AHB-Standards zeigen auf eine **18 Jahre alte Ausgabe**; wer den KWL-Weg der LSV beschreiten
> will, muss gegen die **Ausgabe 2025** nachweisen. Bei jedem Nachweis die unterstellte Ausgabe
> ausschreiben — die Ziffernnummerierung kann zwischen den Ausgaben abweichen, ein Verweis auf
> «Ziff. 4.4.4» ohne Jahrgang ist nicht eindeutig.
>
> ⚠ **Nicht geprüft und deshalb nicht behauptet:** welche Ziffern sich zwischen 2007 und 2025
> materiell geändert haben. **SIA 382/1:2025 liegt nicht im Haus**; das Delta wäre über die KB
> `normen` zu beschaffen (Rule `normen-referenz`, Führung der Norm-Fundstelle liegt dort). Hier
> steht nur der Fassungsvermerk, kein Inhaltsvergleich.
...
- **09-Projektdokumentation / 10-Projektablauf / 04-Grafikvorlagen**: Struktur Run 52 vollständig
  kartiert. **04-Grafikvorlagen-Ordnerrücken bestätigt als reine Büro-/CI-Vorlagen** (drei
...
— relevant sobald JANS ein Mandat mit der Stadt Zürich als Bauherrin/Eigentümerin führt
...
## 18. Projektdokumentation (PAB 2.16.R) + Abnahmeprotokoll SIA 118 — Ordner 09/10 (Run 60, 2026-07-25)

Letzter noch offener Backlog-Punkt aus §9: der OneDrive-Lock aus Run 52 hatte sich aufgelöst
(reines Sync-Timing, analog dem Naturgefahren-/Lignum-Präzedenzfall), alle vier Dateien in
`09-Projektdokumentation/09.1-Projektdokumentation/` und `10-Projektablauf/10.6-Projektabschluss/`
sind jetzt vollständig gelesen.

### 18.1 Richtlinie für Projektdokumentationen (PAB 2.16.R, Stand 01.06.2008)

Verbindliche **Gliederungsstruktur** für die Vorprojekt-/Bauprojekt-Dokumentation, die JANS bei
einem Stadt-ZH-Mandat abgeben muss (A4-Hochformat-Broschüre, z.B. Spiralbindung):

0 Titelblatt (Logo AHB, Dokumentbezeichnung «Dokumentation Vorprojekt»/«Dokumentation
Bauprojekt», Projektbezeichnung mit Foto, Auftrags-/BAV-Nummer) · 0 Inhalt · 1 Zusammenfassung
(max. 1 Seite: Ziele/Kosten/Termine) · 2 Einleitung (2.1 Ausgangslage, 2.2 Ziele und Bedürfnisse,
2.3 Grundlagen, 2.4 Grundstücksdaten, 2.5 Lage, 2.6 Situation, 2.7 Randbedingungen) · 3 Ist-Zustand
(3.1 Baugeschichte und Denkmalpflege, 3.2 Bausubstanz, 3.3 Fotos) · 4 Kosten und Kennzahlen
(4.1 Gesamtanlagekosten mit Unterschrift der Projektverfassenden, 4.2 Mengen und Kennzahlen nach
SIA 416, 4.3 Vergleichsobjekte/Benchmarks, 4.4 Kostenvoranschlag/-schätzung nach BKP) ·
5 Projektbeschrieb (5.1 Raumprogramm und bauliche Massnahmen, 5.2 Baubeschrieb nach BKP,
5.3 Projektbeteiligte) · 6 Termine (6.1 Terminprogramm, 6.2 Etappierung und Provisorien) ·
7 Pläne (Situation/Umgebung/Grundrisse/Schnitte/Fassaden, A3).

**Spezielle Kennzahlen (§4.2, Beispiele der Richtlinie):** Kosten pro funktionale Einheit
(CHF/Klasseneinheit, CHF/Arbeits- oder Sitzplatz, **CHF/Kranken- oder Altersheimbett** — direkt
JANS-Healthcare-relevant), Kosten pro vermietbare Fläche (CHF/m² NNF), Energieverbrauch pro EBF
und Jahr (MJ/m²·a nach SIA 380/1), Verhältnis HNF/GF (SIA D 165).

### 18.2 Reales Musterbeispiel: Instandsetzung Schulanlage Döltschi (Leutwyler Partner Architekten, 2008)

Die Musterdokumentation ist kein Blanko-Formular, sondern eine **vollständig ausgefüllte reale
Fallstudie** (Auftrag W.4444, Stand 01.10.2008) — direkt als Benchmark für Umfang/Detailtiefe
nutzbar: Instandsetzung + betriebliche Anpassung einer denkmalgeschützten 1964er-Schulanlage
(Architekt Hans Müller, Gartendenkmalpflege Ernst Cramer) bei laufendem Betrieb, Etappierung über
2 Jahre (Baubeginn Frühjahr 2009, Fertigstellung Frühjahr 2011). Gesamtanlagekosten **20.68 Mio.
CHF** (Erstellungskosten BKP 1-9 17.98 Mio. + 15 % Reserven 2.70 Mio., Indexstand 01.04.2008).
Bemerkenswerter methodischer Grundsatz aus 2.2: bei Bestandeseingriffen kann auf den
Minergie-Umbaustandard und kontrollierte Lüftung **verzichtet** werden, wenn die Eingriffstiefe
unverhältnismässig wäre — neue Bauteile müssen dann nur die Einzelbauteil-Anforderung erfüllen
(Cross-Ref [[energie-uebersicht]] U-Wert-Bestandeslogik).

Die begleitende `Projektdokumentation_KV.xls` liefert dazu die **vollständige BKP-1-9-
Kostengliederung als reales Zahlenbeispiel** (3-/4-stellige BKP-Position mit Frankenbeträgen je
Position, z.B. BKP 1 Vorbereitungsarbeiten 2.29 Mio., BKP 2 Gebäude 11.73 Mio., feingegliedert bis
auf Einzelgewerke wie 211.7 Instandsetzungsarbeiten Beton-/Backsteinsanierung 485'000 CHF) — direkt
als Struktur-Vorlage für JANS-Kostenzusammenstellungen nach BKP nutzbar, ergänzt die generische
BKP-2017-Referenz (Rule `bkp-2017-referenz.md`) um ein reales, vollständig durchgerechnetes
Zahlenbeispiel einer Schulhaus-Instandsetzung.

### 18.3 Abnahmeprotokoll SIA 118 (Stadt-ZH-Formular, Stand 24.05.2006)

Amtliches AHB-Formular für die **Werkabnahme nach Art. 157 ff. SIA 118**: Kopfdaten (Objekt/
Auftrag, Auftraggeberin/Bauleitung/Unternehmerin mit Vertretung, Werkvertragsdatum, betroffene
Arbeiten), Prüfungsprotokoll nach **Art. 158 Abs. 2 bzw. Art. 161 Abs. 3 SIA 118** mit
Ankreuzfeldern «keine Mängel / unwesentliche Mängel / wesentliche Mängel», Bemerkungsfeld,
Mängelbehebungsfrist, Entscheid «Werk gilt als abgenommen (Art. 159/160)» vs. «Abnahme wird
zurückgestellt (Art. 161)», Unterschriftenfelder Auftraggeberin/Unternehmerin/Bauleitung.
Direkt anschlussfähig an Skill `unternehmerkontrolle` (Phase H, Abnahme-Baustein) — bestätigt die
dortige SIA-118-Systematik am realen Stadt-ZH-Formularmuster, kein Delta zu den bereits
dokumentierten SIA-118-Grundlagen, aber erstmals ein reales, direkt verwendbares Formularbeispiel.
