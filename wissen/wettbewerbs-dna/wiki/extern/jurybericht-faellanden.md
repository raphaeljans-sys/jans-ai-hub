...
sources:
  ...
  - "Text-Extrakt: /Volumes/daten/jans-ai-hub/wissen/wettbewerbs-dna/raw/extern-jurybericht-faellanden.txt"
links:
  - "[[teilnahmen/2206-schoental]]"
---

# Jurybericht Fällanden — Kindergarten und Tagesbetreuung (2016)
...
## Siegerprojekt «JOAN» (1. Rang, nach Bereinigungsstufe)
...
- **Nachhaltigkeits-Plausibilität**: unkonventionelle Konzepte müssen belegt sein — der Lüftungsverzicht bei «Campus Lätten» wurde «angezweifelt» (Sommerfall, Strassenlärm) trotz günstigstem Werkpreis (S. 35); billig allein rangiert nicht

## Verallgemeinerbare Regeln (DNA)

1. Bei Ergänzungsbauten auf Schularealen mit knappem Grundstück gewinnt der **kompakte, mehrgeschossige Solitär**: er maximiert den Freiraum, die Energie-Kompaktheit und die Wirtschaftlichkeit gleichzeitig (Fällanden: 3-geschossig gewann, 1-geschossig-flächig wurde K.-o.)
2. **Erschliessung als nutzbaren Raum entwerfen** (zentrale möblierbare Halle statt Korridor) — und für Spitzenfrequenzen dimensionieren; eine zu enge Treppe kann allein das Ausscheiden verursachen
3. **Betriebslogik früh verifizieren** (Küche/Anlieferung, Wegführung, Geschossverteilung der Betreuung, hindernisfreie Erschliessung ausserhalb Schulzeiten): die Jury liest den Grundriss aus Sicht des Personals; Experten Betrieb/Schulleitung sitzen mit am Tisch
4. Die **Setzung muss die bestehende Anlage weiterbauen** (Hof fassen, Adresse an der richtigen Achse bilden, Textur fortsetzen) — ein starkes Innenkonzept rettet eine beziehungslose Setzung nicht; umgekehrt liess die Jury ein Projekt mit gutem Kern nachbessern statt es zu verwerfen
5. Bei gewichtetem Werkpreis (hier 30 %) reicht «mittlere Kosten + hohe Gebrauchsqualität»: das günstigste Projekt (3. Rang) verlor an Betrieb und Aussenraum, das teuerste schied aus — Kosten wirken als Korridor, nicht als Rangordnung
