...
sources:
  ...
  - "/Volumes/daten/jans-ai-hub/wissen/wettbewerbs-dna/raw/extern-jurybericht-froeschmatt-pratteln.txt (pdftotext-Extrakt)"
links:
  - "[[teilnahmen/2206-schoental]]"
---

# Jurybericht Fröschmatt Pratteln — Muster-Notiz (fremdes Referenzverfahren)
...
- Beurteilungskriterien: Städtebau/Architektur/Innenraum · Funktionalität und Flexibilität · Raumprogramm · Nachhaltigkeit und energetische Innovation · Wirtschaftlichkeit Erstellung und Betrieb · **Etappierbarkeit und Rochadeplanung** (S. 11).
- Rangierung (S. 13): 1. LUNGO (Burckhardt+Partner, Basel) · 2. PRATELLUM (Stadler Zlokapa, Basel) · 3. FREITAG (Demian Peper, Zürich) · 4. AURELIA (Degelo Architekten, Basel). Entscheid für LUNGO einstimmig (S. 12).
...
- Kernargumente der Jury:
  ...
  3. **Pädagogik eingelöst**: Lernlandschaften autonom organisierbar, WC/Garderobe/Kopier-/Inputräume integrierter Bestandteil der Ateliers, klare Wege; die Struktur bietet «Geborgenheit» und stärkt die Identität der Lerngruppe (S. 22).
  4. «bemerkenswerten Bearbeitungstiefe» und auf allen Ebenen durchdachte Disposition (S. 22).
- Vorbehalte trotz Sieg (Empfehlungen S. 14): unterirdische Veloeinstellhalle betrieblich/wirtschaftlich/oekologisch problematisch (oberirdisch prüfen), Turnhallen-Aufteilung auf zwei Volumen überprüfen, hoher Glasanteil hinterfragen, Erdüberdeckung der Bepflanzung nachweisen.
...
- **Freiraum-Hygienefaktoren**: geschützte Baumreihen respektieren (bei fast jedem Projekt geprüft), differenzierte Pausenräume mit Nischen statt grosser Restflächen (Friedrich, MOBYDICK negativ), klare Adressbildung der Zugänge, dezentrale oberirdische Velostellplätze an allen Arealzugängen.
- **Etappierung/Provisorien werden konkret geprüft**: zwei Bauetappen «ungünstig» (PRATELLUM S. 29), fehlende Provisorienflächen vermerkt (S. 30), Etappierung «nicht praktikabel» (AURELIA S. 46).

## Verallgemeinerbare Regeln (DNA)

1. **Bei Schulwettbewerben mit Lernlandschafts-Pädagogik entscheidet die Cluster-Funktionalität**: alle Lernateliers gleichwertig (Aussenraum, WC/Garderobe/Input integriert, Aufsicht möglich), keine Korridorschule — Verstoss ist faktisch ein K.-o. im 1. Rundgang.
2. **Unterirdische Nutzflaechen (Turnhallen, Aulen, Velohallen) vermeiden oder minimal halten**: die Trias Wirtschaftlichkeit + Betrieb + graue Energie (SIA 2040) macht sie zum meistwiederholten Abwertungsargument; wer sie braucht, muss Dachnutzung und Minderversiegelung als Kompensation zeigen (so der Sieger).
3. **Setzung aus dem Kontext herleiten und benennen**: die Jury akzeptiert sogar einen Massstabssprung, wenn die Typologie nachvollziehbar aus Umgebungsmerkmalen abgeleitet ist; unbegründete Grossformen ohne differenzierten Freiraum scheiden aus.
4. **Bestandeserhalt ist nur ein halbes Argument**: er punktet bei Nachhaltigkeit und Kosten, gewinnt aber nur, wenn Grundrisse, Erdgeschosse und Fassaden das Konzept architektonisch einlösen.
5. **Nebenkriterien sauber bedienen**: Etappierung/Rochade mit Provisoriennachweis, geschützte Baeume, Velostellplaetze oberirdisch an jedem Zugang, klare Adressen — billige Punkte, deren Fehlen in fast jeder Wuerdigung vermerkt wird; hohe, echte Bearbeitungstiefe wird explizit honoriert.
