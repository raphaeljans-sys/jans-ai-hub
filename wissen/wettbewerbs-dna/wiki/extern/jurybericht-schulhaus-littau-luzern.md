...
# Jurybericht Schulhaus Littau Dorf, Luzern — Gesamtsanierung und Erweiterung bestehender Schulanlage

## Verfahren / Auslober / Jahr / Bauaufgabe

- **Verfahren:** Offener, anonymer Projektwettbewerb nach SIA 142 fuer Teams der Fachrichtungen Architektur, Landschaftsarchitektur und Bauingenieurwesen (S. 5, 23).
- **Auslober:** Stadt Luzern; Bericht des Preisgerichts am 23. Juli 2020 z. H. des Stadtrats genehmigt (S. 24, Titelblatt).
- **Jahr:** Jurierung Mai–Juli 2020, Genehmigung 23.07.2020 (S. 22–24).
- **Bauaufgabe:** «Sorgfaeltiges Weiterbauen» der bestehenden Schulanlage. Schulraumerweiterung um zusaetzliche Primarschulabteilungen und zwei Kindergartenabteilungen, neue Dreifachturnhalle anstelle der bestehenden zwei Einfachturnhallen sowie Gesamtsanierung der Trakte A und B (Ersatz Trakt B grundsaetzlich denkbar); zu konzipieren ist eine Etappierung mit durchgaengigem Schulbetrieb, noetigenfalls mit Provisorien (S. 4–5). Areal mit anspruchsvoller Topografie und bestehendem Wald (S. 23).
- **Beteiligung:** 38 eingereichte Projekte; Ausscheidung in drei Bewertungs- und zwei Kontrollrundgaengen (1. Rundgang 14 Projekte aus, 2. Rundgang 13 aus), 7 Projekte der engeren Wahl, 7 Preise. Preissumme Fr. 160'000.00 exkl. MwSt. fuer 5–7 Preise (S. 20–23).
- **Beurteilungskriterien** (ohne Gewichtung): A Kontext, Staedtebau und Architektur (staedtebauliches Gesamtkonzept, Identitaet, formale Qualitaet, Aussen-/Freiraeume, Umgang mit den Inventarobjekten); B Nutzung und Gestaltung (Raumprogramm, Funktionsnutzen, Nutzungsflexibilitaet, funktionierender Betrieb, Erschliessung, flexibilitaetsstuetzendes Tragwerk); C Funktionalitaet, Wirtschaftlichkeit, Nachhaltigkeit (Material/Konstruktion, effizientes Tragwerk, Etappierung, Wirtschaftlichkeit der Grundrisse nach SIA 416, Minergie A-ECO/PV, Erhalt naturnaher Lebensraeume) (S. 9).

## Siegerprojekt: Nr. 33 «Lucky Luke und die Daltons» (Jaeger Charpie Architekten GmbH, Emmen; Berchtold.Lenzin Landschaftsarchitekten)

- **Typologie (KB-Taxonomie):** Ensemble/Mehrkoerper im Weiterbauen — drei praezis gesetzte Neubauten (Klassentrakt C, Betreuungspavillon mit Kindergaerten und Aula, Dreifachturnhalle), die die erhaltenen Bestandesbauten (Trakt A/B) zu einer neuen Gesamtanlage ergaenzen; Klassengeschosse um eine zentrale Atelierzone fuer je vier Gruppen (Erschliessung: Cluster) (S. 28–29).
...
## Wiederkehrende Jury-Argumente und K.-o.-Punkte (ueber die Raenge 1–7)

- **Der ortsbauliche/staedtebauliche Ansatz entscheidet an der Spitze.** Bis zuletzt wurden zwei gegensaetzliche, je fuer valabel befundene Konzeptionen gegenuebergestellt; ausschlaggebend fuer den Sieger war der auf Quartier und Schulbetrieb «massgeschneiderte» ortsbauliche Ansatz (S. 22–23).
...
- Kennzahlen (GF/GV, Kosten je Projekt nach eBKP-H/BKP) und die Wuerdigungen der Raenge 4–7 sind im Textextrakt nicht enthalten; bei Bedarf Original-PDF (Plandarstellungen, Vorpruefungsanhang) konsultieren.
