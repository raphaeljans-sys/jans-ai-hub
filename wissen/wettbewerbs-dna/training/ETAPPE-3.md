...
|---|---|---|---|---|---|---|
| Schulbau (Prio 1) | erledigt (`outputs/2026-07-14_etappe3-schulbau-sweep.md`) | 23 Bestand | **23/23 established** | **established (23/23, Refuter-Welle bestanden)** | **offen — naechste Zelle** | **established** (`wiki/muster/kennwerte-schulbauten.md`, 25 Quellen, 431/436 refuter-bestaetigt) |
