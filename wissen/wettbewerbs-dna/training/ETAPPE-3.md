...
| Healthcare (Prio 2) | **erledigt** (`outputs/2026-07-23_etappe3-healthcare-sweep.md`: 48 Kandidaten, 42 frei-pdf verifiziert) | 6 Bestand (ksa · sihlsana · ipw-schlosstal · luks-sursee · taegermoos · bombach) | **6/8 established** (Tranche 1: ksa, sihlsana, ipw-schlosstal; Tranche 2 25.07.: luks-sursee-schwyzermatt [spital, Sieger «Feld und Flur»], alterswohnen-taegermoos-kuesnacht [alterswohnen, «Kassiopeia»], haus-der-demenz-bombach-zuerich [pflegeheim/Demenz, «ERIKA»]; je Refuter-bestanden, Sursee mit korrigierter Misattribution) | — | healthcare-neubau-zh.json v1.0 vorhanden (Revision nach B6) | ausstehend |
