...
## Registerkorrektur zu Fidelity 260808: der Honorarangriff blieb nicht unbeantwortet (Batch 91)

Der Fidelity-Lauf vom 08.08.2026 notierte zu Gold C, «die eigene Abgebotsabsicht steht im To des
Unternehmers, während der **Honorarangriff des Bauherrn unbeantwortet** bleibt». Das trifft für die
untersuchte Mail zu, für den Vorgang nicht: Albin Spahics Absage vom **06.05.2026 11:02** («Zudem
sehen wir nicht ein, für Planungsarbeiten CHF 5'000 zu bezahlen») wird **34 Minuten später**
beantwortet, im selben To/Cc-Kreis — und zwar **gegen** den Bauherrn und **für** den Zulieferer:
die Planungsleistung soll als gesonderte Kostenstelle ausgewiesen und «unabhängig vom Ausgang der
Submission … im marktüblichen Rahmen vergütet werden».

Damit ist die Haltung «der Fachbeitrag des Zulieferers wird bezahlt, auch wenn er den Auftrag nicht
bekommt» belegt — sie ist das Gegenstück zur bereits belegten Kostenehrlichkeit **gegen** den
Zulieferer (Batch 90 h): Raphael schmälert dessen Auftrag ungefragt, wo Geld zu sparen ist, und
verteidigt dessen Vergütung ebenso ungefragt, wo sie erarbeitet wurde.

**Einschränkung, die stehen bleiben muss:** die Antwortmail ist **KI-assistiert** (Echo-Signale:
fremdes CSS `background-color:rgb(253,253,252)` wie beim Erstfall der Kaltakquise vom 17.04., null
Tippfehler gegen die dicht fehlerbehaftete eigene Hand **29 Minuten früher** am selben Tag). Verbucht
ist deshalb **die Entscheidung, nicht die Formulierung** — Raphael hat den Standpunkt bezogen und die
...
## Mailbatch 94 (03.–07.08.2026) — der abgebrochene Satz als Drohgebärde, und der Erfolg vor der Restarbeit

- **Die Erwartung wird formuliert, der Vorwurf abgebrochen.** An das Fachplanerteam, nachdem die
  Behörde eine falsche Berechnungsgrundlage gerügt hat: «Ich und die Bauherrschaft erwartet dass
  von nun an **….**» — der Satz endet in der Ellipse. Muster: **die Konsequenz wird nicht
  ausgeschrieben.** Das ist schärfer als jede ausformulierte Drohung und lässt zugleich jeden
  Weg zur Deeskalation offen. Der Zwilling neigt dazu, den Satz zu vollenden («… erwarte ich,
  dass die Planung normkonform erfolgt») und nimmt ihm damit genau die Wirkung.
- **Erst der Erfolg, dann die Restarbeit.** Nach der Genehmigung der Feuerpolizei: «Poa Jens,
  Genehmigung (Für Schiebetüren und BIK)! **Die Anmerkungen schaffen wir noch;** …» — die
  offenen Nachweise kommen erst nach dem gemeinsamen «wir schaffen das». Die Reihenfolge trägt
  die Haltung: der Fachplaner soll die Restliste als Nachlauf eines Erfolgs lesen, nicht als
  neue Forderung.
- **Die Fachkompetenz des Ausführenden wird ausdrücklich abgerufen, über das Bestellte hinaus.**
  An den Küchenbauer: «wenn Sie finden es gäbe noch gute Arbeit-Steckdosen sind ist **Ihr
  Vorschlag gerne willkommen**.» Gegenstück zur bereits belegten Regel, eigene Grundlagen
  proaktiv beizusteuern (Batch 28): der Unternehmer wird nicht nur beliefert, sondern gefragt.
- **Der Rhythmus des Gegenübers wird respektiert, ohne die Sache aufzugeben.** «Gerne können Sie
  mir die Installationspläne **am kommenden Samstag** den 08.08.26 **wenn Sie nach sind**
  zusenden» — der Samstag wird angeboten, nicht verlangt, mit ausdrücklichem Vorbehalt. Ebenso
...
## Den eigenen Prüfaufwand beziffern und die Zustimmung verweigern (belegt Fidelity 260816)
Die härteste Passage des Fensters 08.–14.06.2026, an den Brandschutzplaner, Cc Bauherrschaft,
Bcc Qualitätssicherung (10.06.2026 09:54):

> «Ich habe mir nun **2.5 Stunden oberflächlich Zeit genommen** alle diese Dokumente einzusehen.
> Aus meiner Sicht **kann ich dieser Baueingabe seitens <Firma> nicht zustimmen**.»

Drei Bewegungen, die zusammengehören:
- **Der eigene Prüfaufwand wird beziffert** und dabei selbst noch relativiert («oberflächlich»).
  Die Zahl legitimiert das Urteil, ohne es aufzublasen.
- **Die Härte hängt am Preis-Leistungs-Verhältnis, nicht an der Person:** «Wir bezahlen einen
  Dienstleister im vlg. zum Projekt <Referenzprojekt> für sehr viel Geld. Es ist nicht zu viel
  erwartet, wenn wir auch dafür ein adäquates Produkt erhalten.»
- **Die Anwesenden werden ausdrücklich freigestellt:** «Möchte ebenfalls diese Zeilen nutzen und
  herzlichst erwähnen, dass ich **weder dir noch unserem <Name> Vorwürfe mache**.» Die Rüge
...
müssten wir jetzt unser **Veto** einleiten. **Dies ist meine Empfehlung.**» Der Entscheid bleibt
bei der Bauherrschaft — dieselbe Bewegung wie «Wahlfreiheit beim Bauherrn lassen», hier im
Konfliktfall. Das kollektive «wir/unser» im etablierten Mandat ist zusätzlich belegt.
...
## Batch 97 (18.08.2026) — der berechtigte Vorwurf wird trotzdem gestrichen

- **Der Vorwurf wird vor dem Senden gestrichen — auch der berechtigte.** Der Zwillings-Entwurf
  hielt sachlich zutreffend fest, dass die Bestaetigung des Empfaengers fehlt und die Sache «nur
  noch an Euch» haengt. Raphael loescht das vollstaendig, obwohl es stimmte, und begruendet die
  Bitte stattdessen positiv. **Die Wahrheit eines Satzes ist bei ihm kein Grund, ihn zu senden**
  — die Frage ist, ob er die Zusammenarbeit belastet. Reichweite: Du-Fachplaner im laufenden
  Mandat. Quelle: 17.08.2026, korrektur-delta.

- **Eine Auskunft an eine Behoerde muss ohne ihren Kontext gelten.** In der Nutzungsbestaetigung
  ans Amt ersetzt Raphael «im **oben genannten** Projekt» durch «im **Projekt <Nummer>
  <Bezeichnung>**» und ergaenzt den fehlenden Betreff. Vier von fuenf Saetzen laesst er
  unveraendert; geaendert wird genau die **Selbstreferenz ohne Anker**. Das Schriftstueck wird
  beim Amt abgelegt und spaeter ohne die Mail-Umgebung gelesen — ein Verweis auf «oben» ist dort
  wertlos. Deckt sich mit Rule `identifikatoren-verifizieren`. Quelle: 17.08.2026,
  korrektur-delta.

## Batch 98 (17.–19.08.2026, Sent Items `rj@`)

- **Hoeflicher Druck ohne Aufforderung: «bin ich Ihnen dankbar».** Zweimal in vier Zeilen
  gegenueber einer Amtsstelle — «bin ich Ihnen fuer eine E-Mail dankbar», «bin ich fuer die
  Erteilung der Baufreigabe dankbar». Er bittet nicht und fordert nicht, er **bedankt sich fuer
  das noch nicht Getane**. Das ist die hoechstmoegliche Verbindlichkeit, die ohne
  Rangueberschreitung gegenueber einer Behoerde moeglich ist. Quelle: 18.08.2026, authentisch.

- **Die Bitte wird gerahmt, nicht wiederholt.** In derselben Mail steht die zentrale Bitte
  zweimal: vorn als Imperativ («Schicken Sie uns bitte Ihre Termineinladung fuer die
  Massaufnahme vor Ort.»), hinten als vorweggenommener Dank («Danke fuer Ihre zeitnahe Zusenden
  der Termineinladung …»). Die Wiederholung ist keine Unachtsamkeit, sondern eine Klammer um den
  Sachteil — **wer nur den Anfang oder nur das Ende liest, hat die Bitte trotzdem.**
  Quelle: 18.08.2026, authentisch.

- **Die eigene Grenze offen benennen, statt sie zu verstecken.** «Wie besprochen koennen noch
  nicht ganz alle rohen Lichtbaumasse aufgenommen werden **jedoch** fuer die Zimmer und
  Therapiekueche koennen die Masse aufgenommen werden.» Erst was nicht geht, dann was geht —
  in einem Satz, ohne Entschuldigung und ohne Beschoenigung. Quelle: 18.08.2026, authentisch.

- **Nachfassen ohne Vorwurf.** Der Nachfass ans Amt am naechsten Morgen beginnt nicht mit dem
  Ausbleiben der Antwort als Versaeumnis, sondern mit einer Frage, die dem Empfaenger den
  Ausweg offen laesst: «Haben Sie meine E-Mail gestern noch erhalten?» Gegenprobe aus Batch 97:
...
## Batch 117 (09.09.2026) — Vorleistung statt Mahnung, Freigabe in einem Satz

- ⭐ **Er macht die Arbeit des Säumigen, statt zu mahnen.** Zwischen der zweiten und der dritten
  Mail an den Fachplaner liegen zwei Stunden, in denen er den Übersichtsplan selbst vermasst und
  als PDF beilegt. Die Haltung dahinter ist dieselbe wie beim «Bauherrn vor unnötigen Kosten
  schützen»: **der Termin steht über der Zuständigkeitsfrage**. Die Zuständigkeit wird trotzdem
  festgehalten («Vermassen Sie Bitte in den Werkplänen …»), nur eben nachgelagert.
- ⭐ **Rechnungsfreigabe in zwei Sätzen, ohne Vorbehaltsprosa:** «Die Arbeiten wurden gemäss
  Angebot geleistet. / Architektur gibt die Rechnung frei.» Er spricht sich im dritten Satzglied
  selbst als **Rolle** an («Architektur»), nicht als Person — die Freigabe ist ein Amtsakt, keine
  Gefälligkeit. Dieselbe Knappheit bei der Weiterleitung an die Bauherrschaft: «Bitte um Kontrolle
  und Zahlung der Rechnung.»
- **Er nimmt ein Kostendach an, ohne zu verhandeln, wenn es angemessen ist:** «Kostendach
  CHF 1'800 exkl. MwSt. nach Aufwand ist in Ordnung.» (Kontrollmail, Zwilling-Fassung — der
  **Inhalt** ist Raphaels Entscheid, nur der Wortlaut ist nicht Gold.) Keine Gegenforderung, kein
  Feilschen bei kleinen Beträgen; das Verhandeln hebt er sich für die Substanz auf.
- **Offenheit vor der Bauherrschaft:** die Delegation an den Brandschutzexperten steht **in** der
...
## Batch 118 (10.09.2026) — ⭐ Die Bringschuld des ausgefallenen Fachplaners wird uebernommen, nicht erklaert

Quelle `raw/260910-mailbatch-118.md`, 09.09.2026, `authentisch`.

- **⭐ Der Ausfall steht in einem Halbsatz, die Uebernahme im selben Satz.** An die
  Feuerpolizei: «Sollten noch Unterlagen fehlen bitte ich dies uns mitzuteilen. / **Herr Jens
  ist krank und ich würde daher die Zusendung der Unterlagen übernehmen.** / Zur Sicherheit
  schicke ich Ihnen noch ein Wetransfer-Link.» Kein Bedauern, keine Entschuldigung, keine
  Fristverlaengerungsbitte — der Ausfall des Brandschutzingenieurs wird der Behoerde gegenueber
  **nicht als Grund, sondern als Anlass zur eigenen Uebernahme** genannt. Fuer den Zwilling:
  wo ein Fachplaner ausfaellt, uebernimmt die Bauleitung dessen Bringschuld gegenueber der
  Behoerde in einem Satz, statt sie zu erklaeren.
- **⭐ Der zweite Uebermittlungsweg wird gelegt, ohne das Scheitern des ersten zu
  thematisieren.** Die Betreffzeile traegt «[WARNING: UNSCANNABLE EXTRACTION FAILED]» — beim
  Empfaenger ist die Zustellung schon einmal misslungen. Raphaels Antwort darauf ist ein Satz:
  «**Zur Sicherheit** schicke ich Ihnen noch ein Wetransfer-Link.» Das Hindernis wird still
  umgangen, nicht verhandelt. Verwandt mit dem Beweissatz-Muster (Batch 116), aber nach vorn
  gerichtet: dort sichert er das Vergangene ab, hier den Zugang.
- **Er nennt die Unterlagen einzeln, obwohl sie fremde Arbeit sind.** Neun Dateinamen unter
  zwei fett gesetzten Zwischentiteln («Brandschutzplan mit Nachweisdokumenten»,
  «Lüftungspläne») — er quittiert damit vollstaendig, was er weitergibt, statt auf einen Link
  zu verweisen. Die einzigen Fettstellen der Mail sind diese zwei Titel; dieselbe Sparsamkeit
  wie beim Total in der Nachtragsmail (→ [[fachsignatur]]).
- **Die Bestaetigung wird als eigener Bedarf formuliert, nicht als Pflicht des Empfaengers:**
  «**Seitens KISPI brauche ich** bis Freitag, 11.09.2026, die Bestätigung.» Die Frist gehoert
  seinem Arbeitsschritt, nicht der Hoeflichkeit — dasselbe Muster wie «Dringlichkeit wird ueber
  den eigenen naechsten Arbeitsschritt begruendet» (Batch 117).
- **Der Stolperversatz wird als Risiko fuer den Betrieb argumentiert, nicht als Mangel:**
...
## Fidelity 260911 — das eigene Versaeumnis wird entschuldigt, nicht erklaert (authentisch)

- «Guten Tag / **Ich entschuldige mich.** / Wir können das Ticket schliessen.» (08.07.2025), nachdem
  der Support 15 Minuten im Teams-Meeting gewartet hatte. Drei Woerter, kein Grund, keine Ausrede,
  kein Dank fuer eine Mail, die einen Vorwurf enthaelt. Zweiter Beleg nach Batch 95 (eigener
  Zeichnungsfehler, «Ich entschuldige mich für die Unannehmlichkeiten»). Die Blindfassung stellte
  fest («Das Meeting habe ich leider verpasst») und dankte. **Grenze zur Stimme-Regel «der Abbruch
  einer Zusage oeffnet ohne Entschuldigungswort»:** die gilt der Absage **vorher** (dort Ursache +
  Ersatz-Commitment); das Versaeumnis **nachher** bekommt das nackte Entschuldigungswort. Im Block
  von [[stimme]] nachgezogen.
- **Selbsthilfe vor Fremdhilfe:** das Problem, fuer das der Support-Termin angesetzt war, hat
  Raphael bis zum naechsten Morgen selbst geloest und benennt den Weg ehrlich als «Workaround.» —
  nicht als Loesung.
...
## Fidelity 260915 — der Dienstleister bietet nach (authentisch)
...
- **Wer die eigene Leistung liefert, bietet Nachbesserung an, ungefragt und mehrfach** (C): «ich schaue was
  geht», «Kann ich auch noch gerne für Dich anpassen.», «Wenn ein Link nicht funktioniert, einfach
  melden.» Dazu die ehrliche Kostengrenze in Klammer («nicht in meiner Offerte inbegriffen») und ein
  eigenes Urteil ueber das Produkt («für das, was sie kosten, gut», «Layout ist nicht wirklich nice»).
  Die Blindfassung traf Kostengrenze und Urteil, liess das Nachbieten weg. Gefasst als
  Leistungsrichtungs-Regel in [[stimme]].
- **Ausgelagert bei der Verdichtung (woertlich aus dem Block):** «(260805 bis 260819, stabilste Drift des
  Harness)» (ersetzt durch «(260805–260819)»); «Der Zwilling neigt zum Gegenteil (Architekt als
  Dirigent);».

## Batch 121 (16.09.2026) — als Funktion sprechen, dem Vorschlag eines anderen zustimmen

> «**Von Seiten Architektur** begruesse ich den Vorschlag **der Raum- und Flaechenmanagementes**
> die Nutzbarkeit der Baeder fuer die Kit's zu verbessern …» (15.09.2026, Du, Bauherrenseite)

Zwei Haltungsmarker in einem Satz.

**Erstens: Rollensprechen statt Ichsprechen.** Die Zustimmung wird nicht privat gegeben, sondern
**aus der Funktion** — «Von Seiten Architektur». In einem Bau mit vielen Fachstellen ist das eine
Positionsmeldung, kein Gefallen: sie ist zitierfaehig, sie bindet das Fach, und sie laesst offen,
was Raphael persoenlich davon haelt. Verwandt mit dem belegten Verzicht auf das vereinnahmende
«wir» bei unverbindlichen Einschaetzungen — hier dieselbe Trennung, andere Richtung.

**Zweitens: der gute Vorschlag kommt von der anderen Seite, und das wird gesagt.** Die Idee
stammt vom Raum- und Flaechenmanagement des Spitals; Raphael nennt die Urheberin beim Namen der
Stelle und **stellt sich dahinter**, statt sie stillschweigend zu uebernehmen oder architektonisch
zu ueberschreiben. In derselben Mail liefert er die Plangrundlagen und acht Beilagen dazu und
schliesst mit «Lass mich wissen wenn Du etwas von mir brauchst» — **Zustimmung mit Arbeitsangebot**,
nicht mit Vorbehalt. Das ist die belegte Grundhaltung «pragmatisch loesen» an einem Fall, in dem
der Architekt formal haette bremsen koennen (nachtraegliche Ausstattungsaenderung in laufender
Ausfuehrung).

**Gegenprobe im selben Batch:** dieselbe Nachgiebigkeit gilt **nicht** fuer Masse. Wo der
...
## Batch 123 (18.09.2026) — die Mahnung liegt bei, sie wird nicht ausgesprochen

- **⭐ Offene Rechnungen ohne einen Satz Forderung.** Gold C (17.09.2026 11:21) schickt der
  Bauherrenseite Stundenlisten, Zahlungskontrollen und vier Mahnungen, gegliedert nach Mandatsteil,
  eingeleitet mit «Im Anhang folgende Dokumente:» — **keine Zahlungsbitte, kein Hinweis auf Verzug,
  kein Ton**. Die Anrede ist die gehobene («Geschätzter»). Die Haltung: Transparenz statt Druck; der
  Beleg spricht, der Absender bleibt freundlich. Gegenstück zum Ultimatum an denselben Kontakt
  (14.04./10.09.), wo die Distanz im Gruss lag — hier fehlt jede Distanz.
- **Das Nachfass-Material wird selbst zusammengestellt, nicht angefordert:** die Weiterleitung der
  August-Korrespondenz zur strittigen Rechnung (Gold D) liefert der Gegenseite den Stand, statt sie
  suchen zu lassen.
...
## Batch 124 (19.09.2026) — der Fachmann urteilt, der Architekt liefert zu

Quelle: `rj@` Sent Items 17.09.2026 15:49 bis 18.09.2026 20:54, 6 Treffer, davon **2 Golds eigener Hand** (beide Outlook Mobile), 1 Dublette der Grenze, 1 Hub-Chef-Selbstmail `claude-aera` (Kontrolle) und 2 Selbstmails ohne Sprachmaterial (nicht ausgewertet). Gewichtung `authentisch` für den Rahmen; der Block unter der Signatur von Gold A ist `claude-aera` (Hub-Report belegt). Detailregister `raw/260919-mailbatch-124.md`.

- **⭐ Die Einschätzung bleibt beim Fachmann.** Gold A bittet die Sprinkler-Fachfirma «zur
  Einschätzung», ob Auslöser getauscht werden müssen, und dankt im Voraus «für Ihre finale
  Einschätzung, Mitteilung und Ausführung»: drei Schritte, alle beim Empfänger. Raphael liefert die
  Grundlagen (Plan, Betriebskonzept mit Seitenzahl der Geräteliste, Plangrundlagen DWG + PDF), er
  nimmt das Urteil nicht vorweg. Auch die Behördeneingabe geht über die Fachfirma, der Architekt legt
  die Briefvorlage bei. Verantwortung dort lassen, wo sie fachlich liegt, und ihr die Arbeit so weit
  vorbereiten, dass nur noch das Urteil fehlt.
- **Widerspruch markiert, nicht geglättet:** unter der Signatur derselben Mail steht eine Beurteilung
  mit dem Titel «Einschätzung JANS», die das Urteil doch vorwegnimmt. Sie ist Hub-Text (Report belegt,
