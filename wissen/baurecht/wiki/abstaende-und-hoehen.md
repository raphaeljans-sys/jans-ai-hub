...
## Grenzabstand
Minimaler Abstand eines Gebäudes zur Parzellengrenze (§§ 269-270 PBG). Die «Grenzlinie»
ist die Grundstücksgrenze (§ 269 PBG).
- **Grosser Grenzabstand:** zur Hauptwohnseite (Fassade mit Wohnräumen).
- **Kleiner Grenzabstand:** zur Nebenseite.
> *Detailwerte/Mehrlängenzuschlag noch offen — Buch Kap. 15 Teil 2 (Shots ab 513) im
> nächsten Lauf distillieren; konkrete Zonenwerte siehe [[zonenkonformitaet]] + BZO.*
...
Dürfen in den Grenzabstand ragen: Vordächer/Vortreppen (max. 1.5 m Ausladung),
Erker, Balkone (unter Bedingungen). Rechtsgrundlage: § 260 Abs. 3 PBG, § 14 ABV.
