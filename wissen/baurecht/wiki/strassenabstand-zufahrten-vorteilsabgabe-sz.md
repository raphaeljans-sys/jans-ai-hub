...
# Strassenabstand, Zufahrten und Vorteilsabgabe an Kantonsstrassen (Kanton Schwyz)

**Kernregel:** Im Kanton Schwyz regelt nicht das PBG, sondern das eigenständige
**Strassengesetz (StraG, SRSZ 442.110)** und die **Strassenverordnung (StraV, SRSZ
442.111)** den Abstand zu **Kantonsstrassen**, die Bewilligungspflicht für Zufahrten/
Zugänge sowie die **Vorteilsabgabe** — ein im ZH-PBG-System so nicht vorkommendes
Institut. Quelle: Merkblatt Tiefbauamt SZ zu Formular Z15 (26.05.2009/rev. 21.03.2014),
mit wörtlich zitiertem Gesetzesauszug im Anhang → vollständig in
[[strassenabstand-zufahrten-vorteilsabgabe-sz]]-Rohtext
`raw/260823_amtlich_sz_merkblatt-z15-strassenabstand-zufahrten.md`.

**Herkunftshinweis:** Das Merkblatt lag fehlabgelegt im ZH-Projektordner 2414 Thalwil
(Bohlweg 3, Reglemente-Archiv, Ordner "05 VSS NORM") — es gilt **nicht** für Thalwil
(Kt. ZH), sondern für Bauvorhaben im Bereich von Kantonsstrassen im **Kanton Schwyz**.
Aufgenommen, weil die KB explizit ZH **und** SZ abdeckt (`CLAUDE.md` Zeile 1) und aktuell
kein Artikel zum SZ-Strassenrecht bestand.

## 1. Zufahrten und Zugänge (§§ 47 StraG / 25 StraV)

- **Bewilligungspflicht** für neue Zufahrten/Zugänge zu Strassen, ebenso beim Aus-/
  Umbau bestehender Zufahrten oder bei wesentlich grösserem/andersartigem
  Verkehrsaufkommen (§ 47 StraG, § 25 StraV).
- **Verkehrsstarke Anlagen** (Faustregel des Merkblatts: > 50 Parkplätze **oder**
  > 600 Fahrzeuge/Tag) brauchen ein Verkehrsgutachten eines qualifizierten
  Verkehrsplaners mit dem Baugesuch.
- Grundsatz **rückwärtige Erschliessung** über das untergeordnete Strassennetz;
  besteht bereits eine Einfahrt in die Kantonsstrasse, ist diese zu nutzen.
- **Sichtweiten (VSS SN 640 273a, seit 1.8.2010 Nachfolgenorm von SN 640 273):**
  Beobachtungsdistanz innerorts 3.00 m ab Fahrbahnrand (kommunale/private Strassen,
  Gewerbe/Einkauf/öff. Parkplätze) bzw. ≥ 2.50 m (Hauszufahrten), ausserorts 5.00 m.
...
- **Ausgestaltung:** Erschliessungsbreite im Einmündungsbereich 5.00 m (≤ 15
  ...
  Vertikalausrundung. Wendemanöver zwingend auf privatem Grund (Einfahrt in die
  Kantonsstrasse stets vorwärts).
...
- **Ausnahme (§ 42 StraG):** nur bei besonderen Verhältnissen (Vermeidung
  ...
  ausdrücklich NICHT.** Die Ausnahme ist Teil der Baubewilligung.
- Unterschreitung ist **stets vorteilsabgabepflichtig**.
...
- **Keine Abgabe**, wenn die Erschliessung über eine Feinerschliessungsstrasse
  erfolgt, die auch anderen Grundeigentümern dient (**VGE 717/03 vom 14.11.2003,
  E. 3**) — dann besteht stattdessen eine Beteiligungspflicht an deren Erstellungs-/
  Unterhaltskosten, kein abgeltungspflichtiger Sondervorteil.
- **Rechenbeispiele aus dem Merkblatt:** (a) Zufahrt MFH, Nutzfläche 323.5 m²
  (Gebäude 154.5 + Tiefgarage 56.5 + Parkplätze 112.5) × CHF 500.-/m² × 4.5 % =
  **CHF 7'278.75**. (b) Unterschreitung Strassenabstand, Verkehrswertschätzung
  CHF 240'000.- (betroffene Flächen über alle Geschosse + Vorbauten) × 5 % =
  **CHF 12'000.-**.

## 4. Grundstück grenzt an Kantonsstrasse (§ 38 StraG)

- Seitliche Hindernisfreiheit entlang des Verkehrsraums; Vorplätze mit Rabatten
  (min. 0.80 m), Mauern oder Zäunen abzugrenzen, ohne die Sichtweiten
  einzuschränken.
- Längsparkplätze ohne Abtrennung von der Fahrbahn: nur mit Zustimmung Tiefbauamt,
  Ausnahmefall. **Parkplätze mit Rückwärtseinfahren in die Kantonsstrasse werden
  grundsätzlich nicht bewilligt.**
- Bauphase: Prüfpflicht mittels **Einflusslinie 1:1** ab Bezugspunkt (Baugrube/
  Aufschüttung entlang der Kantonsstrasse) — bei Betroffenheit sind statische
  Betrachtungen bereits mit dem Baugesuch einzureichen.
- **Erdanker unter der Kantonsstrasse** brauchen eine vertragliche Regelung mit
  Regierungsratsbeschluss (gesondertes Verfahren, frühzeitig anzustossen).

## Bezug zum JANS-Alltag

- **Nicht mit ZH verwechseln:** Kanton ZH kennt keine Vorteilsabgabe für Zufahrten/
  Strassenabstand in dieser Form — das PBG-System arbeitet stattdessen über
  Baulinien (§§ 96 ff. PBG, → [[baulinien-und-abstandslinien]]) und den subsidiären
  6-m-Strassenabstand (§ 51 Abs. 2 PBG) ohne eigene Abgabe. Bei SZ-Projekten (z.B.
  Wangen SZ) ist die Vorteilsabgabe eine **zusätzliche, in ZH nicht vorhandene
  Kostenposition** früh in die Kostenschätzung einzustellen.
