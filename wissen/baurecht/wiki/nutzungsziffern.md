...
sources: [260602_docs-baurecht-begriffe.md, 260602_docs-baurecht-pbg-zh.md, "§ 251 PBG", "§ 253a PBG", "§ 254 PBG (Anhang)", "§ 255 PBG", "§ 256 PBG", "§ 257 PBG", "§ 258 PBG", "§ 259 PBG", "§ 276 PBG", "§ 52 PBG", "§ 9 ABV", "§ 10 ABV", "§ 11 ABV", "§ 12 ABV", "§ 13 ABV", "§ 17 ABV (aufgehoben)", "§ 2c ABV (Unterniveaubauten)", "§ 6 ABV (Fassadenflucht)", "Buch Bd 2 Kap. 14 S. 919-992", 260607_amtlich_zh_pbg.md, 260607_amtlich_zh_abv.md, "PBG-Volltext amtlich Nachtrag 134 (frisch bezogen 2026-08-23, notes.zh.ch/appl/zhlex_r.nsf/WebView/BDFE23FD4AE7E6E6C1258E3D001CBB62/$File/700.1_7.9.75_134.pdf)", "Leitfaden 'Harmonisierung der Baubegriffe', Baudirektion Kt. ZH, 1.3.2017, IVHB Ziff. 8.4/8.5", 260824_amtlich_zh_ivhb-leitfaden-baudirektion.md]
...
verifiziert:
  - datum: 2026-07-25
    ...
    ergebnis: "Fassungsstand-Umkehr KORRIGIERT (harmonisierte Fassung = geltender Hauptteil seit 2015/2017, nicht 'nPBG'-Vorlage; Anhang = altes Recht, nur bis BZO-Anpassung der Gemeinde); 3 Einzelkorrekturen: § 9 ABV 'UG mehrheitlich über gewachsenem Boden' ist nur Anhang-Recht, im Hauptteil gestrichen; § 10 lit. c ABV Energiespar-Nebenräume aktuell 20% (nicht 10%); § 17 Abs. 2 ABV existiert nicht (seit 1.2.1992 aufgehoben) - Nutzweisen-Übertragung beruht auf kommunalem Recht"
  - datum: 2026-08-23
    methode: "Modell-D-Volltextabgleich (adversarial), Buch-Run 94, Fortsetzung der Re-Verifikations-Kette (Vorschlag Run 93 — ältestes verifiziert-Datum unter den established-Artikeln); Reglemente-Queue 2414 Thalwil ist seit Run 87 T1-T9 vollständig abgearbeitet, daher nächster Schritt aus der Kette gewählt"
    umfang: "§§ 251/253a/254-260/276/52 PBG (Hauptteil UND Anhang) frisch von notes.zh.ch bezogen (amtliches PDF, aktueller Nachtrag 134) und mit pdftotext -layout extrahiert, Wort für Wort gegen raw/260607_amtlich_zh_pbg.md sowie gegen den Artikel-Wortlaut gegengelesen; ABV-Fassungsstand über die PDF-Fusszeile von raw/260607_amtlich_zh_abv.md verifiziert (kein neuer Bezug nötig)"
    ergebnis: "CONFIRMED wortgleich, 0 Korrekturen an den bisherigen Zitaten. Genuiner Fund (kein Fehler im Artikel, aber Fassungsstand-relevant): das PBG trägt amtlich bereits Nachtrag 134 (zhlex.zh.ch, Publikation 01.08.2026) - bisher durchgängig als 'Nachtrag 133, keine Drift' geführt (zuletzt Buch-Run 93). Nachtrag 134 ist jedoch erst per 01.10.2026 IN KRAFT (Fusszeile des amtlichen PDF '1.10.26 - 134' gegenüber '1.7.26 - 133' im bestehenden Raw) - für die Rechtslage heute (23.08.2026) bleibt Nachtrag 133 massgebend, und Nachtrag 134 ändert an den hier geprüften Bestimmungen inhaltlich nichts (wortgleich). ABV bleibt unverändert bei Nachtrag 127 (zhlex.zh.ch bestätigt, keine Drift). Offen bleibt unverändert die needs-verification-Frage zur Unterniveaubauten-Neuregelung bei der UeZ (Buch S. 990 f., am Gesetzeswortlaut § 256 PBG nicht wörtlich bestätigbar, siehe Buch-Destillat buecher/band-2/14-nutzungsdichte-ausnuetzung.md Z. 492 f.)."
  - datum: 2026-08-24
    methode: "Modell-D-Recherche (Buch-Run 130, Fortsetzung der Run-55-Flagge): needs-verification-Frage 'Unterniveaubauten neu bei der ÜZ angerechnet?' liess sich am reinen Gesetzeswortlaut von § 256 PBG nicht abschliessend klären, da der Hauptteil-Wortlaut selbst schweigt (anders als die Anhang-Fassung, die explizit 'oberirdisch' verlangt). Amtliche Vollzugshilfe der Baudirektion Kanton Zürich beigezogen: raw/260824_amtlich_zh_ivhb-leitfaden-baudirektion.md (Leitfaden 'Harmonisierung der Baubegriffe', 1.3.2017, per WebFetch bezogen und mit PyMuPDF extrahiert)."
    umfang: "IVHB Ziff. 8.4 (§ 256 PBG, Überbauungsziffer), Ziff. 8.5 (§ 257 PBG, Grünflächenziffer) als Cross-Beleg, Ziff. 3.1 (§ 6 ABV, Fassadenflucht) zur Einordnung, warum der Gesetzeswortlaut selbst offen bleibt"
    ergebnis: "BESTÄTIGT (needs-verification geschlossen): der Leitfaden sagt zu § 256 PBG wörtlich 'Im Gegensatz zur bisherigen Regelung sind neu auch Unterniveaubauten anzurechnen' und 'Auch Kleinbauten, Anbauten und Unterniveaubauten zählen zur anrechenbaren Gebäudefläche' (S. 42) - unabhängig bestätigt in Ziff. 8.5 zur Grünflächenziffer (S. 44: 'eine Unterniveaubaute [zählt] zur anrechenbaren Gebäudefläche bei der Überbauungsziffer'). Grund, warum der reine PBG-Wortlaut offen blieb: der Begriff 'Fassadenflucht' (§ 6 ABV) ist auf Unterniveaubauten laut Leitfaden 'nicht direkt anwendbar' - für sie gilt 'sinngemäss die projizierte Fassadenlinie des unter dem massgebenden ... Terrains liegenden Baukörpers'; diese Analogie steht nicht im Gesetzestext selbst, sondern nur im erläuternden Leitfaden. Die Buch-Aussage (S. 990 f.) ist damit KEIN Buchkommentar-Fehler, sondern zutreffend."
---

# Nutzungsziffern (Mass der Nutzung)

Die Nutzungsziffern legen fest, wie intensiv ein Grundstück überbaut werden darf.
...
- **Anrechenbar** ist jeder Raum in einem **Vollgeschoss**, der dem Wohnen/Arbeiten oder
  ...
  Erschliessung** (Gänge, Treppen mit ganzem Treppenhaus, Lift-Schacht) — soweit sie zu
...
(§ 49a Abs. 3 PBG) und **Arealüberbauung** (qualitätsabhängiger Bonus, kumulierbar
wenn BZO dies vorsieht). Buch Bd 2 S. 934-937.

## Ausnützungsübertragung
Verschiebung nicht genutzter Ausnützungsreserve auf das Nachbargrundstück — nur in
**gleicher Zone**, gegen **Ausnützungsrevers im Grundbuch**. Eigener Artikel:
[[ausnuetzungsuebertragung]].

> Hinweis: Werte sind kantonal/kommunal festgelegt — immer die aktuelle BZO der
> Gemeinde prüfen (vgl. [[zonenkonformitaet]]). Diese Zusammenstellung ersetzt
> nicht den Gesetzestext (zh.lex.ch).
