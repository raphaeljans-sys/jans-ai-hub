...
title: Laermschutz und Schutz vor nicht ionisierender Strahlung (baulicher Umweltschutz ZH)
status: established
...
Baubewilligungsverfahren. Fuer JANS zwei Dauerthemen: der **Laermschutz** (steuert, ob und wie an
verkehrs-/fluglaermbelasteten Lagen ueberhaupt Wohnbau moeglich ist) und die **nicht ionisierende
Strahlung** (Mobilfunkantennen auf/neben Objekten, Standorte in Bauzonen). Beide arbeiten mit dem
Konzept **Emission an der Quelle begrenzen (Vorsorge) + Immissionen an schutzwuerdigen Orten
einhalten**.

## Laermschutz (Art. 11-25 USG / LSV)
...
> Fuer das **Recht** (ES-Zuordnung Art. 43/44 LSV, Belastungsgrenzwerte Anhang 3/4/6) ist dieser Artikel
> fuehrend. Die **parzellenscharfe ES-Zuordnung** liefert die Schwester-KB login-frei als Vektor:
> `wissen/planungsgrundlagen/wiki/kartenportale-zonenplan-zh` (GIS-Layer 0154 `..._np_ls_festlegung_f`,
> Connector `geo-zh.mjs`). Die dortige Seite verweist hierher zurueck.
