...
konfrontiert ist — bewegt sich im **kantonalzuercherischen Rechtsmittelweg** (VRG/PBG) mit Aufstieg ans
...
Bundesrecht (BGG/ZPO/EMRK) nur sinngemaess.

## 1. Kern in vier Saetzen
- **Dreistufiger Instanzenzug** (Art. 29a BV): Verfuegung → **Baurekursgericht** (Rekurs, volle Kognition
...
- **Aufschiebende Wirkung** hemmt den Bau grds. (§ 25 Abs. 1 VRG), aber **§ 339 PBG** beschraenkt die
  Hemmung darauf, *soweit* der Verfahrensausgang die Bauausfuehrung beeinflussen kann → **Teilfreigabe**
  moeglich.
- Neben den ordentlichen Rechtsmitteln: **formlose Rechtsbehelfe** (Wiedererwaegung, Aufsichtsbeschwerde),
  **ausserordentliche** (Revision § 86a VRG; Erlaeuterung) und als echte Alternative die **Mediation**.
...
- **Baurekursgericht** — erste, umfassende Rekursinstanz (seit 1.7.2014; § 329 ff. PBG; § 19 Abs. 1 lit. a
  VRG); **volle Kognition** inkl. Unangemessenheit (§ 20 VRG), Zurueckhaltung nur bei Gemeindeautonomie.
...
## 5. Kosten & Entschaedigung (Teil 2)
- **Gerichtsgebuehr** Baurekursgericht i.d.R. **500-50'000 Fr.** (Ø ~5'000; § 338 PBG), Streitinteresse =
  Bausumme (BEZ 2014 Nr. 36); BGer korrigiert Ueberhoehungen.
- **Unterliegerprinzip** (§ 13 Abs. 2 VRG); bei Gutheissung Nachbarrekurs Kosten **je zur Haelfte** Bauherr/
  Behoerde (RB 2005 Nr. 12).
- **Parteientschaedigung** (§ 17 Abs. 2 VRG) nur angemessen, erfahrungsgemaess **~1'500-2'500 Fr.** (BEZ 2007
...
- Unentgeltliche Rechtspflege (§ 16 VRG) juristischen Personen versagt; nicht fuer Baubewilligungswerber
  (BGer 1C_378/2012).

## 6. Ausserordentliche Rechtsbehelfe & Mediation (Teil 2)
- **Wiedererwaegungsgesuch** (§ 9.8.1): formloser Rechtsbehelf an die erste Instanz; **unterbricht die
  Rekursfrist NICHT** → immer parallel fristwahrend rekurrieren.
- **Aufsichtsbeschwerde** (§ 9.8.2): jedermann, an die Baudirektion (§ 2 lit. b PBG), subsidiaer, beschraenkte
  Kognition.
- **Revision** (§ 86a VRG): gegen rechtskraeftige Entscheide bei neuen Tatsachen/Beweismitteln oder
  Strafverfahren; **90 Tage / 10 Jahre**. **Erlaeuterung/Berichtigung** nur bei unklarem Dispositiv (BEZ 1999
  Nr. 7).
- **Mediation** (§ 9.9.6): aussergerichtliche, zukunftsgerichtete Konfliktloesung; geeignet bei Dauer-
...
- Bei unbefriedigendem Entscheid **immer parallel fristwahrend rekurrieren**, auch wenn man mit der Behoerde
  verhandelt — Wiedererwaegung/Gespraech hemmt die 30-Tage-Frist nicht.
- Bei Nachbarrekurs gegen einen abtrennbaren Teil → **Teilfreigabe** nach § 339 PBG beantragen, Rohbau laeuft
  weiter.
- Kostenrisiko ehrlich rechnen: eigener Aufwand bleibt grossteils an einem haengen, gegen die Gemeinde gibt es
  fast nie eine Parteientschaedigung → frueh die Verhandlungs-/**Mediationsloesung** suchen (Musterfall:
  gemeinsame Tiefgarage statt zweier Rekurse).
- Ist-Zustand vor Baubeginn **beweissicher dokumentieren** (Fotos/Plaene) — der spaeter entscheidende Beweis
  im Immissions-/Bausicherheitsstreit.

Siehe auch: [[baubewilligungsverfahren]] (Zustellbegehren/Verfahren davor),
[[baurechtlicher-vorentscheid-und-voranfrage]] (rechtsmittelfaehiger Vorentscheid),
