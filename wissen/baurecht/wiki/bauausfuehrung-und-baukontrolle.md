...
**Kurz:** Die rechtskraeftige Baubewilligung erlaubt den Baustart **noch nicht**. Es braucht die
**Baufreigabe** (§ 326 PBG); waehrend der Ausfuehrung kontrolliert die oertliche Baubehoerde
baupolizeilich (§ 327 PBG); am Ende steht die **Bezugsbewilligung/Schlusskontrolle**; ein laengerer
**Unterbruch** kann zur erzwungenen Beendigung fuehren (§ 328 PBG). Faktenbasis: Buch-Destillat
...
- **Rechtzeitig anzuzeigen:** Baubeginn, wesentliche Zwischenstaende (**Schnurgeruest, Kanalisations-
  grundleitungen, Rohbauvollendung, Bezugsbereitschaft**) und Bauvollendung (§ 327 Abs. 1 PBG, § 23 BVV).
- **Gebaeudeabbruch:** bewilligungspflichtig **nur in Kernzonen** (§ 309 Abs. 1 lit. c PBG), sonst nur
  **meldepflichtig**; im Lichte § 239 PBG (Sicherheit, Entsorgung Abbruchmaterial).
- **Asbest (Art. 3a ABV, seit 1.6.2018):** Abbruch ist der oertlichen Baubehoerde **auch ohne
  Baubewilligung** rechtzeitig vor Beginn zu melden; ordnungsgemaesse Entsorgung nachzuweisen
  (Art. 16 VVEA). → **Praxisfalle bei Umbau/Abbruch im Bestand.**

## 3. Baupolizeiliche Kontrollen (§ 327 Abs. 2 PBG)

- **Rechtsnatur: Realakt, keine Verfuegung** — nicht direkt anfechtbar. Erst ein **Abbruch-/
  Wiederherstellungsbefehl** ist eine anfechtbare Verfuegung (Rekurs Baurekursgericht, § 329 Abs. 1 PBG).
- Zustaendig ist die **oertliche Baubehoerde** (§ 318 PBG), die in **geeigneten Abstaenden** prueft, ob
  die Arbeiten Vorschriften und Plaenen entsprechen; Delegation an Hilfspersonen/Private moeglich.
- **Anlass:** Meldung der Bauherrschaft / von Amtes wegen / Veranlassung durch Dritte.
- **Durchfuehrung:** Voranmeldung, Betretungsbefugnis, Fachbegleitung; **Drohneneinsatz** zulaessig, aber
  Personendaten-Luftaufnahmen ggf. zu loeschen (KGer LU 18.4.2018 Horw; Datenschutz). **Mitwirkungs-/
  Duldungspflicht** des Betroffenen, notfalls unmittelbarer Zwang.
- **Rechtsschutz:** Wer durch eine Baukontrolle (Realakt) in schutzwuerdigen Interessen betroffen ist,
  kann eine **anfechtbare Verfuegung verlangen** (§ 10c VRG; Art. 29a BV).
...
- **Bezugsbewilligung** (§ 327 Abs. 1 PBG, § 23 BVV): erteilt, wenn die Baute den Geboten der **Wohn-/
  Arbeitshygiene** entspricht (§ 12a BBV II). Geprueft: **genuegende Austrocknung** (SIA-Norm 180),
  **Benutzbarkeit Sanitaereinrichtungen** (§ 12a BBV I), **energetische Anforderungen** (§ 239 Abs. 3 PBG;
  Formulare awel.zh.ch), **Sicherheit** Gelaender/Bruestungen (SIA-Norm 358; § 239 Abs. 1 PBG).
  → Wohnhygiene-Mindestmasse: [[wohnhygiene-und-raumanforderungen]].
- **Schlusskontrolle:** Uebereinstimmung Ausfuehrung ↔ bewilligte Plaene. **Vertrauensschutz begrenzt:**
  Auch nach der Abnahme darf die Behoerde materielle Maengel beanstanden; Treu und Glauben weicht
  ueberwiegenden oeffentlichen Interessen (BGer 1C_333/2017).

## 5. Unterbruch der Bauarbeiten / «ewige Baustelle» (§ 328 PBG)

- **Zweck:** Schutz von Nachbarschaft und Oeffentlichkeit vor Anblick und Gefahren einer **Bauruine**
  (Sicherheit § 239 PBG, Einordnung § 238 PBG → [[raumplanung-und-gestaltung]]).
- **Unterbruch** liegt vor bei laengerem Stillstand — oder wenn so zaegig gebaut wird, dass die Bauzeit
