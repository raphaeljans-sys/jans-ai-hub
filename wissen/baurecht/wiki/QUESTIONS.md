...
durch Pflanzen aufnehmen zu lassen; Abs. 3: der natürliche lokale Wasserhaushalt ist zu erhalten
...
`raw/260803_amtlich_zh_wsv.md` traf sofort auf Z. 1104 («… in getrennten Grundstücksentwässe-
...
- **§ 232 PBG** (amtlicher Wortlaut, `raw/260607_amtlich_zh_pbg.md` Z. 2320, Nachtrag 133) regelt
  ausschliesslich die Duldungspflicht für geringfügige öffentliche Einrichtungen auf privatem
...
zitiert die Destillate als Top-Quelle Stufe 0b. Bisher wurden **vier** tote Rechtsstände
...
Längsneigung, Gefällewechsel und Ausrundungsradien sind dort mit Fundstelle belegt
(Ziff. 20.5-20.6, Tab. 13, S. 29). Muster «Ein Zugang heilt keinen Bestand»: der Artikel wurde
danach dreimal angefasst (25.07., 27.07., 30.07.), die Aussage blieb jedes Mal stehen.

**Erledigt (Wissens-Chef Run 21).** Im Wiki-Artikel ist die Kostenpflicht-/needs-verification-Stelle
durch den **Verweis auf die führende Fundstelle** ersetzt — bewusst **ohne Wertkopie** in `baurecht`
(Norm-Kennwerte und Fassungsstände führt `normen`, Führungsmatrix `koordination/QUERBEZUEGE.md`).
Die Statusaussagen in den datierten Log-Abschnitten unten (Runs 29/33/41/43/44/46) sind entsprechend
nachgeführt, ihr ursprünglicher Wortlaut bleibt durchgestrichen sichtbar.

**Was NICHT erledigt ist und weiterhin offen bleibt:**
- **Maximale LÄNGSneigung von Parkfeldern** — im Destillat nicht enthalten; die Norm regelt in
  Ziff. 18 nur das **Quergefälle** von Parkfeldern (6 %, rollstuhlgerecht 2 %). Bei Bedarf am
  Original nachlesen.
- **SIA 500 / SN 521 500, Korrigendum C3 (1.10.2013), Ziff. 9.7.2/9.7.3** — der Norm-Wortlaut des
  Korrigendums bleibt unverifiziert; das normen-Destillat `sia-500-2009` deckt nur die
  Basisausgabe ab. Eigener Sachverhalt, durch diesen Lauf **nicht** geklärt.

**Steuerungsfolge.** Der Rücktaktungs-Vorschlag für den Loop `baurecht-buch-training` (Buch-Run 46,
Abschnitt 2026-07-15) stützte sich unter anderem auf die «VSS-Rampen-/Parkierungsnormen
(kostenpflichtig, dauerhaft nicht frei beschaffbar)». Diese Begründung ist weggefallen; dort ist ein
...
**jedoch nicht**, wenn **umfangreiche**, baubewilligungspflichtige Sanierungsarbeiten am Objekt
ausgeführt werden»?

Zu beachten bei der Bearbeitung:
- Das Merkmal **«umfangreiche»** ist tragend — ohne es wird aus einer Faustregel eine
  überschiessende Rechtsaussage, die jede bewilligungspflichtige Sanierung erfasst.
- Die 15-%-Schwelle ist **kommunal** (Zuständigkeit: Amt für Baubewilligungen Stadt Zürich,
  Baukontrolle), also **keine kantonale** Geltungsaussage. Ausserhalb der Stadt Zürich nicht ohne
  weiteres übertragbar.
- Die Richtlinie stützt sich auf § 239 Abs. 1, **§ 357 Abs. 4**, § 358 PBG ZH und § 20 BBV I —
  Anknüpfungspunkt ist damit die Verbesserungs-/Zumutbarkeitsklausel von **Abs. 4**, nicht die
  «keine feste Quote»-Aussage zu **Abs. 1**. Das sind verschiedene Absätze derselben Norm, kein
  Widerspruch.
- Die bfu-Broschüre ist eine Fachpublikation (Beratung/Empfehlung), keine Norm; technische Normen
  sind für sich allein nicht rechtsverbindlich.

Quellen: `wissen/normen/destillate/bfu-gelaender-und-bruestungen.md` Z. 92-97;
`wissen/planungsgrundlagen/wiki/recht-norm-arbeitshilfen-planungsdetails.md` §3 (Z. 100-102,
128-141); im eigenen Bestand bereits vorhanden: `buecher/band-2/17-gebaeude-und-raeume-teil2-ausruestungen.md`
(§ 20 BBV I; BEZ 2019 Nr. 5 «Nachrüstung Altbau Absturzsicherung», S. 1291).

**Frage 2 — Ausgabestand SIA 358 (Fassungsdivergenz zwischen den KBs).** `baurecht` führt die
...
- Kinderschutz/Durchfallschutz: `baurecht` Öffnungsweite **≤ 90 mm** bis 75 cm Höhe gegen das
  bfu-Destillat **Kugelprobe 12 cm Durchmesser** bis 75 cm Höhe.

Zu klären ist, welche Ausgabe für die JANS-Praxis massgebend ist und ob die im Buch-Destillat
geführten Werte als Stand-1996-Angabe zu kennzeichnen sind. **In diesem Lauf bewusst keine Zahl
...
- **Flächendeckende ae/oe/ue-statt-Umlaut-Verstösse** (Audit F) quer durch praktisch alle
...
- **Teilschritt (1) verifiziert (~08:30-Lauf, Mac Mini):** Die im health-check vermutete
  ...
  (das bedient nur den Handy/Cowork-Dispatch-Kanal und die crontab-Zusatzläufe
...
- **Root-Cause-Hypothese CONFIRMED (~19:00-Lauf, Mac Mini, dedizierte Verifikation):**
  ...
  **Fix vorgeschlagen, NICHT autonom ausgeführt** (Config-Änderung an lokalen
  ...
  verboten): allen fünf "Modell-Politik"-Blöcken (beide Stationen) einen Satz ergänzen,
...
- **§ 15m HWSchV stand auf dem Kopf.** [[15-lage-von-gebaeuden]] und [[abstaende-und-hoehen]]
  ...
  ist **begünstigend, nicht einschränkend** (heute § 20 WsG). **Interne Divergenz aufgelöst:**
...
- **LSV Art. 40 Abs. 2 — Additionsprinzip ohne seine Ausnahme.** Das Destillat gab den Grundsatz
  ...
  Freizeitlärm, Glockengeläut). **Anhang 3/4 beschafft:** Grenzwerttabellen wertidentisch
  (ES II Tag PW 55 / IGW 60 / AW 70), Systematik PW < IGW < AW CONFIRMED. Neu erfasst: Bahnlärm auf
  Strassen → Anhang 3; Standseilbahnen/Eisenbahnwerkstätten → Industrie-/Gewerbelärm (Anhang 6);
...
- **Komplex 2 — akzessorische Normenkontrolle: «§ 50a VRG» existiert nicht (KORRIGIERT).** Amtlicher VRG-Volltext beschafft (`raw/260715_amtlich_zh_vrg_beschwerde.md`, zhlex-PDF Stand 1.7.26-133): Sequenz **§ 49 → § 50 → § 51 [aufgehoben] → § 52** — **kein § 50a**. Richtig verortet: **prinzipale/abstrakte Normenkontrolle** via Rekurs **§ 19 Abs. 1 lit. d VRG** (Erlasse ausser KV/Gesetze), Rügegrund **§ 20 Abs. 2 VRG** (Verletzung übergeordneten Rechts), Legitimation **§ 21b VRG**, Weiterzug § 41/§ 50 VRG; für PBG-Erlasse § 338a Satz 2 PBG. **Akzessorische (vorfrageweise) Normenkontrolle = ungeschriebener allgemeiner Grundsatz**, kein eigener Paragraph. Zusätzlich CONFIRMED: § 41 VRG (VGr letzte kantonale Instanz), § 50 Abs. 2 VRG (Unangemessenheit nur wenn Gesetz es vorsieht → «keine Angemessenheitskontrolle»). Fehlerhafte «§ 50a VRG»-Zitate an allen 6 Fundorten (Wiki, Destillat ×4 Stellen, beide INDEX, curriculum) korrigiert; die einmal als Gemeindeautonomie-Beleg missplatzierte «§ 50a VRG» → Art. 50 BV.
...
- **Komplex 1 — §§ 218/219/220 PBG (Ausnahmebewilligung/Dispens), Wiki [[ausnahmebewilligung-und-bestandesschutz]] (bleibt `established`):** gegen `raw/260607_amtlich_zh_pbg.md` Z. 2179-2194 adversarial geprüft. **1 echte Korrektur (die aus Run 34 offene Lücke geschlossen):** § 220 Abs. 2 war im Wiki auf «Wahrung von Sinn/Zweck und öffentlichen Interessen» **verkürzt** — die entscheidende **Gemeinwesen-Ausnahme** («…es sei denn, es würde die Erfüllung einer dem Gemeinwesen gesetzlich obliegenden Aufgabe verunmöglicht oder übermässig erschwert») fehlte ganz; jetzt vollständig im Fliesstext + Frontmatter ergänzt. **Präzisierung:** § 220 Abs. 3 gilt nur «für Vorschriften, die auch ihn [den Nachbarn] schützen» (nachbarschützende Funktion) — ergänzt. **Neu als Kontext:** §§ 218/219 PBG als Trias-Einordnung (§ 218 Rechtsnatur/öffentliches Recht, § 219 nur Verschärfung) + Frontmatter `paragraphen` (§ 218/219/§ 220 Abs. 2). § 220 Abs. 1 (besondere Verhältnisse + Unverhältnismässigkeit) CONFIRMED; kein Abs. 4 (nach Abs. 3 folgt § 221 aufgehoben).
- **Komplex 2 — KNHV §§ 13-22/29-32 (Natur-/Landschaftsschutz/Erholungsflächen), Destillat [[04-natur-und-heimatschutz]]:** gegen `raw/260714_amtlich_zh_knhv.md` (Nachtrag 130, gültig ab 1.8.2025) geprüft. **Amtliche Abschnitts-Randtitel bestätigt:** «II. Naturschutz» §§ 13-18, «III. Landschaftsschutz» §§ 19-22, «IV. Ortsbild- und Denkmalschutz» §§ 23-28, «V. Kommunale Erholungsflächen» §§ 29-32, «VI. Inkraftsetzung» § 33. **1 echte Korrektur (Fehlzuordnung):** das Destillat zitierte die Naturschutz-Lebensräume (Trockenstandorte/Feuchtgebiete/Magerwiesen/Hecken) fälschlich als «§§ 19-22 KNHV Landschaftsschutz» — amtlich sind sie **§ 13 Abs. 1 KNHV** (Naturschutz); korrigiert. **Neu belegt:** § 14 KNHV = Fundstelle für «Abstandslinien an Waldrändern/Gewässern» + Baumbestand-Schutz; § 30 KNHV = Erholungsflächen-Richtwert 45 m²/Einwohner. §§ 29-32 sind **nicht** Schluss-/Übergangsbestimmungen (das ist § 33), sondern Erholungsflächen — Auftragsprämisse korrigiert.
- **Komplex 3 — USG-Altlasten Art. 32c/32d/32dbis/32bbis (adversariale Re-Verifikation/Festigung), Destillat [[12-baureife-teil4-gebuehren-abfall-altlasten]] + Wiki [[baureife-und-erschliessung]]:** die bereits (Run 44) als CONFIRMED markierten Aussagen gegen `raw/260714_amtlich_ch_usg.md` **nochmals adversarial** geprüft — **Kern hält vollständig** (Art. 32c Abs. 1 Sanierungspflicht, Abs. 2 KbS; Art. 32d Verursacherprinzip Abs. 1/2/3/5; Art. 32dbis Abs. 3 Veräusserungs-Bewilligung «ein Wort»; Art. 32bbis zwei Drittel/1.7.1972-1.7.1997/1.11.2021 alle wortgleich). **1 Absatz-Korrektur:** die Kostenverteilungsverfügung auf Verlangen eines Verursachers ist **Art. 32d Abs. 4 USG** (nicht Abs. 3 = Ausfallkosten Gemeinwesen); im Destillat behoben.

- **Stale-Flags geschlossen (Run 45):**
  - § 220 Abs. 2 «Gemeinwesen-Ausnahme im Wiki verkürzt» (offen seit Run 34) → **erledigt** (Komplex 1).
  - «Art. 32b bis / 32d bis USG Nomenklatur vor Kundenzitat am Fedlex-USG-Volltext prüfen» → **erledigt** (Run 44 Nomenklatur, Run 45 Re-Verifikation + Abs.-4-Fix; amtlich «32bbis»/«32dbis» je ein Wort).
...
- **Komplex 1 — VRG-Rechtsschutz (§§ 25/26/26a-d/55/58/86-89 VRG + § 317/338/339/339b PBG), Wiki [[rechtsschutz-und-rechtsmittelverfahren]] (bleibt `emerging`):** gegen `raw/260714_amtlich_zh_vrg_rechtsschutz2.md` + `raw/260712_amtlich_zh_vrg.md` + `raw/260607_amtlich_zh_pbg.md` geprüft. Mehrheit CONFIRMED (§ 25 Abs. 1/§ 339 PBG, § 86a Revision, § 338 PBG Gerichtsgebühr, § 339 PBG Teilfreigabe). **2 Korrekturen:** (1) das im Wiki behauptete «Replikrecht § 26b VRG» — § 26b Abs. 4 VRG regelt wortwörtlich nur die **Zustellung der Vernehmlassungen**, kein kodifiziertes Replikrecht; das Replikrecht ist Praxis aus **Art. 29 Abs. 2 BV** (BGE 132 I 42 E. 3.3), jetzt so präzisiert; (2) «Zivilgericht» als Forum für Schadenersatz — § 339b PBG allein sagt nur «nach dem jeweiligen Verfahrensrecht», das Zivilgericht als Forum folgt erst aus **§ 317 PBG** in Kombination, jetzt präzisiert. **Offen bleiben** § 209f PBG und § 50a VRG (ausserhalb des heute beschafften Volltextumfangs) — Status bleibt `emerging`.
...
- **Komplex A — §§ 295-298 PBG (Kap. 17): Destillat↔Destillat-Divergenz geschlossen.** Das Destillat [[17-gebaeude-und-raeume]] führte §§ 295-298 PBG als «Detail offen», während das **Schwester-Destillat [[17-gebaeude-und-raeume-teil2-ausruestungen]]** sie **bereits seit 2026-07-13 Modell-D-volltextverifiziert** hatte (§ 296/297/298 dort ausdrücklich «volltextverifiziert 13.07.2026») — dieselbe Divergenz-Klasse wie die Wiki↔Destillat-Fälle aus Run 39/40, nur zwischen zwei Buch-Destillaten. Grundnorm-Kurzfassung in teil1 am strukturell richtigen Ort (vor §§ 299 ff.) ergänzt + auf teil2 als kanonische, vertiefte Fundstelle (inkl. § 71 PBG Energieplan-Anschlusspflicht/WKK) verlinkt; eigenständig gegen `raw/260607_amtlich_zh_pbg.md` (Z. 3033-3057) gegengeprüft, alle **CONFIRMED**: § 295 (Wärmeversorgung — standortgerechte Heizzentralen mit Abwärme/erneuerbaren Abs. 1; **Fernwärme-Anschluss- und Duldungspflicht** bei technisch/wirtschaftlich gleichwertigem Angebot Abs. 2), § 296 (Beförderungsanlagen — zweckgerecht/fachgemäss, Anpassung an technische Entwicklung wo Sicherheit verlangt), § 297 (Nebenräume in Wohnhäusern — Trockenräume/Einstellgelegenheiten, konkretisiert § 39 BBV I), § 298 (RR-Delegation für strengere Sicherheits-/Ausrüstungsbestimmungen bei Gebäuden > 6 anrechenbaren Geschossen). Eigener Abschnitt im Destillat ergänzt, Frontmatter-`verifiziert` nachgeführt. **Status bleibt `emerging`** (Ausrüstungen-Teil § 4 ABV + Einstellräume-Detail §§ 37-39 BBV I ab Shot 632 weiterhin ungelesen).
...
- **Komplex 1 — reiner BBV-I-Wortlaut (letzte offene Restschuld aus Run 39):** §§ 18/21/22/23/24/26/29/30a/31/32/33/37/40/42/43/44/45/45a/46/46a BBV I + § 19a BBV II gegen `raw/260607_amtlich_zh_bbv1.md` + `raw/260607_amtlich_zh_bbv2.md` geprüft. **Festgestellt: der amtliche Wortlaut deckte sich bereits mit einer Korrektur, die am 2026-07-13 (Buch-Run 32/33) im Wiki [[wohnhygiene-und-raumanforderungen]] vorgenommen worden war, aber NICHT ins Buch-Destillat [[17-haustechnische-anlagen-teil3]] und `buecher/INDEX.md` nachgezogen wurde** — exakt dieselbe Wiki→Destillat-Divergenz wie in Run 39 bei EnerG. Beim eigenständigen Volltextabgleich zusätzlich **zwei bisher unentdeckte Fehler gefunden**, die auch im Wiki fehlten: (a) **§ 29 Abs. 2 BBV I kennt keine «Ausnahme innenliegende Räume»** bei der WRG-Pflicht (unbelegter Zusatz, gestrichen); (b) **§ 42 Abs. 1 BBV I kennt kein «> 1 Kochplatte»-Kriterium** bei der Nutzeinheit-Definition (nur «eigene Kücheneinrichtung» im Gesetzestext). Alle Korrekturen jetzt in Destillat + INDEX.md + Wiki (Ergänzung) synchron. **6 Korrekturen gesamt** (§ 24 BBV I fälschlich als AWEL-Bewilligungsgrundlage statt Mengenzähler-Pflicht, Brauchwarmwasser-Bedingungen fälschlich § 23 statt § 26 Abs. 2, unbelegte Ausnahme innenliegende Räume § 29 Abs. 2, «§ 45 Abs. 3» existiert nicht → § 45a, «> 1 Kochplatte» nicht im Wortlaut § 42, Freiluftbad-Schwelle «ab» statt «mehr als» 8 m³ § 46), 1 Ergänzung (12-W/m²-Komfortklimadeckel § 45 Abs. 2 lit. a neu im Destillat), 0 Halluzinationen sonst — Rest CONFIRMED (§§ 18/21/22/26/30a/31/32/33/37/40/43/44/46a BBV I, § 19a BBV II). [[17-haustechnische-anlagen-teil3]] `emerging`→**`established`**.
- **Komplex 2 — § 62 StrG Wiki→Destillat/Zweitwiki-Divergenz nachgezogen:** die bereits 2026-07-13 (Buch-Run 36) im Wiki [[baulinien-und-abstandslinien]] korrigierte Mehrwertbeitrags-Regel (§ 62 lit. c/d StrG, max. ½ Wertvermehrung/¾ Kosten bzw. max. ½ Trottoir-Kosten, KEIN kommunal/kantonal-Split 1/4-1/2/1/4) war im Buch-Destillat `03-erschliessung-landsicherung-teil1.md` (3 Stellen im Fliesstext + Frontmatter) und im zweiten Wiki-Artikel [[baureife-und-erschliessung]] (1 Stelle) NICHT nachgezogen — dort stand weiterhin die widerlegte Buch-Angabe. Alle 4 Fundstellen + `buecher/INDEX.md` jetzt korrigiert.
- **Lehre für den Radar:** bei parallelen VOLLGAS-Instanzen entstehen wiederholt Wiki→Destillat- (und teils Wiki→Zweitwiki-)Divergenzen, weil ein Run oft nur EINEN der mehreren Orte korrigiert, an denen ein Fakt steht. Ein Lauf, der primär TRANSFER/Verifikation an einem neuen Komplex macht, sollte am Ende kurz gegen `grep -rn "<Schlüsselbegriff>"` über wiki/ + buecher/ prüfen, ob alle Fundstellen synchron sind — dieser Mechanismus hat in Run 39 UND Run 40 unabhängig voneinander Divergenzen gefunden.
- **needs-verification (verbleibend):** § 48 BBV I (laut Wiki aufgehoben, Materie in § 12b EnerG) nicht separat im Destillat verifiziert, nur § 48c erwähnt (bleibt in Kraft) — geringe Prio, da bereits im Wiki korrekt dokumentiert. **BBV-I-Wortlaut damit vollständig abgeschlossen.**

## ✅ GEKLÄRT 2026-07-14 (Run 39-KNHV-Instanz + Run 41-Cleanup) — die KNHV ist NICHT aufgehoben, kein Nachfolgeerlass nötig
**Ursprünglicher Befund (Run 38, 2026-07-13):** die zhlex-Erlassseite `erlass-702_11-…-099.html` zeigte für die KNHV (LS 702.11) ein «Aufhebungsdatum 01.08.2025», der Nachfolgeerlass war nicht auffindbar → Flag «hohe Priorität».
**Auflösung:** Der volle Volltextabgleich gegen die **aktuelle konsolidierte Fassung Nachtrag 130** (`raw/260714_amtlich_zh_knhv.md`, gültig ab 01.08.2025) hat den Irrtum aufgeklärt: Das «Aufhebungsdatum 01.08.2025» bezog sich auf das **Ende der Geltungsdauer JENER Fassung (Nachtrag 099)**, nicht auf eine Aufhebung der Verordnung als Ganzes. Per 01.08.2025 gilt unter **derselben LS-Nummer 702.11** und demselben Titel («Kantonale Natur- und Heimatschutzverordnung KNHV») die revidierte Fassung **Nachtrag 130**. Es handelt sich um eine **Teilrevision** (RRB vom 15.01.2025, OS 80, 179), die **nur § 3** (Bundesinventare, neue Fassung) und **§ 3a** (Zuständigkeit/Delegation ALN/ARE, neu eingefügt) betrifft. **Kein Nachfolgeerlass zu ermitteln.** Alle im Hub zitierten KNHV-Paragraphen (§§ 4/6/7/8/10/12/23-28 sowie § 2a/§ 2/§ 9/§ 13-32) sind **unverändert und CONFIRMED**.
**Eingearbeitet:** Wiki [[naturschutz-und-denkmalschutz]] (Rechtsstatus-Absatz + Frontmatter, 2026-07-14) und Destillat [[04-natur-und-heimatschutz]] (Verifikations-Vermerke §§ 4/6/7/8/10/12/23-28 + Quellenblock). **Cleanup Run 41:** `wiki/INDEX.md` beide Naturschutz-Artikel `emerging`→`established` nachgezogen (Status-Divergenz), dieser Flag-Block als geklärt markiert. Beleg: `raw/260714_amtlich_zh_knhv.md`, Nachtrag 130.

## Geklärt / verifiziert — 2026-07-14 (Buch-Run 39, Phase 3 · Modell-D Volltextabgleich: EnerG §§ 9-14 Fassungsstand + Wiki↔Destillat-/INDEX-Divergenz)
Fokus dieses Laufs: die in Run 32 im Wiki [[wohnhygiene-und-raumanforderungen]] bereits korrigierten EnerG-Fassungsstand-Befunde waren **im Buch-Destillat [[17-haustechnische-anlagen-teil3]] und im `buecher/INDEX.md` noch NICHT nachgeführt** — obwohl das Destillat-Frontmatter «verifiziert» trug. Das ist die klassische Wiki↔Destillat-Divergenz, die Modell D fangen soll. Gegen `raw/260712_amtlich_zh_energ.md` (Nachtrag 129, Stand Publikation 1.7.2025) direkt verifiziert und im Destillat eingearbeitet:
- **✅ VHKA-Schwelle korrigiert (§ 9 EnerG):** Buch/Destillat «ab 5 Nutzeinheiten» ist überholt — amtlich **Neubau ≥ 2 Nutzeinheiten (Warmwasser, § 9 Abs. 1)** bzw. **Bestand ≥ 3 Nutzeinheiten pro Gebäude bei Gesamterneuerung (§ 9 Abs. 3, in Kraft seit 1.9.2025)**; Befreiung bei besonderen Verhältnissen **§ 9 Abs. 5** (nicht Abs. 4). Destillat-Kurzfassung, VHKA-Detailzeile, Formel-Zeile, Transfer-Zeile + beide INDEX-Summaries korrigiert.
- **✅ § 12b EnerG statt § 30a Abs. 2 BBV I / § 13 EnerG:** die Wärmenutzung fossiler Elektrizitätserzeugungsanlagen ist heute in **§ 12b EnerG** geregelt; **Probeläufe Notstrom ≤ 50 h/Jahr** (§ 12b Abs. 1 — nicht 30 h). Destillat korrigiert.
- **✅ § 13 EnerG (Abnahmepflicht dezentraler Strom) per 1.9.2022 aufgehoben; § 9a EnerG existiert nicht** (Numerierung § 9 → § 10). § 10a (Wärmebedarf Neubauten) und § 10c (Eigenstromerzeugung/PV, Berechnungsgrundlage EBF) sind neu eingefügt (G vom 19.4.2021) — im Buch 2019 noch nicht enthalten, für die Energie-Beratung relevant (§ 10c neu als Modell-A-Drill erfasst). Rechtsschutz §§ 9-13d = Baurekursgericht (§ 14 EnerG).
- **✅ NISV-INDEX-Divergenz korrigiert:** `buecher/INDEX.md` führte die AGW-Legaldefinition noch mit der falschen Fundstelle «Art. 6 Abs. 3 NISV» — richtig ist **Art. 3 Abs. 6 NISV** (in Wiki + Destillat 19 bereits seit Run 32/37 korrekt, nur der INDEX-Auszug war veraltet).
- **needs-verification (verbleibend):** reiner BBV-I-Wortlaut §§ 21/22/23/24/26/29/30a/31/32/33/37/40/42/44/45/46/46a/48/48c BBV I + § 19a BBV II am amtlichen `raw/260607_amtlich_zh_bbv1.md` (separater Modell-D-Lauf); § 42a BBV I war bereits Run 32 als aufgehoben markiert (Materie in § 43 BBV I).
...
- **needs-verification (neu/verbleibend):** ~~§ 62 StrG (Mehrwertbeiträge, kein raw-Volltext vorhanden)~~ **erledigt 2026-07-14 (Buch-Run 40)** — volltextverifiziert gegen `raw/260713_amtlich_zh_strg.md`, siehe Abschnitt oben; § 357 Abs. 5 PBG Verordnungspraxis/Gerichtsentscheide (Buchtext ab Shot 732 nachlesen); Kap. 17 Restteile §§ 295-298 PBG + Ausrüstungen-Detail (Destillat bleibt `emerging`).
...
- **✅ VSS-Veloabstellplatz-Normen ROLLEN-KORRIGIERT (Cross-KB Run 12, 2026-07-22).** Das Wiki
  ...
  **SN 640 065** («Leichter Zweiradverkehr – Abstellanlagen, Bedarfsermittlung», Oktober 1996,
  amtlicher Volltext). **SN 640 060 existiert real**, aber als eigenständige Grundlagennorm
...
- **⚠️ VSS-Rampenneigungsnorm «SN 640 291a» — Normbezeichnung präzisiert, ~~Kennwerte bleiben
  ...
  **Nachtrag 2026-08-03:** Die Kostenpflicht-Aussage war bereits am Tag dieses Eintrags überholt.
  ...
  260714). Längsneigung, Gefällewechsel und Ausrundungsradien sind dort mit Fundstelle belegt
  (Ziff. 20.5-20.6, Tab. 13, S. 29) — dort nachschlagen, **nicht** neu beschaffen. Weiterhin offen
  bleibt allein die maximale **Längs**neigung von Parkfeldern (die Norm regelt in Ziff. 18 nur das
  Quergefälle). Der ursprüngliche Wortlaut dieses Eintrags bleibt unten als Historie stehen.
  Die alte Bezeichnung «SN 640 291a» entspricht in
...
- **Bauen im Betrieb (Healthcare):** kein eigener Brücken-Artikel, aber **nicht mehr
  unabgebildet** (Stand nachgetragen 2026-08-24, Buch-Run 105) — Healthcare-Fundstellen sind
  inzwischen über mindestens sechs Artikel verteilt: Asbest-Meldepflicht/Bezugskontrolle im
  Bestand [[bauausfuehrung-und-baukontrolle]], starke Personenbelegung/Erschliessung
  [[baureife-und-erschliessung]], Pflegewohnung-Zonenkonformität BEZ 2015 Nr. 36
  [[nutzungsziffern]], Aufzugsschwelle/Krankentransport-Mass [[wohnhygiene-und-raumanforderungen]],
  Patientenzimmer-Lärmschutz [[laermschutz-und-nichtionisierende-strahlung]],
  OEV-Parkplatzreduktion bei Healthcare-Projekten [[fahrzeugabstellplaetze-und-parkierung]];
  Grundprinzip weiterhin in [[bestandsumbau-eingriffstiefe]] (bereits in `wiki/INDEX.md` Z. 103
  so vermerkt). **Bleibt offen:** ein eigener Brücken-Artikel, der diese Fundstellen bündelt und
  die Brandschutz-Schnittstelle (Skill `brandschutz`) explizit verlinkt, existiert weiterhin
  nicht — dafür fehlt bislang ein auslösender Praxisfall/Auftrag, kein Recherchedefizit.
- ~~**Dispens / Ausnahmebewilligung:** nirgends behandelt.~~ → **erledigt 2026-06-18** (Run 10):
  ...
  Bestandesgarantie **ohne feste Quote** (Grenze neubauähnliche Umgestaltung). Schärft auch
...
- ~~**needs-verification — Fassungsstand nPBG/nABV (Kap. 15.13):** §§ 2/2a/2b/2c/6/6a/6b/6c/6d/7 nABV und
  ...
  **Vorlage-Text der Harmonisierung**, IVHB). Vor Zitat in Kundenberatung am **aktuell in Kraft stehenden**
  ...
  → **erledigt, nachgetragen 2026-08-24 (Buch-Run 105, Fund beim Sichten dieser Datei — die Frage war
  bereits durch frühere Läufe beantwortet, hier nur die Schliessung nachgeführt).** Der Fassungsabgleich
  ist am amtlichen Volltext LS 700.1 (Stand 1.7.2026) vollzogen: die harmonisierte Fassung (nPBG/nABV)
  **ist geltendes Kantonsrecht** (Hauptteil), das alte Recht steht nur noch im Anhang PBG und gilt
  übergangsrechtlich weiter, bis die jeweilige **Gemeinde** ihre BZO harmonisiert hat (Buch-Run 31/32,
  2026-07-12). Die Achtjahresfrist zur Gemeinde-Anpassung (01.03.2025) ist eine Ordnungsfrist ohne
  eigene Sanktion (Buch-Run 84, 2026-08-23, Quellen live gegen zh.ch geprüft — eine zunächst vermutete
  Fristverlängerung auf 29.02.2028 erwies sich als Verwechslung mit dem sachfremden
  Mehrwertausgleichsgesetz). Vollständig dokumentiert in [[abstaende-und-hoehen]], Abschnitt
  «Harmonisierungsvorlage (nPBG/nABV) — neue Messsystematik (Kap. 15.13)». Die 2025 in
  `planungsgrundlagen/wiki/recht-norm-ivhb-baubegriffe.md` referenzierte amtliche Anwendungshilfe bleibt
  als Zusatzquelle gültig, war für die Schliessung aber nicht mehr nötig.
...
**(a) P1 — drei Sätze im Destillat sind grammatisch zerstört und damit nicht zitierfähig.**
