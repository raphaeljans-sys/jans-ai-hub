...
- Steuernde Instrumente:
  ...
  - **Wegleitung der Baudirektion 1997** «Parkplatzbedarf in kommunalen Erlassen»:
    richtunggebend, als «sachverstaendige Stellungnahme» zu beruecksichtigen (BGE 124 II 272);
    Gemeindetypisierung **Typ 1** (laendlich, nur Reduktion) / **Typ 2** (Zentrum, zusaetzlich
    Maximum). Die Baubehoerde muss die Beschraenkung nur anwenden, wenn ihre eigenen
    Bestimmungen hinter dem Umweltschutzrecht zurueckbleiben (VB.2004.00234).
- **Autoarme Nutzungen** (PPV Stadt Zuerich Art. 8 Abs. 5-8): der Minimalbedarf laesst sich
  gestuetzt auf ein **Mobilitaetskonzept** senken; das **Behinderten-Minimum bleibt** und die
  Reduktion wird als oeff.-rechtl. Eigentumsbeschraenkung **vor Baubeginn im Grundbuch
  angemerkt**. Stadt-ZH-Leitfaden Mobilitaetskonzept (2016).
