...
**Das Wichtigste:** Die zulaessige Dichte wird in ZH ueber vier Ziffern gesteuert —
**Ausnuetzungsziffer (AZ, § 254/255 PBG)**, **Baumassenziffer (BMZ, § 254)**,
**Ueberbauungsziffer (UEZ, § 256)** und **Freiflaechenziffer (FFZ, § 257)**, jeweils
bezogen auf die **massgebliche Grundstuecksflaeche (§ 259 PBG)**. Fuer Dachausbauten
zentral: Raeume in **Dach- und Untergeschossen** zaehlen **nicht** voll zur Ausnuetzung,
sondern nur als **Mehrflaeche** ueber `zulaessige Ausnuetzung ÷ Zahl der zulaessigen
Vollgeschosse` (§ 255 Abs. 2 PBG).

## Begriffe & Paragraphen

- **Ausnuetzungsziffer (AZ)** — § 254 Abs. 1 PBG (S. 938 f.):
  `AZ = anrechenbare Wohn-/Arbeitsraeume in Vollgeschossen (m²) / massgebliche Grundstuecksflaeche (m²)`.
- **Anrechenbare Geschossflaeche** — § 255 Abs. 1 PBG (S. 938): anrechenbar sind **alle dem
  Wohnen, Arbeiten oder sonst dem dauernden Aufenthalt dienenden Raeume in Vollgeschossen**,
  **inkl. zugehoeriger Erschliessungsflaechen und Sanitaerraeume samt inneren Trennwaenden**.
  `§ 10 ABV` enthaelt eine Liste anrechenbarer Wohn-/Arbeitsraeume.
- **Raumbegriff** — § 260 PBG (S. 939): «Raum» = allseitig umschlossen, dem Wohnen/Arbeiten
  dienend. Offene Erdgeschossflaechen, Balkone, Loggien sind keine «Raeume».
- **Massgebliche Grundstuecksflaeche** — § 259 Abs. 1 PBG (S. 920): von der Baueingabe erfasste,
  baulich noch nicht ausgenuetzte Grundstuecksflaeche der Bauzone. Flaechen >15 m hinter der
  Waldabstandslinie sowie Wald/offene Gewaesser fallen ausser Ansatz (Abs. 3).
- **Ueberbauungsziffer (UEZ)** — § 256 Abs. 1 PBG (S. 958): `UEZ = senkrechte Projektion
  groesste oberirdische Gebaeudeumfassung (m²) / massgebliche Grundstuecksflaeche (m²)`.
- **Baumassenziffer / Freiflaechenziffer** — § 254 / § 257 PBG; ABV-Konkretisierung (§ 13 ABV).

## Formeln & Schwellenwerte (woertlich aus dem Werk)

**Dach-/Untergeschoss — Mehrflaechenregel (§ 255 Abs. 2 PBG, S. 950 f., 14.1.5.8):**
> Grundsaetzlich sind nur Raeume in **Vollgeschossen** zur Ausnuetzung anzurechnen. Raeume in
> **Dach- und Untergeschossen**, die dem Wohnen/Arbeiten/dauernden Aufenthalt dienen, sind in
> der Regel **nicht** anrechenbar — anrechenbar ist nur die **Mehrflaeche**, die je Geschoss
> jene Flaeche **ueberschreitet**, welche sich bei gleichmaessiger Aufteilung der gesamten
> zulaessigen Ausnuetzung auf die zulaessige Vollgeschosszahl ergaebe:
>
> `Mehrflaeche-Schwelle je Geschoss = gesamte zulaessige Ausnuetzung (m²) / Zahl der zulaessigen Vollgeschosse`
>
> Was pro Dach-/Untergeschoss **darueber** liegt, ist anrechenbare Geschossflaeche. (§ 276 PBG
> bestimmt, wann Dach-/Untergeschosse zudem als **Geschoss** zaehlen.)

**Sanitaerraeume** (§ 255 Abs. 1, S. 950): Abortanlagen, Bad/Dusche sind anrechenbar.
**Innere Trennwaende** anrechenbar; **Aussenwandquerschnitte** ausser Ansatz (S. 950).

## Praxis / Fallrecht (aus dem Werk zitiert)

- **Nicht anrechenbar** (keine Wohn-/Arbeitsnutzung; S. 944 f.): reine Lager-/Archivraeume im UG,
  Waschtrocknungsraum, ein nur durch Glasbausteine belichteter/nicht oeffenbarer Raum, ein
  Reduit unter der Dachschraege mit Belichtung <0.5 m² und Raumhoehe ~1.8 m (nicht wohntauglich),
  ein Einstellraum 9.6 m² mit Raumhoehe ~2.2 m ohne ausreichende Belichtung (VB.2008.00012 u.a.).
- **Anrechenbarkeit** haengt an der **Eignung** zum Wohnen/Arbeiten (Belichtung, Raumhoehe,
  Erschliessung), nicht an der tatsaechlichen Nutzung; verbotene Nutzung darf nicht unterstellt
  werden (BEZ 2001 Nr. 4).
...
- Bei **Dachausbau-Fragen** zuerst klaeren: (1) Ist das Dachgeschoss ein **Vollgeschoss** oder
  echtes Dachgeschoss (→ § 276 PBG, Kap. 16)? (2) Wie gross ist die **AZ-Reserve** der Parzelle?
  (3) Welche DG-Flaeche liegt **ueber** der Mehrflaechen-Schwelle und ist damit anrechenbar?
- Die in Vermessungs-/Bestandesplaenen oft eingezeichnete **1.50-m-Hoehenlinie** ist die
  Schwelle der wohntauglichen/anrechenbaren Flaeche unter der Dachschraege — Schluesselgroesse
