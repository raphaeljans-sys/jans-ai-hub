...
Das PBG regelt die oeffentlich-rechtlichen Abstaende in den **§§ 260-274 PBG**: gegenueber
politischen Grenzen, Wald und Verkehrsanlagen (§§ 261-268), Grenzabstaende zu Nachbar-
grundstuecken (§§ 269-270) und Gebaeudeabstaende (§§ 271-274). Diese Abstaende gelten
**grundsaetzlich nur fuer Gebaeude** und werden **immer ab der Fassade** gemessen
(§ 260 Abs. 1 PBG), weshalb die **Gebaeudeart** (Mini-/bewilligungsfreie/besondere/
abstandsfreie Bauten vs. Hauptgebaeude) ueber die einzuhaltenden Abstaende entscheidet.
Wald- und Gewaesserabstand folgen Sonderregimen (§ 262 PBG / Waldabstandslinie bzw.
Art. 36a GSchG + Gewaesserraum), die strenger sind als die nachbarlichen Grenzabstaende.

## 2. Begriffe & Paragraphen

### 2.1 System der Abstaende (S. 996)
- Abstandsregeln im Ueberblick: **§§ 261-268 PBG** = Abstaende von politischen Grenzen,
  Wald, Verkehrsanlagen (insbes. Strassen), Versorgungsleitungen, Anschlussgleisen;
  **§§ 269-270 PBG** = Grenzabstaende der Nachbargrundstuecke; **§§ 271-274 PBG** =
  Gebaeudeabstaende. Weitere: **§§ 99-101 PBG** (Verkehrsbaulinien), **§§ 21-26 ABV**
  (Begriff/Messweisen der kommunalen Grenzabstaende), Strassenabstands- und Verkehrs-
  sicherheitsverordnung (Mauern/Einfriedungen/Pflanzen), **BBV II** (Verschaerfungen/
  Milderungen), gewaesserschutzrechtliche Bestimmungen, eidg. Starkstromverordnung
  (§§ 286-291 PBG). (S. 996)
- **Privatrechtliche Abstaende:** Baeume, Straeucher, Einfriedungen von Nachbar-
  grundstuecken gehoeren **nicht** dem oeffentlichen Recht an, sondern dem kantonalen
  Privatrecht — **Art. 688 ZGB i.V.m. §§ 169 ff. EG ZGB** (S. 996; vgl. S. 1525).
...
- **Bewilligungsfreie Bauten/Anlagen:** Gesamthoehe ≤ 2,5 m UND Bodenflaeche ≤ 6 m²
  ...
  **abstandspflichtig** (S. 996 f.).
- **Besondere Gebaeude:** Gebaeude/Gebaeudeteile, die **nicht fuer den dauernden
  Aufenthalt von Menschen** bestimmt sind und deren groesste Hoehe **4 m** (bei Schraeg-
  daechern **5 m**) nicht uebersteigt (§ 49 Abs. 3 PBG). Hier ist die **Nutzung**
  massgebend fuer die Qualifikation (anders als bei Mini-/abstandsfreien Bauten).
  → **reduzierte** Grenz- und Gebaeudeabstaende (§ 49 Abs. 3 / § 273 PBG). (S. 997)
- **Abstandsfreie Gebaeude:** unter- oder oberirdische Gebaeude, die den gewachsenen
  Boden um **nicht mehr als 50 cm** ueberragen und **keine Oeffnungen gegen Nachbar-
  grundstuecke** aufweisen → keine Abstandsvorschriften, sofern die BZO nichts anderes
  festlegt (§ 269 PBG). (S. 997)
- **Hauptgebaeude:** alle uebrigen Gebaeude → Abstaende **vollumfaenglich** nach Bau- und
  Zonenordnung und PBG (§ 260 PBG). (S. 998)

### 2.3 Messweise — Fassade und Grenze (S. 998)
- **Fassade:** Abstaende werden **immer ab der Fassade** gemessen (§ 260 Abs. 1 PBG).
  Massgebend ist die **horizontale Lage der Fassade** = Projektion der groessten
...
- **Politische Grenzen** (Gemeinde-/Bezirks-/Kantonsgrenzen): **kein** Abstand, aber
  Gebaeude duerfen sie **nicht ueberschreiten** (§ 261 PBG). Zwei Gebaeude koennen — durch
  Brandmauer getrennt — an der politischen Grenze zusammengebaut werden (vgl. S. 1339).
- **Zonengrenzen:** mangels Vorschrift **kein** kantonalrechtlicher Abstand
  (BEZ 1989 Nr. 21); Gebaeude duerfen Zonengrenzen ueberschreiten, jeder Gebaeudeteil
  haelt aber die fuer **seine** Zone geltenden Vorschriften ein (RB 1991 Nr. 84); das
  Gebaeude wird gleichwohl als Einheit behandelt (Geschoss-Anrechnung RB 1994 Nr. 84).
- **Landwirtschaftszone:** Abstand einzuhalten, sofern dort nicht zugleich eine
  Grundstuecksgrenze verlaeuft. Gemeinden duerfen **keine** eigenen Zonengrenzabstaende
  einfuehren, solange das PBG keine Grundlage enthaelt (Kreisschreiben Baudirektion,
  4. Mai 2015, Ziff. VI). (S. 998 f.)
- **Landwirtschaftliche Bauten an der Bauzonengrenze** (Tierhaltung): Mindestabstaende
  zu bewohnten Zonen nach Art. 3 Abs. 2 lit. a **LRV** + Anhang 2 Ziff. 512 LRV /
  ART-Empfehlungen Taenikon (S. 999; Naeheres S. 1370 f.).

### 2.5 Waldabstand (S. 999-1005) — § 262 PBG, NICHT § 268
- **Rechtsgrundlage Kt. ZH: § 262 PBG**, je separat fuer innerhalb und ausserhalb der
  Bauzonen. Bundesrahmen: **Art. 17 WaG** (Bauten in Waldesnaehe nur zulaessig, wenn
  Erhaltung/Pflege/Nutzung des Waldes nicht beeintraechtigt; Kantone schreiben
  angemessenen Mindestabstand vor; Unterschreitung aus wichtigen Gruenden bewilligbar,
  Abs. 3). Zweck: Schutz waldnaher Bauten vor Windwurf/Schatten/Feuchtigkeit und Schutz
  des Waldes (BGE 119 Ia 12 E. 5). (S. 999)
- **Innerhalb Bauzonen — Waldabstandslinie:** der massgebliche Waldabstand wird durch
  die in der Nutzungsplanung festzusetzenden **Waldabstandslinien** bestimmt
  (§ 262 Abs. 1 PBG). Der Erlass ist **zwingend** (§ 66 Abs. 1 PBG). (S. 999 f.)
- **Regelabstand: § 66 Abs. 2 PBG → 30 m** von der Waldgrenze. Bei kleinen Wald-
  parzellen oder besonderen oertlichen Verhaeltnissen naeher oder weiter, **bis 15 m**
  (VGr 2013.00291 E. 6.5; BEZ 1996 Nr. 18). Waldabstandslinien beduerfen der Genehmigung
  des Bundes (Art. 52 WaG). Das VGr hat einen Waldabstand von **10 m** sanktioniert
  (VB.2010.00147). (S. 1000)
- **Abstandspflichtige Bauten:** neue oberirdische Gebaeude duerfen die Waldabstands-
  linie nicht ueberschreiten (§ 262 Abs. 1 PBG); Balkone Sonderregel § 262 Abs. 3 PBG.
  **Unterirdische** Gebaeude/Gebaeudeteile sind **abstandsbefreit** (Umkehrschluss aus
  § 262 Abs. 1 PBG), Ausnahmebewilligung § 220 PBG. **Bestehende** Gebaeude geniessen
  Bestandesschutz § 357 PBG; Wiederaufbau nach Zerstoerung § 307 PBG. (S. 1002 f.)
- **Forstpolizeilicher Mindestabstand (eigenstaendig, Art. 17 WaG):** das VGr erachtet
  einen Abstand unter **10 m** i.d.R. als zu gering; bei einem Schwimmbassin genuegten
...
- **BGE 119 Ia 12 E. 5** — Zweck der Waldabstandsvorschriften (S. 999).
- **VGr 2013.00291 E. 6.5** — Reduktion der Waldabstandslinie bis 15 m bei besonderen
  oertlichen Verhaeltnissen (S. 1000).
- **VB.2010.00147** — Waldabstand von 10 m sanktioniert (S. 1000); forstpolizeilich unter
  10 m i.d.R. zu gering (S. 1004).
- **BR I/2001 Nr. 95** — forstpolizeilicher Minimalabstand Schwimmbassin 4-5 m (S. 1005).
...
- **Fruehwarnung bei waldnahen Parzellen (ZH):** Es gelten ZWEI voneinander unabhaengige
  Waldabstaende — die planungsrechtliche **Waldabstandslinie** (§ 262 PBG, Regel 30 m)
  UND der **forstpolizeiliche** Mindestabstand (Art. 17 WaG, faktisch ≥ 10 m). Im Baufeld
  (Skill `machbarkeit`/Agent `baulinien-analyst`) ist die strengere der beiden bindend.
  Unterirdische Bauteile sind von der Waldabstandslinie befreit — relevant fuer Tiefgaragen
  an der Linie.
