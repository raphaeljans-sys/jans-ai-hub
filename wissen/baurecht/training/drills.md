...
Format: **F:** Frage — **A:** Antwort (mit § + Band/Seite). Bei Wiederholung pruefen, ob die
Antwort frei + belegt gelingt. Datum = letzte korrekte Wiederholung.

## Kap. 14 — Nutzungsdichte/Ausnuetzung

- **F:** Wie ist die Ausnuetzungsziffer definiert? — **A:** `AZ = anrechenbare Wohn-/Arbeitsraeume
  in Vollgeschossen / massgebliche Grundstuecksflaeche` (§ 254 Abs. 1 PBG; Bd 2, S. 938). _[2026-06-07]_
- **F:** Zaehlen Wohnraeume im Dachgeschoss zur Ausnuetzung? — **A:** Nur die **Mehrflaeche** ueber
  `zulaessige Ausnuetzung ÷ Zahl zulaessiger Vollgeschosse` (§ 255 Abs. 2 PBG; Bd 2, S. 950 f.).
  Voll anrechenbar sind nur Raeume in **Vollgeschossen**. _[2026-06-07]_
- **F:** Sind Sanitaerraeume und innere Trennwaende anrechenbar? — **A:** Ja, beide (§ 255 Abs. 1
  PBG; Bd 2, S. 950); Aussenwandquerschnitte ausser Ansatz. _[2026-06-07]_
- **F:** Was macht einen Dachraum «anrechenbar»? — **A:** Eignung zum Wohnen/Arbeiten — genuegende
  Belichtung/Belueftung, Raumhoehe, Erschliessung; nicht die tatsaechliche Nutzung (Bd 2, S. 944 f.;
  BEZ 2001 Nr. 4). _[2026-06-07]_
- **F:** Welcher § regelt die *massgebliche Grundstuecksflaeche*, und was faellt ausser Ansatz?
  — **A:** **§ 259 PBG**; ausser Ansatz: Wald/Gewaesser, Waldabstandsstreifen >15 m hinter der
  Waldabstandslinie, uebergeordnete Strassen, der Allgemeinheit dienende oeffentliche Fusswege/
  Eisenbahnanlagen (§ 259 Abs. 2/3 PBG; Bd 2, S. 920-927). _[2026-06-09]_
- **F:** Unter welchen drei Bedingungen ist eine Ausnuetzungsuebertragung zulaessig? — **A:** (1)
  **gleiche Zone** (kein Sprung ueber Zonengrenzen, § 72 Abs. 3 PBG), (2) **raeumliche Naehe /
  direkt angrenzend** (Verbot grossflaechiger Verschiebung), (3) **Zustimmung + Ausnuetzungsrevers
  im Grundbuch** (Bd 2, S. 928-932). _[2026-06-09]_
- **F:** Welcher kommunale Daumenwert begrenzt die Ausnuetzungserhoehung der beguenstigten
  Parzelle? — **A:** Beispiel Art. 40 BO Erlenbach: **max. ein Fuenftel (20 %) der Grundausnuetzung**
  (kommunal, nicht kantonal einheitlich; Bd 2, S. 932). _[2026-06-09]_
- **F:** Steht die Geschossflaechenziffer (GFZ) der IVHB im Kanton Zuerich zur Verfuegung? — **A:**
  **Nein** — die IVHB-GFZ steht in ZH NICHT zur Verfuegung; ZH steuert ueber AZ/BMZ/UEZ/
  Gruenflaechenziffer (Bd 2, S. 988). _[2026-06-09]_
- **F:** Welcher § ist die Freiflaechenziffer — und welcher gerade NICHT? — **A:** Freiflaechenziffer
  **§ 257 PBG**; **nicht** § 259 (das ist die *massgebliche Grundstuecksflaeche*) (Bd 2, S. 920/949).
  _[2026-06-09]_
- **F:** Zaehlen Pflege-/Hotelzimmer zum vorgeschriebenen Wohnanteil? — **A:** Nicht automatisch —
  wohnaehnliche Nutzungen (Heime, Hotellerie, Healthcare) koennen ausserhalb des Wohnanteils
  liegen; Abgrenzung ueber Zweckbestimmung (§ 49a/§ 52 PBG; Bd 2, S. 984 f.). _[2026-06-09]_

## Kap. 16 — Gebaeudedimensionen (Geschosse + Kniestock)

- **F:** Welcher § definiert Voll-/Dach-/Untergeschoss — und welcher die Anrechenbarkeit? — **A:**
  Qualifikation nach Lage: **§ 275 PBG** (Voll Abs. 1 / Dach Abs. 2 / Unter Abs. 3); Anrechenbarkeit
  zur Geschosszahl: **§ 276 PBG** (Bd 2, S. 1136, 1142 f.). _[2026-06-10]_
- **F:** Ab welcher Kniestockhoehe wird ein Dachgeschoss zum Vollgeschoss? — **A:** Ueber **0,9 m**
  (§ 275 Abs. 2 PBG); bei vor dem **1.7.1978** bewilligten Bauten erst ueber **1,3 m** — diese
  Erleichterung gilt nur fuer Bestand, nicht fuer Neubau (BEZ 1997 Nr. 19; Bd 2, S. 1148).
  _[2026-06-10]_
- **F:** Wo genau wird der Kniestock gemessen? — **A:** **0,4 m hinter der Fassade** (nicht hinter
  der Aussenwaermedaemmung), vertikal ab Oberkant Unterlagsboden bis Unterkant Dachverkleidung
  (Fertigplanum, BEZ 1994 Nr. 21; Bd 2, S. 1148 f.). _[2026-06-10]_
- **F:** Macht eine energetische Aussendaemmung aus einem Dachgeschoss ein Vollgeschoss? — **A:**
  Nein — der Kniestock wird **hinter der Fassade** gemessen, die Daemmdicke bleibt ausser Betracht;
  die Geschossqualifikation aendert sich nicht (§ 275 Abs. 2 PBG; Bd 2, S. 1148). _[2026-06-10]_
- **F:** Wann zaehlt ein Untergeschoss zur Geschosszahl? — **A:** Wenn es Wohn-/Schlaf-/
  Arbeitsraeume enthaelt (§ 276 Abs. 1 PBG) oder mehrheitlich ueber dem gewachsenen Terrain liegt
  (Volumen ueber Boden anrechenbar, BEZ 2009 Nr. 63; Bd 2, S. 1143 f.). _[2026-06-10]_
- **F:** Wie wird der Kniestock bei einem auskragenden Dachgeschoss gemessen? — **A:** An der
  Fassade des darunterliegenden **Vollgeschosses**, nicht an der Auskragung (Dach imaginaer bis zur
  Fassade fortgedacht); ueber 0,9 m bleibt es ein Vollgeschoss (BEZ 1997 Nr. 7; Bd 2, S. 1152 f.).
  _[2026-06-10]_

## Kap. 15 — Lage von Gebaeuden (System, Wald, Gewaesser)

- **F:** Welcher § regelt im Kt. ZH den **Waldabstand** — und welcher gerade NICHT? — **A:**
  **§ 262 PBG** (Bundesrahmen Art. 17 WaG); **nicht** § 268 PBG (das betrifft Anschlussgleise).
  Regelabstand der Waldabstandslinie **30 m**, reduzierbar **bis 15 m** (§ 66 Abs. 2 PBG;
  Bd 2, S. 999 f.). _[2026-06-11]_
- **F:** Ab welcher Groesse ist eine Baute abstandspflichtig, ab welcher bewilligungspflichtig? —
  **A:** Abstandsfrei UND bewilligungsfrei nur als **Minibau** (≤ 1,5 m Hoehe UND ≤ 2 m² Boden,
  § 2 Abs. 1 ABV). Daruber bis 2,5 m / 6 m² bewilligungsfrei, aber als Gebaeude bereits
  **abstandspflichtig** (§ 1 lit. a BVV; Bd 2, S. 996 f.). _[2026-06-11]_
- **F:** Was ist ein «besonderes Gebaeude» und welchen Vorteil bringt die Qualifikation? — **A:**
...
- **F (Modell D, Methodik):** Diese Karteikarte (Z. 1077-1081) hatte die richtige Zuordnung des
  ...
  Wiki-Artikel [[fahrzeugabstellplaetze-und-parkierung]] bis Run 70 das Gegenteil. Wie konnte das
