# Batch-Lauf 2026-07-25 — Synobsis-Nachtaufbereitung
...
- Kollisionsschutz (Regel 260724): keine zweite Synobsis-Instanz aktiv (`ps` = 0) — ok.
...
- Quelle unabhaengig gegengeprueft: 854 Top-Level-Verzeichnisse (853 Architekten +
  `00_Organisation`) — identisch zum Vortag. Juengste Ordner-Aenderung `HdM`,
  2026-04-07 — kein neuer Stoff seit Katalog-Stand 2026-07-02.
- Stufe 2 per Stichprobe funktionsgeprueft: `synobsis_query.py --semantic
  ...
  u.a. Sauerbruch Hutton) — Semantikindex intakt.
- `vectors.npz` binaer neu gebaut (Embeddings deterministisch, daher kein inhaltlicher
  Git-Diff); ggf. reine Zeitstempel-Diffs in Katalog-Indexdateien.

## Fortschritt
853/853 (100 %). Erstdurchlauf steht unveraendert seit 2026-07-02.

## Befund / Empfehlung
Dreizehnter ergebnisloser Nachtlauf in Folge. Ohne neues Rohmaterial in der Quelle oder
...
**Empfehlung an Raphael (zum dreizehnten Mal in Folge, nicht selbst umgesetzt — der
