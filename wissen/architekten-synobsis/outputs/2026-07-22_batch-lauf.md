# Batch-Lauf 2026-07-22 — Synobsis-Nachtaufbereitung
...
- `git diff --stat` (nur KB): 2 Dateien (`catalog/INDEX.md`, `catalog/cad-index.json`),
  je 2 Zeilen — reine Zeitstempel, kein inhaltlicher Diff. `vectors.npz` binaer neu
  geschrieben (Embeddings deterministisch).
- Quelle unabhaengig gegengeprueft: 854 Top-Level-Verzeichnisse (853 Architekten +
  ...
  neuer Stoff seit dem Katalog-Stand 2026-07-02.
- Stufe 2 per Stichprobe funktionsgeprueft: `synobsis_query.py
  "introvertierter Hof Beton Kapelle"` → plausible Rangfolge, Top Boehm (7.79) und
  Zumthor (7.39, Bruder-Klaus-Betonkapelle) — Semantikindex intakt.

## Fortschritt
853/853 (100 %). Erstdurchlauf steht unveraendert seit 2026-07-02.

## Befund / Empfehlung
Zehnter ergebnisloser Nachtlauf in Folge (20. Wiederholungslauf seit dem produktiven
...
**Empfehlung an Raphael (zum zehnten Mal in Folge, nicht selbst umgesetzt — der
