...
- **Verabschiedet, aber noch kein Gesetz.** Die MuKEn sind eine **Musterempfehlung** der EnDK an
  die Kantone, keine unmittelbar geltende Norm. Jeder Kanton muss sie erst in sein **kantonales
  Energiegesetz** überführen (wie ZH das mit MuKEn 2014 → EnerG per 1.9.2022 getan hat).
- **Umsetzungshorizont laut Fachpresse: 2025–2030** — die Kantone sind unterschiedlich schnell;
  bis zur Rechtskraft im Kt. ZH gilt weiterhin die aktuelle EnerG-Fassung (→ [[energienachweis-zh]]).
- Diese Verabschiedung ist ein **Frühindikator**, kein sofort wirksames Recht — für laufende
  Baugesuche im Kt. ZH/SZ bleibt der heutige Vollzug massgebend.
...
Recht (im Kt. ZH: EnerG/EVEN, Basis MuKEn 2014). MuKEn 2025 zeigt aber die Richtung für die
nächsten Jahre verbindlich an: **keine fossile Heizung im Neubau mehr**, **mehr PV-Pflicht**, und
**graue Energie wird gesetzlich statt nur über Labels reguliert**. Wer heute plant und langfristig
...
| Modul 11 | Wärmedämmung/Ausnützung | Wanddicke/Dachaufbau wegen Wärmedämmung wird bei BMZ/GFZ **nur bis max. 35 cm** angerechnet | Auf **Muster-Ebene** erstmals mit Zahlenwert (35 cm) kodifiziert. **Für den Kt. ZH KEINE Neuerung** — dort gilt die 35-cm-Kappung bereits seit **1.4.2013**: § 258 Abs. 4 (BMZ), § 256 Abs. 2 (ÜZ), § 257 Abs. 3 (Grünflächenziffer), § 253a PBG (LS 700.1, FN 46: G vom 26.03.2012) sowie § 12 Abs. 3 ABV. ZH-Sonderfall: bei **nachträglicher** Aussenwärmedämmung an bestehenden Gebäuden ist sie für BMZ/ÜZ/GrFZ **ganz unbeachtlich** (§ 253a Abs. 2 PBG) — weitergehend als das Muster. Die **GFZ** steht in ZH nicht zur Verfügung; für die **AZ (§ 255 PBG)** besteht keine solche Kappung. Führend: `wissen/baurecht/wiki/nutzungsziffern` + `…/abstaende-und-hoehen` (Wissens-Chef Run 6, 16.07.2026) |
