---
quelle: "Formular EN-104 «Eigenstromerzeugung bei Neubauten» (Energienachweis)"
herausgeber: "EnFK — Konferenz Kantonaler Energiefachstellen"
ausgabe: "Version Juni 2019 (Formular-Nr. 403-EN-104-001-ger; gueltig bis 31.12.2024)"
...
## Modul-Flaechen-Annahmen (zur Plausibilisierung der Anlagengroesse)
- Mono-/polykristalline Module oder Hybridkollektoren: **8 m²/kW**.
- Duennschicht-Module: **16 m²/kW**.

## Reales JANS-Beispiel (auf dem Formular)
- Vorhaben: Abbruch & Neubau Einfamilienhaus, Bezirk Einsiedeln (Kt. SZ).
- EBF neu **320 m²** → berechnete Leistung 320 × 10 = **3'200 W = 3,2 kW**.
- Geplante Anlage: PREFA Solardachplatte Klein, **22 Module × 146 W = 3,2 kW** → Vorgabe erfuellt.
- Nachweis erarbeitet + private Kontrolle: Raphael Jans Architekten ETH (gleiche Person).
...
- Wer partout keine Anlage will, kann (kantonsabhaengig) eine **Ersatzabgabe** leisten —
  wirtschaftlich selten attraktiv.
- Indach-/dachintegrierte Loesungen (z.B. Solardachplatten) erfuellen die Pflicht und sind
  gestalterisch/denkmalvertraeglich oft die bessere Wahl als Aufdach.

## Offene Punkte / zu pruefen
- ⚠ Formular-Version Juni 2019 war bis 31.12.2024 gueltig — aktuelles kantonales Formular
  (ZH: ueber zh.ch/baueingabe-energieformulare) verwenden.
- Brandschutz bei dachintegrierter PV → Skill `brandschutz`; rechtliche Pflicht/Ausnahmen →
  Skill `baurecht`.

Verwandt: `[[enfk-en-102-waermeschutz-2018]]`, `[[minergie-besser-planen-bauen]]`.
