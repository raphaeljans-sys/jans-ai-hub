...
> Ergänzt `[[sommerlicher-waermeschutz]]` (dort der SIA-180-Nachweis für den **Innenraum**-Komfort
> eines einzelnen Gebäudes) und `[[fassadenbegruenung-hitzeschutz-pv-zielkonflikt]]` (dort die
> Fassade als Bauteil) um die **Aussenraum-/Mikroklima-Perspektive**: was macht ein Quartier oder
> ein einzelnes Grundstück im Aussenraum, um die sommerliche Überhitzung zu dämpfen — unabhängig
> vom Gebäude selbst. Verweist auf `[[rrb-2025-1082-klimaanlagen-bewilligungspraxis-zh]]` (dort der
> Regierungsratsbeschluss ZH, der genau diese baulichen Vorstufen «kühlen ohne Klimaanlage» vor der
> Klimaanlagen-Bewilligung verlangt).
...
«Massnahmen gegen Hitze»). Für Fassadenbegrünung, Wasserelemente, Verschattungselemente wurden in
...
(1) Überwärmung im **gesamten** Stadtgebiet vermeiden, (2) **vulnerable Gebiete** gezielt entlasten,
(3) das bestehende **Kaltluftsystem** (v.a. an den Hanglagen) erhalten. Sie besteht aus drei
Teilplänen (Hitzeminderung, Entlastungssystem, Kaltluftsystem) und richtet sich ausdrücklich an
«Planende und Bauende sowie die Stadtverwaltung» — inkl. einer Toolbox für wirkungsvolle
Massnahmen-Kombinationen, differenziert nach Tag-/Nachtwirkung. Bei grossen Arealen wirkt die Stadt
auf «klimaökologisch optimierte Projekte» hin.

Konkret umgesetzt wird das über das **Programm Stadtgrün** (Baumpflanzungen z.B. am Bullingerhof und
im Gleisbogen Zürich-West, Entsiegelung von Parkplätzen zu Schotterrasen/Wiesen, ökologische
Aufwertung). Die dort öffentlich beschriebenen Projekte betreffen primär **städtische** Flächen; ein
separates, direkt an private Bauherren gerichtetes Förderelement (Vertikalbegrünung, 50 %
Kostenbeteiligung) ist bereits in `[[fassadenbegruenung-hitzeschutz-pv-zielkonflikt]]` dokumentiert.

**Stadtklimatool**: Planende und Bauende können sich für einen beliebigen Standort in der Stadt
Zürich über das städtische Stadtklimatool eine Kurzanalyse und Handlungsempfehlungen ausgeben lassen;
zusätzlich bietet Grün Stadt Zürich eine Freiraumberatung zu hitzemindernder Aussenraumgestaltung an.
Stadtklimatische Anforderungen sind bereits in kommunalen Richtplänen verankert, die laufende Revision
der Nutzungsplanung soll das weiter vertiefen — eine **verbindliche, generelle Bewilligungspflicht**
speziell für Hitzeminderungs-Massnahmen bei privaten Baueingaben wurde in dieser Recherche jedoch
**nicht** klar belegt (offener Punkt, siehe unten).

## SIA-Normlage: keine eigene Aussenraumklima-Norm gefunden
In dieser Recherche wurde **kein** SIA-Merkblatt oder keine SIA-Norm identifiziert, die speziell das
Aussenraum-/Stadtklima bzw. Hitzeminderungsmassnahmen im Freiraum regelt (Suche u.a. nach «SIA
Aussenraumklima», «Hitzeminderung Norm»). Gefunden wurden nur die bereits andernorts dokumentierten
Nachbar-Normen: **SIA 180** für den sommerlichen Wärmeschutz **im Gebäude**
(`[[sommerlicher-waermeschutz]]`) und **SIA 2028** für Klimadaten in Bauphysik/Energie-/
Gebäudetechnik-Berechnungen (Normtext nicht gelesen, nur Titel verifiziert). Das Thema Hitzeminderung
im Aussenraum wird in der Schweiz aktuell primär über **kommunale/kantonale Planungsinstrumente**
(Richtpläne, Fachplanungen, Förderprogramme) statt über eine bundesweite SIA-Norm gesteuert — eine
Lücke, die für ein präzises Update beobachtet werden sollte.

## Bauherren-Transfer
- **Vor der Klimaanlage: den Aussenraum und die Gebäudehülle prüfen.** Der Regierungsratsbeschluss ZH
  zur Klimaanlagen-Bewilligungspraxis (`[[rrb-2025-1082-klimaanlagen-bewilligungspraxis-zh]]`)
  verlangt genau diese Reihenfolge: Verschattung, Nachtauskühlung, Speichermasse, interne
  Lastreduktion **vor** der aktiven Kühlung — und benennt den Hitzeinseleffekt explizit als Grund,
...
- **Kt. ZH vs. Stadt ZH nicht in jedem Punkt sauber getrennt**: die quantifizierten Kühleffekte
  stammen von der kantonalen Seite «Massnahmen gegen Hitze», die Fachplanung/das Förderprogramm sind
  kommunal (Stadt Zürich) — für Projekte ausserhalb der Stadt Zürich gelten die kantonalen
  Kühlkennwerte als generische Orientierung, die kommunalen Instrumente (Stadtklimatool, Förderung)
