...
**Fachlich:** Die kantonale Förderseite hält ausdrücklich fest, dass «Photovoltaik-Anlagen ohne gleichzeitige Dämmung des Daches» nicht gefördert werden, und verweist für PV auf pronovo.ch. Der Bund kennt drei Gefässe: **KLEIV** für Anlagen unter 100 kW, **GREIV** ab 100 kW und die **HEIV**, die hohe Einmalvergütung für Anlagen von 2 bis 149.99 kW **ohne Eigenverbrauch**. Die Vergütung besteht aus einem Grundbeitrag und einem leistungsabhängigen Beitrag; massgebend sind Inbetriebnahmedatum, Höchstleistung und die Bauart, wobei zwischen angebaut/freistehend und integriert unterschieden wird. Per 01.01.2025 wurden die Neigungswinkelboni deutlich erhöht — für stark geneigte **integrierte** Anlagen von 250 auf 400 CHF/kW, für angebaute und freistehende von 100 auf 200 CHF/kW — und für Grossanlagen ab 100 kW auf bisher unüberdachten Parkplatzarealen kam ein Parkflächenbonus von 250 CHF/kW hinzu. Die exakte Tariftabelle in CHF steht weder auf der Übersichtsseite noch in unseren Destillaten; sie ist im Tarifrechner und in der Richtlinie zur Energieförderungsverordnung Photovoltaik geführt und **vor jeder Zusage an eine Bauherrschaft dort abzurufen**.

**Bauherren-Transfer:** Zwei Dinge sind für die Bauherrschaft praktisch relevant. Erstens verschiebt die Bonus-Systematik die Rechnung zugunsten der **Indach-Lösung**: eine integrierte Anlage auf einem steilen Dach erhält doppelt so viel Neigungswinkelbonus wie eine aufgesetzte, was den Mehrpreis der Integration teilweise auffängt und bei einem Neubau ohnehin die architektonisch bessere Lösung ist. Zweitens ist die verbreitete Faustregel «die Einmalvergütung deckt 20 bis 30 % der Investition» eine Angabe aus Anbieterunterlagen von 2022 und taugt nur zur Grössenordnung. Für eine belastbare Zahl gilt der Tarifrechner mit dem konkreten Inbetriebnahmedatum. Wer die Dachdämmung ohnehin anfasst, sollte die kantonale Förderung für die **Dämmung** prüfen, weil sich damit ein Teil des Dachaufbaus mitfinanzieren lässt, den die PV-Anlage sonst allein tragen müsste.

**Quelle:** Kanton Zürich, Energieförderung, Förderprogramm 2026, Stand Januar 2026 (zh.ch, abgerufen 23.08.2026) — keine PV-Förderung, Verweis auf pronovo.ch. Pronovo AG, Förderung Photovoltaik (KLEIV/GREIV/HEIV-Abgrenzung) und Neuerungen Einmalvergütung Photovoltaik (Boni ab 01.01.2025), beide abgerufen 23.08.2026. Faustregel «20-30 %» aus `[[solarreport-solarapp-basel-2022]]` (Glossar, Quellstand 05.11.2022, status emerging). ⚠ Die exakte CHF-Tariftabelle ist in der KB **nicht** belegt und als offener Punkt geführt. Aufgenommen Run 149, 23.08.2026.
