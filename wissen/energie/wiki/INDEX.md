...
## Kernprodukt
- [[BAUHERREN-FAQ]] — belegte Antworten auf Bauherren-Energiefragen · **established** (**Stand 2026-09-18 (Run 207): 301 Kernfragen F1–F301 (maschinell nachgezählt), 348 Destillate ohne INDEX (`ls`, heute gemessen), 40 Wiki-Themenartikel; davor Stand 2026-09-17 (Run 204): 299 Kernfragen F1–F299, **349** Destillate ohne INDEX, 40 Wiki-Themenartikel; davor Stand 2026-09-15 (Run 199): 296 Kernfragen F1–F296 (maschinell nachgezaehlt, `grep -c "^## F[0-9]"`), **348** Destillate ohne INDEX, 40 Wiki-Themenartikel ohne INDEX/QUESTIONS/FAQ** (inkl. `eng-revision-2026-solarwind-nationales-interesse` aus Run 198, dort nicht nachgezählt); davor Stand 2026-09-14 (Run 196): 295 Kernfragen; davor Stand 2026-09-11 (Run 191): 294 Kernfragen; davor Stand 2026-09-10 (Run 190): 292 / 348 / 39; ⚠ die Zahl 342 in aelteren Berichten und im Health-Check vom 01.09.2026 zaehlt `destillate/INDEX.md` mit — derselbe Zaehlfehler, der schon in Run 116 korrigiert wurde); ⚠ die Destillat-Zahl wurde in Run 116 nachgezählt und um eins nach unten korrigiert — die bisherige Serie hatte `destillate/INDEX.md` als Destillat mitgezählt; der Zuwachs von Run 115 auf 116 beträgt korrekt +4, primärquellenbelegt, je Intensiv-Lauf mehrere parallele Rechercheagenten plus adversariale Gegenprüfung bestehender Antworten). Diese Zeile nennt bewusst nur den aktuellen Stand statt jede Lauf-Ergänzung einzeln aufzulisten (Verdichtung statt additivem Wachstum, Rule `wissens-bibliothekar`) — die vollständige Lauf-für-Lauf-Historie mit allen Einzelergänzungen steht in `CHANGELOG.md` (neueste zuoberst).

## Themen-Artikel
Echte eigenständige Wiki-Artikel (`wiki/*.md`), 39 Stück (nachgezählt 07.09.2026, Run 185 — Run 184
hatte 38 gezählt und die Zahl 31 korrigiert, die zuvor mehrere Läufe stehen geblieben war).
...
- [[minergie-standards]] — Minergie/-P/-A/ECO + Eigenstromerzeugung (Stand 2023, mit THGE); ergänzt: **MKZ-Formel** + Minergie-2023-Neuerungen (90 % Q_h,li, Monitoring 1000 m², 60 % E-Parkplaetze) · **established** + **neu Run 179: Zertifizierungsgebuehren beider Reglemente nebeneinander — der Zusatz ECO hat ein eigenes Produktreglement (ecobau + Minergie, V2023.1), seine Gebuehr kommt ZUSAETZLICH zur Minergie-Gebuehr und ist beim MFH 1'000-2'000 m2 EBF das 2,5-fache davon; Kat. X Lager und XII Hallenbad sind nicht ECO-zertifizierbar (F275, F276)** (Destillat `[[minergie-produktreglement-zusatz-eco-2023-1]]`)
...
- [[sommerlicher-waermeschutz]] — Hitzeschutz: g-Wert, Beschattung, Speichermasse, Wetterdaten 2035, Fassadenbegruenung als 5. Stellschraube (PET-Kuehlung ⌀4,8 °C, Zielkonflikt mit Fassaden-PV); SIA-180:2014-Nachweisverfahren 1/2/3 mit Grenzwerten (Verfahren 1 Kennwerte, Verfahren 2 g_tot je Orientierung, Verfahren 3 Simulationskriterium) + ZH-Formularbezug EN-102a/b/EN-110-ZH; Rechtsgrundlage ZH **§ 3 WDV** (seit 1.9.2022, wie MuKEn 2014 Art. 1.8), **MuKEn 2025 Art. 1.9** führt ihn weiter und nimmt reversible Wärmepumpen in Wohnräumen von Steuerung/Windfestigkeit aus (Empfehlung, noch nicht geltendes Recht); **Simulationspflicht bei Kühlung nur als Bauherrenvorgabe der Stadt ZH**, Oberlichter g_tot ≤ 0,025/f_g (SIA 180 Ziff. 5.2.4.7) (F293/F294, Gegenlesung Run 191); **Kt. SZ**: EVEN seit 1.1.2026 wie ZH, keine eigene strengere Wegleitung auffindbar (Negativbefund) (F145) · **established** (Run 88, ergaenzt Run 103); ergaenzt durch `[[urbane-hitzeinseln-kuehlstrategien-aussenraum]]` (Aussenraum-/Mikroklima-Perspektive statt Innenraum-Nachweis, established seit Run 101)
- [[tageslicht-minergie-eco]] — **Tageslicht als Ausschlussvorgabe bei Minergie-ECO** (Vorgabe 140.01, geltende Fassung Vorgabenkatalog 2023.1, Dokumentstand 01.07.2026): Tageslichterfüllungsgrad Hauptnutzräume mind. 50 % (Ausschluss) bzw. 70 % (2 Punkte Bonus), Anteil ungenügend belichteter Raumflächen max. 20 % Neubau / 35 % Erneuerung (Bonus 10 % / 20 %); Berechnung nach SN EN 17037 zugelassen, Autonomie-Median > 50 % bzw. > 70 %, TLQ-Schwellen 0.6 / 1.9 / 3.1 / 4.7 % für 100 / 300 / 500 / 750 Lux; **befristete Ausnahme 40 % für kleine Schule und Schule**, aber nur bei Bauweisen «mittel»/«leicht»/«sehr leicht» nach SIA 380/1 und nur bei Zielkonflikt mit dem sommerlichen Wärmeschutz gemäss Minergie ab Version 2023 (⚠ **kein Befristungsdatum im Text belegt**); Katalog rät selbst von 70 % Autonomie bei 750 Lux ab, «weil dies sehr grosse Glasflächen erfordert» · **emerging**, Einzelagenten-Destillat mit Verifikation der Ausnahmeregelung am Vorgabentext durch den Hauptlauf (Destillat `[[minergie-eco-vorgabenkatalog-standard-2023-1]]`, Run 185, F285). Gegenstück zu `[[sommerlicher-waermeschutz]]` — dort der Hitzeschutz, hier die gegenläufige Tageslichtanforderung
...
- [[eng-revision-2026-solarwind-nationales-interesse]] — **EnG-Revision vom 26.9.2025 (in Kraft seit 1.4.2026)**: neuer Art. 14a EnG (kantonales konzentriertes Plangenehmigungsverfahren für Solar-/Windanlagen von nationalem Interesse), Art. 10 Abs. 1quater/2/3 (keine projektbezogene Richtplanfestsetzung in Eignungsgebieten), Art. 13 Abs. 3 aufgehoben; Spiegel im RPG (Art. 8 Abs. 2/4, Art. 18b Wasserkraftwerke, führend `wissen/baurecht`); für JANS-Standardprojekte (keine Anlage von nationalem Interesse) ohne direkte Wirkung, Bezug nur bei Grossanlagen; ⚠ Fedlex-RPG-Konsolidierung «Stand 1.7.2026» hat die Änderung verloren — nicht als geltende Fassung zitieren · **emerging** (Cross-KB-Übernahme aus `wissen/baurecht` Buch-Run 143, 15.09.2026)
...
- [[elektrosmog]] — Niederfrequente elektromagnetische Felder beim Bauen: NISV-Anlagegrenzwert **1 µT** für Orte empfindlicher Nutzung, kein Grenzwert für Hausinstallationen (Stand der Technik: Erdungsinsel/Einpunkt-Erdung, sternförmige Leitungsführung); Feldstärke-Faustregel 50 cm Abstand; Vorgehen bei Beschwerden (F226); ⚠ **07.09.2026 ergänzt** um die Minergie-ECO-Zusatzanforderung 110.05 NIS-Zonenplan (Nutzungszonen A/B, Verteiler-/WLAN-Antennen-Platzierung, deckt neu auch den Hochfrequenzbereich WLAN/Inhouse-Kommunikation ab) · **emerging**, Datenstand 2002 fuer den NISV-Grundstand / 01.07.2026 fuer den ECO-Zusatz (Destillate `[[elektrosmog-informationsblatt-ahb-ewz]]`, `[[vorgehen-bei-beschwerden-innenraumklima]]`, `[[minergie-eco-vorgabenkatalog-standard-2023-1]]`)
- [[radon-schutzmassnahmen]] — **Radon: bauliche Schutzmassnahmen und Grenzwerte** (neu, Run 184, 07.09.2026): Grenzwerte 100 Bq/m³ Neubau (inkl. Messunsicherheit ≤200) vs. 300 Bq/m³ Erneuerung (Ausschlussvorgabe, Messunsicherheit bereits im Wert enthalten); Radondrainage Ø10cm, Rohrdurchführungssysteme, wasserdichter Beton SIA 272, Erdsonden-Abstand ≥3m, Lüftungs-Einregulierung 1-1.05; Messmethodik METAS-Dosimeter 2-3 Monate; Radonkarte BAG nur Wahrscheinlichkeitsindikator, kein Messersatz · **emerging** (Destillat `[[minergie-eco-vorgabenkatalog-standard-2023-1]]`, Vorgaben 110.03/110.04/110.50)
