...
- [ ] **E-D7** Foerderprogramme Bund/Kt. ZH (CHF-Saetze) — nur mit Datum zitieren. (FAQ F7).
  Hinweis: Foerderprogramm Energie ZH laeuft 2026 unveraendert weiter (zh.ch-Mitteilung 2025).
- [ ] **E-D8** SIA 380/1: Differenz **Ausgabe 2009** (EN-102-Destillat) ↔ **Ausgabe 2016**
  (im EN-ZH-Formular referenziert) abgleichen.

## Inhaltliche Luecken
- [x] **E1** λ-Wert-Bandbreiten Daemmstoffe belegt ✓ 2026-06-07 → `[[daemmstoffe-lambda]]`,
  `[[sia-2001-waermedaemmstoffe-lambda]]`. Offen: Naturdaemmstoffe/VIP (SIA 2001 S. 15-17).
- [ ] **E2** Bauteilekatalog Kap. 4 (homogene/inhomogene Standardaufbauten) destillieren.
- [ ] **E3** Fenster: U-Wert (Aw) + g-Wert + Zielkonflikt Verlust/solarer Gewinn (g-Wert-Tabelle in EN-102 erfasst; eigener Artikel offen).
...
## FAQ-Backlog
- [~] **E-F** BAUHERREN-FAQ: F1-F5/F10/F12 belegt (F4/F12 ✓ 2026-06-07); offen F6-F9, F11.
