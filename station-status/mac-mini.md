...
Stand: 25.07.2026 18:14:17

## Aktive Claude-Sessions (Transkript-Aktivitaet < 30 Min)
- Developer/jans/ai/hub  (letzte Aktivitaet 18:13)
...
## Hub-Git-Stand (NAS)
- f2078607 energie-training Run 97: gruene Hypotheken luecklos primaerquellenbelegt (UKB/TKB/SZKB) + Massivbau-CHF/m2-Naeherung (AKTIVA) + Duschwasser SIA-385/2 Anhang K + GEAK-Mechanik verifiziert + WDVS-Brandriegel neu (FAQ F134-F135)
