...
## Hub-Git-Stand (NAS)
- ebc06b66 scheduled-tasks-spiegel: Wecker-Backup beider Stationen nach templates/scheduled-tasks/ (Script + heartbeat Check 11 + README), 31+8 Tasks
