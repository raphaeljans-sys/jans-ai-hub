...
| `wirtschaftlichkeit-rechner` | `agents/wirtschaftlichkeit-rechner.md` | **Oekonomie-Modul** (Studientyp B): rechnet aus Volumen + Kennwerten **Residualwert/Marge/ROI** + Sensitivitaet + Risiko-Ampel (Controlling Fact Sheet); fuer Skills `machbarkeit` und `ankaufspruefung` |
