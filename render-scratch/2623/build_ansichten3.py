...
V=[];F=[]
for ln in open(HER/"2623_R3_schraegdach.obj"):
    t=ln.split()
    if not t:continue
...
elevation("2623_v3_ansicht_see.png", u, v, "Seeansicht", front_neg=True)
# Stirnseite/Schnitt: horizontale Achse v, Tiefe u
elevation("2623_v3_ansicht_stirn.png", v, u, "Stirnseite", front_neg=True)
plan("2623_v3_dachplan.png")
