...
H=Path("/Volumes/daten/jans-ai-hub/render-scratch/2623"); RND=H/"collage3/render"
OUT=H/"2623_Collage_Schraegdach_v3_Oberrieden.png"
...
d.text((48,40),"Centre-Idee Komorow auf Parzelle 4100 — Variante Schrägdach, Maximalvolumen W2",font=font(36,True),fill=INK)
d.text((48,92),"2623 Oberrieden · volle Fassadenhöhe 9.0 m, Giebel/Dachterrasse bis 13.0 m · Satteldach quer zum Hang · Seeluke über 50% · begehbares Flachdach mit Brüstung",font=font(22),fill=GREY)
d.text((48,124),"AZ 0.35 ausgeschöpft: aGF ~344 m² (Dichtedeckel) · Footprint ~140 m² · GV ~1'550 m³ · monochrom Maroon nach Referenz «89° Komorow»",font=font(21),fill=GREY)
...
# Reihe 2
y2=y1+h1+44;h2=560
see=trim(Image.open(H/"2623_v3_ansicht_see.png"))
plan=trim(Image.open(H/"2623_v3_dachplan.png"))
stirn=trim(Image.open(H/"2623_v3_ansicht_stirn.png"))
