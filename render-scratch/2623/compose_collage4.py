...
H=Path("/Volumes/daten/jans-ai-hub/render-scratch/2623"); RND=H/"collage4/render"
OUT=H/"2623_Collage_Schraegdach_v4_Oberrieden.png"
...
d.text((48,40),"Centre-Idee Komorow auf Parzelle 4100 — zusammenhängender Baukörper, in den Hang gesockelt",font=font(34,True),fill=INK)
d.text((48,90),"2623 Oberrieden · ein Volumen mit gestaffelter Dachlandschaft · Seeluken · begehbare Dachterrassen · gewachsene Terrainlinie als Geländeschnitt · dezente Fenestrierung",font=font(21),fill=GREY)
d.text((48,121),"Maximalvolumen W2: Fassadenhöhe 9.0 m, Giebel bis 13.0 m, AZ 0.35 (aGF ~344 m²) · monochrom Maroon nach Referenz «89° Komorow»",font=font(20),fill=GREY)
...
lab(48,y1,"Seeperspektive — gesockelt im Hang, Lukarnen und Fensterrhythmus")
...
y2=y1+h1+46;h2=580
see=trim(Image.open(H/"2623_v4_ansicht_see.png"))
quer=trim(Image.open(H/"2623_v4_ansicht_quer.png"))
lab(48,y2,"Seeansicht — Schnitt mit gewachsener Terrainlinie")
pc(c,see,48,y2+34,1620,h2-34)
lab(1700,y2,"Querschnitt durch den Hang")
pc(c,quer,1700,y2+34,732,h2-34)
