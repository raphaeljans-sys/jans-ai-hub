...
Stand: 27.06.2026 (Radar-Lauf)

## Aktiv

| Frist | Was | Quelle | Projekt/Kontext | Prio | Status |
|---|---|---|---|---|---|
| 16.04.2026 | RE-00087 (Kispi, CHF 15'000) 72 Tage ueberfaellig — Mahnstufe 1 (Zahlungserinnerung), naechste Frist 28.06.2026 (MORGEN); Eskalation auf Stufe 2 (Mahnung 1) jetzt faellig | mahnwesen | 2619 KISPI | hoch | offen |
...
| 16.06.2026 | RE-00097 (Hofer, CHF 500) 11 Tage ueberfaellig — Mahnstufe 1 (Zahlungserinnerung), naechste Frist 30.06.2026 (in 3 Tagen) | mahnwesen | Debitoren | tief | offen |
...
| 24.06.2026 | AG JANS Gruendung — FIRMENNAME GEFAEHRDET: Notariat Wiedikon-Zuerich (M. Mathies, 22.06.) hat vorgeprueft und meldet, dass bereits eine «JANS GmbH» im HR eingetragen ist. Gemaess Weisung Firmenidentitaet (Ziff. IV) hat der Rechtsformzusatz AG/GmbH KEINE Unterscheidungskraft → Risiko, dass «JANS AG» vom HRA nicht zugelassen wird. Notariat empfiehlt alternativen Firmennamen (z.B. mit unterscheidungskraeftigem Zusatz «JANS Architektur AG» o.ae.). Update 26.06.: HRA ZH hat die Voranfrage zur Zulaessigkeit der Firma «JANS AG» (Geschaeft 043830-2026) bestaetigt (Empfangsbestaetigung kanzlei.hra@ji.zh.ch, 26.06. 04:49) — die Anfrage liegt bei der zustaendigen Abteilung, Antwort abwarten. Namensentscheid (JANS AG vs. unterscheidungskraeftiger Zusatz) und damit die UBS-Unterschrift erst NACH dem HRA-Bescheid. AKTION Raphael: HRA-Antwort abwarten; faellt sie negativ aus, Alternativnamen waehlen → Claude prueft ihn vorgaengig gegen HR, Belegset anpassen + Korrektur; danach dem Notariat die Word-Dateien Urkunde + Statuten senden. Beurkundungstermin erst NACH UBS-Kapitalbescheinigung | spec/mail | AG JANS Gruendung | hoch | nachfassen |
