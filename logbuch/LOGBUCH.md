...
Regellauf `mahnwesen-verzugscheck` auf dem MacBook Pro. **Kein Verzugsstand messbar, siebter Tag in Folge:** `node connectors/bexio.mjs --verzug --json` antwortet HTTP 401, ebenso die Gegenprobe am Aussteller (`auth.bexio.com/.../userinfo`) und eine zusaetzliche Direktprobe an `api.bexio.com/2.0/kb_invoice`. `~/.bexio.env` unveraendert vom 13.06.2026 11:05, kein neuer Token eingetragen. Letzter verifizierter Zahlstatus 08.08. 08:36, das sind zehn Kalendertage. Es wurde nichts gemahnt, nichts gebucht, nichts versendet.

**Einzige Veraenderung gegenueber gestern:** RE-00100 (Swiss Central City, CHF 13'120.00) ist ins Fuenf-Tage-Fenster gerueckt, die Frist der Zahlungserinnerung laeuft am Donnerstag 20.08. ab. Eine Eskalation ist dort ohnehin gesperrt, solange die Faelligkeit in bexio (30.07.) nicht auf den belegten Zustelltermin 03.08. nachgezogen ist (offen seit 31.07.). Unveraendert: RE-00098/99 (KISPI, zusammen CHF 17'280) sieben Tage ueber der Mahnfrist vom 12.08., unverifiziert; RE-00101 (Tschopp, CHF 6'000) am zweiten Werktag nach Fristablauf, Mahnschritt gesperrt wegen der ungeprueften Tx 3630 ueber exakt CHF 6'000; RE-00087 (KISPI, CHF 15'000) in der Duplikatsklaerung bei C. Schaefer.

**Aktion Raphael unveraendert:** neuen bexio-Token ausstellen und in `~/.bexio.env` eintragen, danach `node /Volumes/daten/jans-ai-hub/scripts/bexio-vorfilter.mjs --voll --trocken`. Bericht: `30 JANS AI HUB OUTPUT/mahnwesen/2026/260818_Verzugscheck.md`. Fristen-Register: datierter Nachtrag an der bestehenden Zeile «bexio-Zugang tot», kein Zweiteintrag.
