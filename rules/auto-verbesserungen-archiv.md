# ARCHIV: Auto-erfasste Verbesserungen (Historie, NICHT importiert)

Dieses Archiv enthaelt den vollstaendigen Stand der Datei auto-verbesserungen.md vor der
Kontext-Diaet vom 19.07.2026. Es wird NICHT in CLAUDE.md importiert und kostet keine Tokens.
Die aktiven Regeln stehen konsolidiert in auto-verbesserungen.md; bei Unklarheiten gilt
dieses Archiv als Beleg der Original-Wortlaute (inkl. Ausloeser-Zitate).
...
## Konsolidierungs-Snapshot 30.07.2026 23:12 — Wortlaut vor Kontext-Diaet 3.0

Der folgende Block ist die vollstaendige Fassung der importierten Datei vor der
Verdichtung vom 30.07.2026 (Header um eine Ebene abgesenkt). Verschobene Eintraege
leben in den SKILL.md/Rules weiter (Verweisliste 260602 in der Hauptdatei).
