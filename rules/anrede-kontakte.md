...
| Hleb (Nachname nicht belegt) | Webprogrammierer raphaeljans.ch (Website-Rebuild) | Website | englisch (Du-Aequivalent) | Die Korrespondenz laeuft englisch: «**Hi Hleb**», zweifach aus Raphaels eigener Hand belegt (16.02. und 27.06.2026), Sign-off «Best regards, Raphael». **Nicht** «Hello» — das ist der Opener beim 3D-Freelancer, nicht bei ihm: die englische Anrede haengt am **Kontakt**, nicht an der Sprache (Beleg `wissen/twin/wiki/stimme.md` Z. 108-110; Fidelity-Review 27.08.2026, `wissen/twin/wiki/QUESTIONS.md` 260827b #1). Schreibweise «Hleb»; die Form «Hlep» in aelteren Mails ist ein Verschreiber Raphaels. Nachgetragen 27.08.2026 (Synergie-Lauf 20) |
| Undine Hofer | Bauherrenvertreterin (Undine Schneider), Wartstrasse 8 | Wartstrasse 8 | **Du** | «Hoi Undine» operativ, «Geschätzte Undine» bei Gewicht (eigene Rechnung, Zahlungsbitte, Freigabe); Gruss schwankt zwischen Kurzgruss und blossem Block. Nachgetragen 26.08.2026 aus vier belegten Fidelity-Läufen (Golds 08.02., 26.03., 01.06., 07.07.2026, alle aus Raphaels eigener Hand) |
