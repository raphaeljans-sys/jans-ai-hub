...
| 3 | `buero-referenzen` | `/Volumes/daten/04_Buero/10_Referenzenbibliothek` | `wissen/architektur-fachwissen` (neu) | `specs/buero-referenzen-spec.md` (29.08.2026) | **Destillat läuft.** Inventar Phase 0 abgeschlossen (23 Inventardateien). Spec 29.08.2026 geschrieben (Lane FACHWISSEN). Erster Destillat-Lauf 29.08.2026: 9 Wiki-Artikel aus `18_Projektkostenplanung`, alle 16 P1-Positionen dieser Sektion destilliert (P2 offen für später). Zweiter Destillat-Lauf 29.08.2026: 4 Wiki-Artikel aus `10_Modellbauen`, alle 12 P1-Positionen dieser Sektion destilliert (P2 offen für später). Dritter Destillat-Lauf 29.08.2026: 5 Wiki-Artikel aus `17_Projektbeschriebe`, alle 7 P1-Positionen dieser Sektion destilliert (P2 offen für später). Vierter Destillat-Lauf 29.08.2026: 6 Wiki-Artikel aus `25_Wettbewerb`, alle 5 P1-Positionen dieser Sektion destilliert (P2 offen für später, Anonymisierungs-Zusatzprüfung durchgeführt, kein Fund). Fünfter Destillat-Lauf 29.08.2026: 7 Wiki-Artikel aus `20_Rendering` (in zwei Teilen desselben Laufs), **vollständig erledigt** (alle 9 Architektur-III-Handouts geprüft: 6 mit Fliesstext destilliert, 3 reine Bildarbeitsblätter begründet uebersprungen). Damit ist die Spec-Plan-Sektionsfolge vollständig durchlaufen; Korpus 3 ist weiterhin NICHT „erledigt" — offen: alle P2 der fünf bearbeiteten Sektionen, sowie die P1-einstelligen Sektionen (`12_Masse`, `21_Rhino` u.a.) aus `wiki/INDEX.md` |
