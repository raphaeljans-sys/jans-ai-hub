...
| 4 | `archiv-fachwissen` | `/Volumes/daten/02_Architektur_Archiv` (23 Themensektionen) | `wissen/architektur-fachwissen` | `specs/archiv-fachwissen-spec.md` (29.08.2026) | **Zweiter Destillat-Lauf abgeschlossen.** Inventar Phase 0: Stand 23.08.2026 war 4 von 23 Sektionen; tatsaechlich liegen mit Stand 29.08.2026 **20 Inventardateien** vor (die Zwischenzahlen 8'023 Dateien/P1 69/P2 507 waren nur der 23.08-Teilstand und sind veraltet, siehe Spec). Spec 29.08.2026 geschrieben (Lane FACHWISSEN). Sektion `02_Denkmalpflege` (8 P1, kein Duplikatsrisiko) am selben Tag vollstaendig destilliert: sieben Wiki-Artikel (SIA-2017-Erhaltungswert, Charta-von-Venedig-Begriffskette, Trockenmauer-Devisierung SVTSM, Naturstein-Datierung Portmann, Kalk-/Oelanstrich-Rezepturen Glaser, Baudokumentations-Gliederung Haus Jans, Umbau-Kriterienkatalog Hassler). Zweiter Lauf, selber Tag: `03_Bauprozesse_I_II` (groesster P1-Einzelfund, 58 P1) — Leutschenbach-Duplikatspruefung gegen Korpus-3-Sektionen `18_Projektkostenplanung`/`17_Projektbeschriebe`/`22_Terminplanung` durchgefuehrt (mehrere P1-Positionen sind identische Dateien/dasselbe Objekt, nicht erneut destilliert), vier echte Neuzugaenge destilliert (SIA-102:2003-Rechenwerk Eberle als dritte Bestaetigung, eBKP-H-2012-Musterbeispiel Haus im Forst auf drei Genauigkeitsstufen, eBKP-H-Bezugsgroessen-Kuerzeltabelle, Terminplan-Dauern-Kennwerttabelle Wohnungsbau plus EFH-Benchmark, Referenzfall Umnutzung Akutspital-Pflegezentrum Oberdiessbach 2009). Norm-Originale nicht destilliert (Abgrenzung), ein Cross-KB-Fund (Grobkostenmethodik-Text Jans) und ein Entwickler-Testfixture (SIA-451) in `wiki/QUESTIONS.md` vermerkt statt destilliert. Sektion `03_Bauprozesse_I_II` damit ohne offenen eigenstaendigen P1-Artikel; erster P2-Lauf (drei Artikel: eBKP-H-2012-Gliederungslogik OAK/EAK, Kostenvoranschlag-Merkblatt oeffentliche Bauherrschaft, instationaerer Waermedurchgang) am 30.08.2026 abgeschlossen, P2 bleibt teilweise offen (u. a. `schaetzungsanleitung_kap5.pdf`). **Dritter Lauf, 30.08.2026:** naechstgroesste Sektion nach Ertrag, `02_Architekturtheorie` (21 P1 von 1603 Dateien, elf Triage-Zeilen) — zehn der elf P1-Zeilen destilliert (zehn Wiki-Artikel: Tektonik/Bekleidung, Materialwahrheit/Stoffwechsel, Typus/Modell/Prototyp, Funktionsbegriff, Ornament/Decorum, Ort/genius loci, Stil/Styling/Signatur/Brand, Materialitaet haptisch/optisch, Begriffskonkordanz, 19-Punkte-Textanalyse-Raster), zwei Positionen technisch blockiert (Bild-Scan ohne OCR, fehlendes poppler auf dieser Station — QUESTIONS.md #61/#62). Auch `01_Konstruktion` und `01_Tragwerk` sind laut CHANGELOG P1(+P2) abgeschlossen. **Vierter Lauf, 30.08.2026:** `10_Protomodern` (Raphael Jans' eigenes, nie abgeschlossenes Buch-/Manifestprojekt, 519 Dateien, 13 P1) — alle 13 P1-Positionen destilliert, dreizehn Wiki-Artikel, Sektion P1 vollstaendig abgeschlossen, P2 (33 Positionen) bleibt offen. **Fuenfter Lauf, 30.08.2026:** `02_Architekturgeschichte` (3826 Dateien, 11 P1 in vier Triage-Gruppen) — alle vier P1-Positionen destilliert, fuenf Wiki-Artikel (Gebaeudeanalyse-Raster Haus Steiger, Fachglossar historischer Bauteile, Tessiner-Tendenza/Ambiente-Genealogie, Archigram/Living-City als zweiter Themenblock derselben Quelldatei, geprüfte Objektliste Tönnesmann/Hildebrand Brunelleschi-Wright). Sektion P1 vollstaendig abgeschlossen, P2 (rund 160 Dateien) bleibt offen. Naechster Lauf: `02_Kunst_Geschichte` (ebenfalls 11 P1, noch unbearbeitet) — Vorsicht bei `04_Politik`/`05_Kultur_Gesellschaft_Stil`/`06_Reisen`/`07_Religion` (Privatunterlagen-Vorbehalt) |
