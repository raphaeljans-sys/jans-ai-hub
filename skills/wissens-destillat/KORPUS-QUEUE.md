...
| 3 | `buero-referenzen` | `/Volumes/daten/04_Buero/10_Referenzenbibliothek` | `wissen/architektur-fachwissen` (neu) | `specs/buero-referenzen-spec.md` (29.08.2026) | **Inventar Phase 0 abgeschlossen** — 23 Inventardateien unter `wissen/architektur-fachwissen/raw/inventar/buero-referenzen__*.md` (Stand 29.08.2026, Zahlen im Detail je Datei; Kennzahlen-Register `wiki/INDEX.md` teils überholt, vor jedem Lauf neu prüfen). **Spec 29.08.2026 geschrieben** (Lane FACHWISSEN) — nächster Lauf beginnt das Destillat auf `18_Projektkostenplanung` gemäss Spec-Plan. Noch kein Wiki-Artikel |
