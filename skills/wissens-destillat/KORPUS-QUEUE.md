...
| 3 | `buero-referenzen` | `/Volumes/daten/04_Buero/10_Referenzenbibliothek` | `wissen/architektur-fachwissen` (neu) | offen | **Inventar Phase 0 abgeschlossen 23.08.2026** — 12 von 32 Sektionen inventarisiert, 581 Dateien gesichtet: P1 44 / P2 124 / P3 234 / X 179. Belege je Sektion in `wissen/architektur-fachwissen/raw/inventar/buero-referenzen__*.md`, Lauf-Report `outputs/2026-08-23_korpus-erschliessung.md`. Noch kein Destillat; Spec weiterhin offen |
