...
| 4 | `archiv-fachwissen` | `/Volumes/daten/02_Architektur_Archiv` (23 Themensektionen) | `wissen/architektur-fachwissen` | `specs/archiv-fachwissen-spec.md` (29.08.2026) | **Spec geschrieben, Destillat noch offen.** Inventar Phase 0: Stand 23.08.2026 war 4 von 23 Sektionen; tatsaechlich liegen mit Stand 29.08.2026 **20 Inventardateien** vor (die Zwischenzahlen 8'023 Dateien/P1 69/P2 507 waren nur der 23.08-Teilstand und sind veraltet, siehe Spec). Spec 29.08.2026 geschrieben (Lane FACHWISSEN), guter Startpunkt naechster Lauf: `02_Denkmalpflege` (P1-Cluster vier Fachbausteine, kein Duplikatsrisiko). Achtung Duplikatsrisiko `03_Bauprozesse_I_II` mit Korpus-3-Sektion `18_Projektkostenplanung` (beide Objekt Leutschenbach) — Spec verlangt Gegenpruefung vor jedem neuen Artikel |
