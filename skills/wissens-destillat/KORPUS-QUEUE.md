...
| 2 | `buero-projekte` | `/Volumes/daten/04_Buero/02_Projekte` (22 Projekte) | `wissen/projekt-lessons` (bestehend) | `specs/buero-projekte-spec.md` (16.08.2026) | **aktiv** — Inventar Phase 0 abgeschlossen 16.08.2026 (21 Sektionen, 807 offen / 5 pauschal / 1 Sonderfall), Triage Phase 1 offen |
