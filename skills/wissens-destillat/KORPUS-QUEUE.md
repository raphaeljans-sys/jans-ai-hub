...
| 2 | `buero-projekte` | `/Volumes/daten/04_Buero/02_Projekte` (22 Projekte) | `wissen/projekt-lessons` (bestehend) | `specs/buero-projekte-spec.md` (16.08.2026) | **aktiv** — Inventar Phase 0 abgeschlossen 16.08.2026, Triage Phase 1 abgeschlossen 23.08.2026 (813 Zeilen, 0 offen, 632 uebersprungen, 179 fuer Phase 2 vorgemerkt: 62 P1 / 91 P2 / 26 P3), Destillat Phase 2 Run 1+2 abgeschlossen 23.08.2026 (alle 62 P1-Zeilen aus `1318_Lorraine_Kueche` sowie 1011/1115/1603 gelesen, 36 `[x]` gesamt, Cluster P1-seitig fertig; 117 `[t]` offen: 91 P2 / 26 P3 im Gesamtkorpus) |
