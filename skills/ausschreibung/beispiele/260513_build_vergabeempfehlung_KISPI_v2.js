...
const OUT = '/Users/raphaeljans/Library/CloudStorage/OneDrive-FreigegebeneBibliotheken–JANS/AD - 01 Geschaeftsfuerung/JANS AI/30 JANS AI HUB OUTPUT/submission/2619-kispi-gastrokueche/auswertung/260513_Vergabeempfehlung_KISPI_Gastrokueche_v2.docx';
...
const footer = () => new Paragraph({
  ...
  children: [
    new TextRun({ text: "Raphael Jans Architekten ETH SIA  -  rj@raphaeljans.ch  -  13. Mai 2026  -  v2 (korrigiert)", size: 16 }),
...
const COL_BEZ_A = 6800;
const COL_R_A = 1200;
const COL_G_A = 1200;
const COL_BEM_A = CONTENT_W - COL_BEZ_A - COL_R_A - COL_G_A;
...
const dTotal = (b, r, g, bem) => new TableRow({
  children: [
    ...
    tcell(bem, COL_BEM_A, { bold: true, borders: totalRow, size: 18 }),
  ],
});
...
const inhalt = [
  ...
  stamm("Datum Bericht", "13. Mai 2026, Fassung v2"),
