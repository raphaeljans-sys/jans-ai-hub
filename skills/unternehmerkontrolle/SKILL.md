...
- **Inputs:** Werkvertrag (aus Phase G) inkl. Termine/Regieansätze/Garantievorgaben, LV/Ausmass, Akonto-/Schlussrechnung des Unternehmers, NT-/Regierapporte, Abnahmebefund. Vorlagen: `templates/abnahmeprotokoll.md`, `maengelprotokoll.md`, `garantieschein.md`, `nachtrag-formular.md`, `regierapport.md`. Sind im Werkvertrag bauökologische Anforderungen überbunden, liefert die KB `wissen/energie` die Kontrollstufe: `destillate/ahb-devis-und-baustellenkontrolle-2008.md` (Prüfpunkte Baustellenkontrolle) und `wiki/oekologische-materialvorgaben-beschaffung.md` (die Kontrollfrage «wann und wie wird auf der Baustelle geprüft, dass die Anforderung eingehalten wird»). ⚠ Alterskorpus 2006/2008, Mechanik übertragbar, Wortlaut nicht.
